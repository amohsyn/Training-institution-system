...
namespace TestData
{
    public class BaseCalendarDayTestDataFactory : EntityTestData<CalendarDay>
    {
		...
		protected override List<CalendarDay> Generate_TestData()
        {
            ...
            string FileName = this.Get_Solution_Path() + "Data/CalendarDay_TestData.xlsx";
            string Repport_File = this.Get_Solution_Path() + "Data/Repports/CalendarDay_TestData.xlsx";
