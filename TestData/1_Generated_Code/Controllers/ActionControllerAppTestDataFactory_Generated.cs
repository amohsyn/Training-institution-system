...
namespace TestData
{
    public class BaseActionControllerAppTestDataFactory : EntityTestData<ActionControllerApp>
    {
		...
		protected override List<ActionControllerApp> Generate_TestData()
        {
            ...
            string FileName = this.Get_Solution_Path() + "Data/ActionControllerApp_TestData.xlsx";
            string Repport_File = this.Get_Solution_Path() + "Data/Repports/ActionControllerApp_TestData.xlsx";
