...
namespace TestData
{
    public class BaseCategory_JustificationAbsenceTestDataFactory : EntityTestData<Category_JustificationAbsence>
    {
		...
		protected override List<Category_JustificationAbsence> Generate_TestData()
        {
            ...
            string FileName = this.Get_Solution_Path() + "Data/Category_JustificationAbsence_TestData.xlsx";
            string Repport_File = this.Get_Solution_Path() + "Data/Repports/Category_JustificationAbsence_TestData.xlsx";
