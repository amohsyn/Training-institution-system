...
namespace TestData
{
    public class BaseWarningTraineeTestDataFactory : EntityTestData<WarningTrainee>
    {
		...
		protected override List<WarningTrainee> Generate_TestData()
        {
            ...
            string FileName = this.Get_Solution_Path() + "Data/WarningTrainee_TestData.xlsx";
            string Repport_File = this.Get_Solution_Path() + "Data/Repports/WarningTrainee_TestData.xlsx";
