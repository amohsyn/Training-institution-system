...
namespace TestData
{
    public class BaseSeanceNumberTestDataFactory : EntityTestData<SeanceNumber>
    {
		...
		protected override List<SeanceNumber> Generate_TestData()
        {
            ...
            string FileName = this.Get_Solution_Path() + "Data/SeanceNumber_TestData.xlsx";
            string Repport_File = this.Get_Solution_Path() + "Data/Repports/SeanceNumber_TestData.xlsx";
