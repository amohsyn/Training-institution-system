...
namespace TestData
{
    public class BaseEntityPropertyShortcutTestDataFactory : EntityTestData<EntityPropertyShortcut>
    {
		...
		protected override List<EntityPropertyShortcut> Generate_TestData()
        {
            ...
            string FileName = this.Get_Solution_Path() + "Data/EntityPropertyShortcut_TestData.xlsx";
            string Repport_File = this.Get_Solution_Path() + "Data/Repports/EntityPropertyShortcut_TestData.xlsx";
