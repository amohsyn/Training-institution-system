...
namespace TestData
{
    public class BaseNationalityTestDataFactory : EntityTestData<Nationality>
    {
		...
		protected override List<Nationality> Generate_TestData()
        {
            ...
            string FileName = this.Get_Solution_Path() + "Data/Nationality_TestData.xlsx";
            string Repport_File = this.Get_Solution_Path() + "Data/Repports/Nationality_TestData.xlsx";
