...
namespace TestData
{
    public class BaseSchoollevelTestDataFactory : EntityTestData<Schoollevel>
    {
		...
		protected override List<Schoollevel> Generate_TestData()
        {
            ...
            string FileName = this.Get_Solution_Path() + "Data/Schoollevel_TestData.xlsx";
            string Repport_File = this.Get_Solution_Path() + "Data/Repports/Schoollevel_TestData.xlsx";
