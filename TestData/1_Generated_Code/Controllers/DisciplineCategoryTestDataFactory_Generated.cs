...
namespace TestData
{
    public class BaseDisciplineCategoryTestDataFactory : EntityTestData<DisciplineCategory>
    {
		...
		protected override List<DisciplineCategory> Generate_TestData()
        {
            ...
            string FileName = this.Get_Solution_Path() + "Data/DisciplineCategory_TestData.xlsx";
            string Repport_File = this.Get_Solution_Path() + "Data/Repports/DisciplineCategory_TestData.xlsx";
