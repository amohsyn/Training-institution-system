...
namespace TestData
{
    public class BaseModuleTrainingTestDataFactory : EntityTestData<ModuleTraining>
    {
		...
		protected override List<ModuleTraining> Generate_TestData()
        {
            ...
            string FileName = this.Get_Solution_Path() + "Data/ModuleTraining_TestData.xlsx";
            string Repport_File = this.Get_Solution_Path() + "Data/Repports/ModuleTraining_TestData.xlsx";
