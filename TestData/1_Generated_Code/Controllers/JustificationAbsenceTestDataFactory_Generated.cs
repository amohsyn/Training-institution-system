...
namespace TestData
{
    public class BaseJustificationAbsenceTestDataFactory : EntityTestData<JustificationAbsence>
    {
		...
		protected override List<JustificationAbsence> Generate_TestData()
        {
            ...
            string FileName = this.Get_Solution_Path() + "Data/JustificationAbsence_TestData.xlsx";
            string Repport_File = this.Get_Solution_Path() + "Data/Repports/JustificationAbsence_TestData.xlsx";
