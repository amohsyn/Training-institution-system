...
namespace TestData
{
    public class BaseMeetingTestDataFactory : EntityTestData<Meeting>
    {
		...
		protected override List<Meeting> Load_Data_From_ExcelFile()
        {
            ...
            string FileName = this.Get_Solution_Path() + "Data/Meeting.xlsx";
        ...
        protected override List<Meeting> Insert_Or_Update_ExcelFile_TestData(out bool is_Insert_Or_Update)
        {
            ...
            this.Create_TestData_Files_Directory_If_Not_Exist();
            string FileName = this.Get_Solution_Path() + "Data/Meeting.xlsx";
            string Repport_File = this.Get_Solution_Path() + "Data/Repports/Meeting.xlsx";
		...
		public override void Generate_Excel_File(List<Meeting> generated_Data)
        {
            // Create Paths 
            this.Create_TestData_Files_Directory_If_Not_Exist();
            string FileName = this.Get_Solution_Path() + "Data/Meeting.xlsx";

            var DataTeble = (this.BLO as MeetingBLO).Convert_to_DataTable(generated_Data);
            (this.BLO as MeetingBLO).ExcelDAO.Save(DataTeble, FileName);
        }
    }
