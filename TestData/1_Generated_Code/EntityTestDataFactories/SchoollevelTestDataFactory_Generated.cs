...
namespace TestData
{
    public class BaseSchoollevelTestDataFactory : EntityTestData<Schoollevel>
    {
		...
		protected override void Constructor(UnitOfWork<TrainingISModel> UnitOfWork, GAppContext GAppContext)
        {
			...
			Entity_CRUD_Test_Reference  = "Schoollevel_CRUD_Test";
        }
		...
		public virtual Schoollevel Create_CRUD_Schoollevel_Test_Instance()
        {
			Schoollevel Schoollevel = this.CreateValideSchoollevelInstance();
            Schoollevel.Reference = this.Entity_CRUD_Test_Reference;
            return Schoollevel;
        }
		...
		public override void Generate_Excel_File(List<Schoollevel> generated_Data)
        {
            // Create Paths 
            this.Create_TestData_Files_Directory_If_Not_Exist();
            string FileName = this.Get_Solution_Path() + "Data/Schoollevel.xlsx";

            var DataTeble = (this.BLO as SchoollevelBLO).Convert_to_DataTable(generated_Data);
            (this.BLO as SchoollevelBLO).ExcelDAO.Save(DataTeble, FileName);
        }
    }
