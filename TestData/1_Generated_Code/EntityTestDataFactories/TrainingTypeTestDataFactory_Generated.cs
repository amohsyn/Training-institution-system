...
namespace TestData
{
    public class BaseTrainingTypeTestDataFactory : EntityTestData<TrainingType>
    {
		...
		protected override void Constructor(UnitOfWork<TrainingISModel> UnitOfWork, GAppContext GAppContext)
        {
			...
			Entity_CRUD_Test_Reference  = "TrainingType_CRUD_Test";
        }
		...
		public virtual TrainingType Create_CRUD_TrainingType_Test_Instance()
        {
			TrainingType TrainingType = this.CreateValideTrainingTypeInstance();
            TrainingType.Reference = this.Entity_CRUD_Test_Reference;
            return TrainingType;
        }
		...
		public override void Generate_Excel_File(List<TrainingType> generated_Data)
        {
            // Create Paths 
            this.Create_TestData_Files_Directory_If_Not_Exist();
            string FileName = this.Get_Solution_Path() + "Data/TrainingType.xlsx";

            var DataTeble = (this.BLO as TrainingTypeBLO).Convert_to_DataTable(generated_Data);
            (this.BLO as TrainingTypeBLO).ExcelDAO.Save(DataTeble, FileName);
        }
    }
