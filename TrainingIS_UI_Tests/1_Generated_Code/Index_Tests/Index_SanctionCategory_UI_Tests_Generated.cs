...
namespace TrainingIS_UI_Tests.SanctionCategories
{
    ...
    public class Base_Index_SanctionCategory_UI_Tests : Base_Index_Entity_UI_Test<SanctionCategory>
    {
		// GApp Context
        public UnitOfWork<TrainingISModel> UnitOfWork { set; get; }
        public GAppContext GAppContext { set; get; }
        public TrainingYear CurrentTrainingYear { set; get; }
		protected string GAppDataTable_Html_Id = "SanctionCategories_entities";
		...
		[TestMethod]
        public virtual void SanctionCategory_Index_Test()
        {
           
        }
		[TestMethod]
        public virtual void Export_SanctionCategories_Tests()
        {
            this.GoTo_Index_And_Login_If_Not_Ahenticated();
		...
		public virtual void Import_And_Import_File_Example_SanctionCategories_Test()
        {
            ...
            string file_path = this.Test_Machine.Get_Downloads_Directory() + this.SanctionCategoryBLO.Get_Import_File_Name();
	...
	public partial class Index_SanctionCategory_UI_Tests : Base_Index_SanctionCategory_UI_Tests
    {
		public Index_SanctionCategory_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Index_SanctionCategory_UI_Tests() : base(null){}
    }
}
