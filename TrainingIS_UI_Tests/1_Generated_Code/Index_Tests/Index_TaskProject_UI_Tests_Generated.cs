...
namespace TrainingIS_UI_Tests.TaskProjects
{
    ...
    public class Base_Index_TaskProject_UI_Tests : Base_Index_Entity_UI_Test<TaskProject>
    {
		...
		protected string GAppDataTable_Html_Id = "TaskProjects_Entities";
		...
		[TestMethod]
        public virtual void Export_TaskProjects_Tests()
        {
            this.GoTo_Index_And_Login_If_Not_Ahenticated();
		...
		[TestMethod]
		public virtual void Import_And_Import_File_Example_TaskProjects_Test()
        {
            this.GoTo_Index_And_Login_If_Not_Ahenticated();
            ...
            string file_path = this.Test_Machine.Get_Downloads_Directory() + this.TaskProjectBLO.Get_Import_File_Name();
