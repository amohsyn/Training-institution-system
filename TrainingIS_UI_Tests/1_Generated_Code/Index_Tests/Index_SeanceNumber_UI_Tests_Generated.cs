...
namespace TrainingIS_UI_Tests.SeanceNumbers
{
    ...
    public class Base_Index_SeanceNumber_UI_Tests : Base_Index_Entity_UI_Test<SeanceNumber>
    {
        ...
        protected override void Constructor(UI_Test_Context UI_Test_Context)
        {
            ...
            this.Valide_Entity_Instance = SeanceNumber_TestData.Create_CRUD_SeanceNumber_Test_Instance();
            this.Valide_Entity_Instance.Reference = this.Entity_Reference;
        }

		public Base_Index_SeanceNumber_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void SeanceNumber_Index_Test()
        {
           
        }
		[TestMethod]
        public virtual void Export_SeanceNumbers_Tests()
        {
            this.GoTo_Index_And_Login_If_Not_Ahenticated();
		...
		[TestMethod]
		public virtual void Import_And_Import_File_Example_SeanceNumbers_Test()
        {
            this.GoTo_Index_And_Login_If_Not_Ahenticated();
            ...
            string file_path = this.Test_Machine.Get_Downloads_Directory() + this.SeanceNumberBLO.Get_Import_File_Name();
	...
	public partial class Index_SeanceNumber_UI_Tests : Base_Index_SeanceNumber_UI_Tests
    {
		public Index_SeanceNumber_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Index_SeanceNumber_UI_Tests() : base(null){}
    }
}
