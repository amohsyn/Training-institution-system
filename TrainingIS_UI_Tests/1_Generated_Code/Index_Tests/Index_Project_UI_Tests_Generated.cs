...
namespace TrainingIS_UI_Tests.Projects
{
    ...
    public class Base_Index_Project_UI_Tests : Base_Index_Entity_UI_Test<Project>
    {
		// GApp Context
        public UnitOfWork<TrainingISModel> UnitOfWork { set; get; }
        public GAppContext GAppContext { set; get; }
        public TrainingYear CurrentTrainingYear { set; get; }
		protected string GAppDataTable_Html_Id = "Projects_entities";
		...
		[TestMethod]
        public virtual void Export_Projects_Tests()
        {
            this.GoTo_Index_And_Login_If_Not_Ahenticated();
		...
		[TestMethod]
		public virtual void Import_And_Import_File_Example_Projects_Test()
        {
            this.GoTo_Index_And_Login_If_Not_Ahenticated();
            ...
            string file_path = this.Test_Machine.Get_Downloads_Directory() + this.ProjectBLO.Get_Import_File_Name();
