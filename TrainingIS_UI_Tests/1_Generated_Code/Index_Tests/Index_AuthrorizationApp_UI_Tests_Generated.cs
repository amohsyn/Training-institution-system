...
namespace TrainingIS_UI_Tests.AuthrorizationApps
{
    ...
    public class Base_Index_AuthrorizationApp_UI_Tests : Base_Index_Entity_UI_Test<AuthrorizationApp>
    {
		...
		protected string GAppDataTable_Html_Id = "AuthrorizationApps_entities";
		...
		[TestMethod]
        public virtual void AuthrorizationApp_Index_Test()
        {
           
        }
		[TestMethod]
        public virtual void Export_AuthrorizationApps_Tests()
        {
            this.GoTo_Index_And_Login_If_Not_Ahenticated();
		...
		public virtual void Import_And_Import_File_Example_AuthrorizationApps_Test()
        {
            ...
            string file_path = this.Test_Machine.Get_Downloads_Directory() + this.AuthrorizationAppBLO.Get_Import_File_Name();
	...
	public partial class Index_AuthrorizationApp_UI_Tests : Base_Index_AuthrorizationApp_UI_Tests
    {
		public Index_AuthrorizationApp_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Index_AuthrorizationApp_UI_Tests() : base(null){}
    }
}
