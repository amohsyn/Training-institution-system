...
namespace TrainingIS_UI_Tests.ControllerApps
{
    ...
    public class Base_Index_ControllerApp_UI_Tests : Base_Index_Entity_UI_Test<ControllerApp>
    {
		// GApp Context
        public UnitOfWork<TrainingISModel> UnitOfWork { set; get; }
        public GAppContext GAppContext { set; get; }
        public TrainingYear CurrentTrainingYear { set; get; }
		protected string GAppDataTable_Html_Id = "ControllerApps_Entities";
		...
		[TestMethod]
        public virtual void ControllerApp_Index_Test()
        {
           
        }
		[TestMethod]
        public virtual void Export_ControllerApps_Tests()
        {
            this.GoTo_Index_And_Login_If_Not_Ahenticated();
	...
	public partial class Index_ControllerApp_UI_Tests : Base_Index_ControllerApp_UI_Tests
    {
		public Index_ControllerApp_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Index_ControllerApp_UI_Tests() : base(null){}
    }
}
