...
namespace TrainingIS_UI_Tests.Functions
{
    ...
    public class Base_Index_Function_UI_Tests : Base_Index_Entity_UI_Test<Function>
    {
		// GApp Context
		...
		[TestMethod]
        public virtual void Function_Index_Test()
        {
           
        }
		[TestMethod]
        public virtual void Export_Functions_Tests()
        {
            this.GoTo_Index_And_Login_If_Not_Ahenticated();
		...
		[TestMethod]
        public virtual void Export_Import_File_Example_Functions_Test()
        {
            this.GoTo_Index_And_Login_If_Not_Ahenticated();
		...
		[TestMethod]
        public virtual void Import_Functions_Test()
        {
            Assert.Fail();
        }
	...
	public partial class Index_Function_UI_Tests : Base_Index_Function_UI_Tests
    {
		public Index_Function_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Index_Function_UI_Tests() : base(null){}
    }
}
