...
namespace TrainingIS_UI_Tests.Classrooms
{
    ...
    public class Base_Index_Classroom_UI_Tests : Base_Index_Entity_UI_Test<Classroom>
    {
		...
		protected string GAppDataTable_Html_Id = "Classrooms_Entities";
		...
		public Base_Index_Classroom_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void Classroom_Index_Test()
        {
           
        }
		[TestMethod]
        public virtual void Export_Classrooms_Tests()
        {
            this.GoTo_Index_And_Login_If_Not_Ahenticated();
		...
		[TestMethod]
		public virtual void Import_And_Import_File_Example_Classrooms_Test()
        {
            this.GoTo_Index_And_Login_If_Not_Ahenticated();
            ...
            string file_path = this.Test_Machine.Get_Downloads_Directory() + this.ClassroomBLO.Get_Import_File_Name();
	...
	public partial class Index_Classroom_UI_Tests : Base_Index_Classroom_UI_Tests
    {
		public Index_Classroom_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Index_Classroom_UI_Tests() : base(null){}
    }
}
