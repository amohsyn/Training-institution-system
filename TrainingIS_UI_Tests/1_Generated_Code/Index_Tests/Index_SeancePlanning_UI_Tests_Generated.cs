...
namespace TrainingIS_UI_Tests.SeancePlannings
{
    ...
    public class Base_Index_SeancePlanning_UI_Tests : Base_Index_Entity_UI_Test<SeancePlanning>
    {
		...
		protected string GAppDataTable_Html_Id = "SeancePlannings_entities";
		...
		[TestMethod]
		public virtual void Import_And_Import_File_Example_SeancePlannings_Test()
        {
            this.GoTo_Index_And_Login_If_Not_Ahenticated();
            ...
            string file_path = this.Test_Machine.Get_Downloads_Directory() + this.SeancePlanningBLO.Get_Import_File_Name();
