...
namespace TrainingIS_UI_Tests.TrainingLevels
{
    ...
    public class Base_Index_TrainingLevel_UI_Tests : Base_Index_Entity_UI_Test<TrainingLevel>
    {
		// GApp Context
        public UnitOfWork<TrainingISModel> UnitOfWork { set; get; }
        public GAppContext GAppContext { set; get; }
        public TrainingYear CurrentTrainingYear { set; get; }
		protected string GAppDataTable_Html_Id = "TrainingLevels_entities";
		...
		[TestMethod]
        public virtual void Export_TrainingLevels_Tests()
        {
            this.GoTo_Index_And_Login_If_Not_Ahenticated();
		...
		[TestMethod]
		public virtual void Import_And_Import_File_Example_TrainingLevels_Test()
        {
            this.GoTo_Index_And_Login_If_Not_Ahenticated();
            ...
            string file_path = this.Test_Machine.Get_Downloads_Directory() + this.TrainingLevelBLO.Get_Import_File_Name();
