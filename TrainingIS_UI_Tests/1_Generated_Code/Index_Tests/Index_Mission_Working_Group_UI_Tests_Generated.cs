...
namespace TrainingIS_UI_Tests.Mission_Working_Groups
{
    ...
    public class Base_Index_Mission_Working_Group_UI_Tests : Base_Index_Entity_UI_Test<Mission_Working_Group>
    {
		// GApp Context
        public UnitOfWork<TrainingISModel> UnitOfWork { set; get; }
        public GAppContext GAppContext { set; get; }
        public TrainingYear CurrentTrainingYear { set; get; }
		protected string GAppDataTable_Html_Id = "Mission_Working_Groups_entities";
		...
		public Base_Index_Mission_Working_Group_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void Mission_Working_Group_Index_Test()
        {
           
        }
		[TestMethod]
        public virtual void Export_Mission_Working_Groups_Tests()
        {
            this.GoTo_Index_And_Login_If_Not_Ahenticated();
		...
		[TestMethod]
		public virtual void Import_And_Import_File_Example_Mission_Working_Groups_Test()
        {
            this.GoTo_Index_And_Login_If_Not_Ahenticated();

			this.Mission_Working_GroupBLO.Save(this.Valide_Entity_Instance);
            ...
            string file_path = this.Test_Machine.Get_Downloads_Directory() + this.Mission_Working_GroupBLO.Get_Import_File_Name();
	...
	public partial class Index_Mission_Working_Group_UI_Tests : Base_Index_Mission_Working_Group_UI_Tests
    {
		public Index_Mission_Working_Group_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Index_Mission_Working_Group_UI_Tests() : base(null){}
    }
}
