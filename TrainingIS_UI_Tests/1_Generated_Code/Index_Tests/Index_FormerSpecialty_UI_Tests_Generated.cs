...
namespace TrainingIS_UI_Tests.FormerSpecialties
{
    ...
    public class Base_Index_FormerSpecialty_UI_Tests : Base_Index_Entity_UI_Test<FormerSpecialty>
    {
		// GApp Context
        public UnitOfWork<TrainingISModel> UnitOfWork { set; get; }
        public GAppContext GAppContext { set; get; }
        public TrainingYear CurrentTrainingYear { set; get; }
		protected string GAppDataTable_Html_Id = "FormerSpecialties_entities";
		...
		public Base_Index_FormerSpecialty_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void FormerSpecialty_Index_Test()
        {
           
        }
		[TestMethod]
        public virtual void Export_FormerSpecialties_Tests()
        {
            this.GoTo_Index_And_Login_If_Not_Ahenticated();
		...
		[TestMethod]
		public virtual void Import_And_Import_File_Example_FormerSpecialties_Test()
        {
            this.GoTo_Index_And_Login_If_Not_Ahenticated();
            ...
            string file_path = this.Test_Machine.Get_Downloads_Directory() + this.FormerSpecialtyBLO.Get_Import_File_Name();
	...
	public partial class Index_FormerSpecialty_UI_Tests : Base_Index_FormerSpecialty_UI_Tests
    {
		public Index_FormerSpecialty_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Index_FormerSpecialty_UI_Tests() : base(null){}
    }
}
