...
namespace TrainingIS_UI_Tests.Trainings
{
    ...
    public class Base_Index_Training_UI_Tests : Base_Index_Entity_UI_Test<Training>
    {
		// GApp Context
        public UnitOfWork<TrainingISModel> UnitOfWork { set; get; }
        public GAppContext GAppContext { set; get; }
        public TrainingYear CurrentTrainingYear { set; get; }
		protected string GAppDataTable_Html_Id = "Trainings_Entities";
		...
		[TestMethod]
        public virtual void Training_Index_Test()
        {
           
        }
		[TestMethod]
        public virtual void Export_Trainings_Tests()
        {
            this.GoTo_Index_And_Login_If_Not_Ahenticated();
		...
		public virtual void Import_And_Import_File_Example_Trainings_Test()
        {
            ...
            string file_path = this.Test_Machine.Get_Downloads_Directory() + this.TrainingBLO.Get_Import_File_Name();
	...
	public partial class Index_Training_UI_Tests : Base_Index_Training_UI_Tests
    {
		public Index_Training_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Index_Training_UI_Tests() : base(null){}
    }
}
