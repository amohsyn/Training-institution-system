...
namespace TrainingIS_UI_Tests.Category_WarningTrainees
{
    ...
    public class Base_Index_Category_WarningTrainee_UI_Tests : Base_Index_Entity_UI_Test<Category_WarningTrainee>
    {
		...
		protected string GAppDataTable_Html_Id = "Category_WarningTrainees_entities";
		...
		[TestMethod]
        public virtual void Export_Category_WarningTrainees_Tests()
        {
            this.GoTo_Index_And_Login_If_Not_Ahenticated();
		...
		public virtual void Import_And_Import_File_Example_Category_WarningTrainees_Test()
        {
            ...
            string file_path = this.Test_Machine.Get_Downloads_Directory() + this.Category_WarningTraineeBLO.Get_Import_File_Name();
