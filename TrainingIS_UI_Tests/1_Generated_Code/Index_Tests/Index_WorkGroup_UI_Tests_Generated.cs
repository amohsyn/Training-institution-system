...
namespace TrainingIS_UI_Tests.WorkGroups
{
    ...
    public class Base_Index_WorkGroup_UI_Tests : Base_Index_Entity_UI_Test<WorkGroup>
    {
		...
		[TestMethod]
		public virtual void Import_And_Import_File_Example_WorkGroups_Test()
        {
            this.GoTo_Index_And_Login_If_Not_Ahenticated();
            ...
            string file_path = this.Test_Machine.Get_Downloads_Directory() + this.WorkGroupBLO.Get_Import_File_Name();
