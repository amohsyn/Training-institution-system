...
namespace TrainingIS_UI_Tests.TaskProjects
{
    ...
    public class Base_Edit_TaskProject_UI_Tests : Base_Edit_Index_Entity_UI_Test<TaskProject>
    {
		// GApp Context
		...
		public Base_Edit_TaskProject_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void TaskProject_Edit_Test()
        {
            // Arrange
	...
	public partial class Edit_TaskProject_UI_Tests : Base_Edit_TaskProject_UI_Tests
    {
		public Edit_TaskProject_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Edit_TaskProject_UI_Tests() : base(null){}
    }
}
