...
namespace TrainingIS_UI_Tests.Absences
{
    ...
    public class Base_Edit_Absence_UI_Tests : Base_Edit_Index_Entity_UI_Test<Absence>
    {
		// GApp Context
		...
		public Base_Edit_Absence_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void Absence_Edit_Test()
        {
            // Arrange
	...
	public partial class Edit_Absence_UI_Tests : Base_Edit_Absence_UI_Tests
    {
		public Edit_Absence_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Edit_Absence_UI_Tests() : base(null){}
    }
}
