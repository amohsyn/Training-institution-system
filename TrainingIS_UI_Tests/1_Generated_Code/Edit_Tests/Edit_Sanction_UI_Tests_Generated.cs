...
namespace TrainingIS_UI_Tests.Sanctions
{
    ...
    public class Base_Edit_Sanction_UI_Tests : Base_Edit_Index_Entity_UI_Test<Sanction>
    {
		// GApp Context
		...
		public Base_Edit_Sanction_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void Sanction_Edit_Test()
        {
            // Arrange
	...
	public partial class Edit_Sanction_UI_Tests : Base_Edit_Sanction_UI_Tests
    {
		public Edit_Sanction_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Edit_Sanction_UI_Tests() : base(null){}
    }
}
