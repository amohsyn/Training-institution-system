...
namespace TrainingIS_UI_Tests.SanctionCategories
{
    ...
    public class Base_Edit_SanctionCategory_UI_Tests : Base_Edit_Index_Entity_UI_Test<SanctionCategory>
    {
		// GApp Context
		...
		public Base_Edit_SanctionCategory_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void SanctionCategory_Edit_Test()
        {
            // Arrange
	...
	public partial class Edit_SanctionCategory_UI_Tests : Base_Edit_SanctionCategory_UI_Tests
    {
		public Edit_SanctionCategory_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Edit_SanctionCategory_UI_Tests() : base(null){}
    }
}
