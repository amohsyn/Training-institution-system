...
namespace TrainingIS_UI_Tests.ClassroomCategories
{
    ...
    public class Base_Edit_ClassroomCategory_UI_Tests : Base_Edit_Index_Entity_UI_Test<ClassroomCategory>
    {
		// GApp Context
		...
		public Base_Edit_ClassroomCategory_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void ClassroomCategory_Edit_Test()
        {
            // Arrange
	...
	public partial class Edit_ClassroomCategory_UI_Tests : Base_Edit_ClassroomCategory_UI_Tests
    {
		public Edit_ClassroomCategory_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Edit_ClassroomCategory_UI_Tests() : base(null){}
    }
}
