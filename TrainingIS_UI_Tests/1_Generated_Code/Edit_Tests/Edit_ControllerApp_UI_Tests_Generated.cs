...
namespace TrainingIS_UI_Tests.ControllerApps
{
    ...
    public class Base_Edit_ControllerApp_UI_Tests : Base_Edit_Index_Entity_UI_Test<ControllerApp>
    {
		// GApp Context
		...
		public Base_Edit_ControllerApp_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void ControllerApp_Edit_Test()
        {
            // Arrange
	...
	public partial class Edit_ControllerApp_UI_Tests : Base_Edit_ControllerApp_UI_Tests
    {
		public Edit_ControllerApp_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Edit_ControllerApp_UI_Tests() : base(null){}
    }
}
