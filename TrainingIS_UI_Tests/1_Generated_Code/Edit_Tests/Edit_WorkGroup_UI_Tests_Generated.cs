...
namespace TrainingIS_UI_Tests.WorkGroups
{
    ...
    public class Base_Edit_WorkGroup_UI_Tests : Base_Edit_Index_Entity_UI_Test<WorkGroup>
    {
		// GApp Context
		...
		public Base_Edit_WorkGroup_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void WorkGroup_Edit_Test()
        {
            // Arrange
	...
	public partial class Edit_WorkGroup_UI_Tests : Base_Edit_WorkGroup_UI_Tests
    {
		public Edit_WorkGroup_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Edit_WorkGroup_UI_Tests() : base(null){}
    }
}
