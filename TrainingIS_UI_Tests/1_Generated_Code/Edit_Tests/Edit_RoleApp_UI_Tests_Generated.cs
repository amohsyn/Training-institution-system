...
namespace TrainingIS_UI_Tests.RoleApps
{
    ...
    public class Base_Edit_RoleApp_UI_Tests : Base_Edit_Index_Entity_UI_Test<RoleApp>
    {
		// GApp Context
		...
		public Base_Edit_RoleApp_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void RoleApp_Edit_Test()
        {
            // Arrange
	...
	public partial class Edit_RoleApp_UI_Tests : Base_Edit_RoleApp_UI_Tests
    {
		public Edit_RoleApp_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Edit_RoleApp_UI_Tests() : base(null){}
    }
}
