...
namespace TrainingIS_UI_Tests.JustificationAbsences
{
    ...
    public class Base_Edit_JustificationAbsence_UI_Tests : Create_Entity_UI_Test<JustificationAbsence>
    {
		// GApp Context
		...
		public Base_Edit_JustificationAbsence_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void JustificationAbsence_Edit_Test()
        {
	...
	public partial class Edit_JustificationAbsence_UI_Tests : Base_Edit_JustificationAbsence_UI_Tests
    {
		public Edit_JustificationAbsence_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Edit_JustificationAbsence_UI_Tests() : base(null){}
    }
}
