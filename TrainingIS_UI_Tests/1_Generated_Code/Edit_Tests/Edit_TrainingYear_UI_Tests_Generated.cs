...
namespace TrainingIS_UI_Tests.TrainingYears
{
    ...
    public class Base_Edit_TrainingYear_UI_Tests : Base_Edit_Index_Entity_UI_Test<TrainingYear>
    {
		// GApp Context
		...
		public Base_Edit_TrainingYear_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void TrainingYear_Edit_Test()
        {
            // Arrange
	...
	public partial class Edit_TrainingYear_UI_Tests : Base_Edit_TrainingYear_UI_Tests
    {
		public Edit_TrainingYear_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Edit_TrainingYear_UI_Tests() : base(null){}
    }
}
