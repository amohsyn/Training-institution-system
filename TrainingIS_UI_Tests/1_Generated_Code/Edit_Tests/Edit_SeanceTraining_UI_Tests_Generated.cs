...
namespace TrainingIS_UI_Tests.SeanceTrainings
{
    ...
    public class Base_Edit_SeanceTraining_UI_Tests : Base_Edit_Index_Entity_UI_Test<SeanceTraining>
    {
		// GApp Context
		...
		public Base_Edit_SeanceTraining_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void SeanceTraining_Edit_Test()
        {
            // Arrange
	...
	public partial class Edit_SeanceTraining_UI_Tests : Base_Edit_SeanceTraining_UI_Tests
    {
		public Edit_SeanceTraining_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Edit_SeanceTraining_UI_Tests() : base(null){}
    }
}
