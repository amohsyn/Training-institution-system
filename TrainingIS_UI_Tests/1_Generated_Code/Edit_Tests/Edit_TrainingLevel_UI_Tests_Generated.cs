...
namespace TrainingIS_UI_Tests.TrainingLevels
{
    ...
    public class Base_Edit_TrainingLevel_UI_Tests : Base_Edit_Index_Entity_UI_Test<TrainingLevel>
    {
		// GApp Context
		...
		public Base_Edit_TrainingLevel_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void TrainingLevel_Edit_Test()
        {
            // Arrange
	...
	public partial class Edit_TrainingLevel_UI_Tests : Base_Edit_TrainingLevel_UI_Tests
    {
		public Edit_TrainingLevel_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Edit_TrainingLevel_UI_Tests() : base(null){}
    }
}
