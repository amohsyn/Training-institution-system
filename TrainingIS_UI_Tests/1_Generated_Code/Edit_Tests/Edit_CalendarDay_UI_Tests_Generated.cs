...
namespace TrainingIS_UI_Tests.CalendarDays
{
    ...
    public class Base_Edit_CalendarDay_UI_Tests : Base_Edit_Index_Entity_UI_Test<CalendarDay>
    {
		// GApp Context
		...
		public Base_Edit_CalendarDay_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void CalendarDay_Edit_Test()
        {
            // Arrange
	...
	public partial class Edit_CalendarDay_UI_Tests : Base_Edit_CalendarDay_UI_Tests
    {
		public Edit_CalendarDay_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Edit_CalendarDay_UI_Tests() : base(null){}
    }
}
