...
namespace TrainingIS_UI_Tests.Trainees
{
    ...
    public class Base_Edit_Trainee_UI_Tests : Base_Edit_Index_Entity_UI_Test<Trainee>
    {
		// GApp Context
		...
		public Base_Edit_Trainee_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void Trainee_Edit_Test()
        {
            // Arrange
	...
	public partial class Edit_Trainee_UI_Tests : Base_Edit_Trainee_UI_Tests
    {
		public Edit_Trainee_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Edit_Trainee_UI_Tests() : base(null){}
    }
}
