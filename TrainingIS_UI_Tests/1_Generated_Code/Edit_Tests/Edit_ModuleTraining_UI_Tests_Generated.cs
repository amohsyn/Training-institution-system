...
namespace TrainingIS_UI_Tests.ModuleTrainings
{
    ...
    public class Base_Edit_ModuleTraining_UI_Tests : Base_Edit_Index_Entity_UI_Test<ModuleTraining>
    {
		// GApp Context
		...
		public Base_Edit_ModuleTraining_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void ModuleTraining_Edit_Test()
        {
            // Arrange
	...
	public partial class Edit_ModuleTraining_UI_Tests : Base_Edit_ModuleTraining_UI_Tests
    {
		public Edit_ModuleTraining_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Edit_ModuleTraining_UI_Tests() : base(null){}
    }
}
