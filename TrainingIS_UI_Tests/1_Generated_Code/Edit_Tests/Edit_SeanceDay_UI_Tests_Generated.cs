...
namespace TrainingIS_UI_Tests.SeanceDays
{
    ...
    public class Base_Edit_SeanceDay_UI_Tests : Base_Edit_Index_Entity_UI_Test<SeanceDay>
    {
		// GApp Context
		...
		public Base_Edit_SeanceDay_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void SeanceDay_Edit_Test()
        {
            // Arrange
	...
	public partial class Edit_SeanceDay_UI_Tests : Base_Edit_SeanceDay_UI_Tests
    {
		public Edit_SeanceDay_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Edit_SeanceDay_UI_Tests() : base(null){}
    }
}
