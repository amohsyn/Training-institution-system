...
namespace TrainingIS_UI_Tests.ActionControllerApps
{
    ...
    public class Base_Edit_ActionControllerApp_UI_Tests : Base_Edit_Index_Entity_UI_Test<ActionControllerApp>
    {
		// GApp Context
		...
		public Base_Edit_ActionControllerApp_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void ActionControllerApp_Edit_Test()
        {
            // Arrange
	...
	public partial class Edit_ActionControllerApp_UI_Tests : Base_Edit_ActionControllerApp_UI_Tests
    {
		public Edit_ActionControllerApp_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Edit_ActionControllerApp_UI_Tests() : base(null){}
    }
}
