...
namespace TrainingIS_UI_Tests.Sectors
{
	...
	[TestCategory("Sector")]
    public class Base_Filter_Sector_UI_Tests : Base_Index_Entity_UI_Test<Sector>
    {
        // GApp Context
		...
		[TestMethod]
        public virtual void Sector_Search_Test()
        {
            // Arrange
    ...
    [TestClass]
    [TestCategory("Sectors")]
	public partial class Filter_Sector_UI_Tests : Base_Filter_Sector_UI_Tests
    {
		public Filter_Sector_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Filter_Sector_UI_Tests() : base(null){}
    }
}
