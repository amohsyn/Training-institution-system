...
namespace TrainingIS_UI_Tests.SanctionCategories
{
    ...
    public class Base_Filter_SanctionCategory_UI_Tests : Index_Entity_UI_Test<SanctionCategory>
    {
        // GApp Context
        ...
        public virtual void Search_Test()
        {
            ...
            string SearchText = SanctionCategory_TestData.Get_TestData().First().Reference;
