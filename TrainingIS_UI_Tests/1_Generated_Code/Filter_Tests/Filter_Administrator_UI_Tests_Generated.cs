...
namespace TrainingIS_UI_Tests.Administrators
{
    ...
    public class Base_Filter_Administrator_UI_Tests : Index_Entity_UI_Test<Administrator>
    {
        // GApp Context
        ...
        public virtual void Search_Test()
        {
            ...
            string SearchText = Administrator_TestData.Get_TestData().First().Reference;
