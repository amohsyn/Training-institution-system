...
namespace TrainingIS_UI_Tests.RoleApps
{
    ...
    public class Base_Filter_RoleApp_UI_Tests : Base_Index_Entity_UI_Test<RoleApp>
    {
        // GApp Context
        ...
        public Base_Filter_RoleApp_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context)
        {
        }
        ...
        public virtual void Search_Test()
        {
            ...
            string SearchText = RoleApp_TestData.Get_TestData().First().Reference;
    ...
    [TestClass]
    [TestCategory("RoleApps")]
	public partial class Filter_RoleApp_UI_Tests : Base_Filter_RoleApp_UI_Tests
    {
		public Filter_RoleApp_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Filter_RoleApp_UI_Tests() : base(null){}
    }
}
