...
namespace TrainingIS_UI_Tests.Category_JustificationAbsences
{
    ...
    public class Base_Filter_Category_JustificationAbsence_UI_Tests : Base_Index_Entity_UI_Test<Category_JustificationAbsence>
    {
        // GApp Context
        ...
        public Base_Filter_Category_JustificationAbsence_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context)
        {
        }
        ...
        public virtual void Search_Test()
        {
            ...
            string SearchText = Category_JustificationAbsence_TestData.Get_TestData().First().Reference;
    ...
    [TestClass]
    [TestCategory("Category_JustificationAbsences")]
	public partial class Filter_Category_JustificationAbsence_UI_Tests : Base_Filter_Category_JustificationAbsence_UI_Tests
    {
		public Filter_Category_JustificationAbsence_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Filter_Category_JustificationAbsence_UI_Tests() : base(null){}
    }
}
