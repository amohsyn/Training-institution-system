...
namespace TrainingIS_UI_Tests.JustificationAbsences
{
    ...
    public class Base_Filter_JustificationAbsence_UI_Tests : Index_Entity_UI_Test<JustificationAbsence>
    {
        // GApp Context
        ...
        public virtual void Search_Test()
        {
            ...
            string SearchText = JustificationAbsence_TestData.Get_TestData().First().Reference;
