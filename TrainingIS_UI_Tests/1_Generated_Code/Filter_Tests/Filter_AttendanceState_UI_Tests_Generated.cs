...
namespace TrainingIS_UI_Tests.AttendanceStates
{
    ...
    public class Base_Filter_AttendanceState_UI_Tests : Index_Entity_UI_Test<AttendanceState>
    {
        // GApp Context
        ...
        public virtual void Search_Test()
        {
            ...
            string SearchText = AttendanceState_TestData.Get_TestData().First().Reference;
