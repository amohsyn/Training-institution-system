...
namespace TrainingIS_UI_Tests.Mission_Working_Groups
{
    ...
    public class Base_Filter_Mission_Working_Group_UI_Tests : Base_Index_Entity_UI_Test<Mission_Working_Group>
    {
        // GApp Context
        ...
        public Base_Filter_Mission_Working_Group_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context)
        {
        }
		...
		[TestMethod]
        public virtual void Mission_Working_Group_Search_Test()
        {
            // Arrange
            // Add Mission_Working_Group to be Edited
    ...
    [TestClass]
    [TestCategory("Mission_Working_Groups")]
	public partial class Filter_Mission_Working_Group_UI_Tests : Base_Filter_Mission_Working_Group_UI_Tests
    {
		public Filter_Mission_Working_Group_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Filter_Mission_Working_Group_UI_Tests() : base(null){}
    }
}
