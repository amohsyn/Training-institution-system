...
namespace TrainingIS_UI_Tests.ApplicationParams
{
    ...
    public class Base_Filter_ApplicationParam_UI_Tests : Index_Entity_UI_Test<ApplicationParam>
    {
        // GApp Context
        ...
        public virtual void Search_Test()
        {
            ...
            string SearchText = ApplicationParam_TestData.Get_TestData().First().Reference;
