...
namespace TrainingIS_UI_Tests.EntityPropertyShortcuts
{
    ...
    public class Base_Filter_EntityPropertyShortcut_UI_Tests : Index_Entity_UI_Test<EntityPropertyShortcut>
    {
        // GApp Context
        ...
        public virtual void Search_Test()
        {
            ...
            string SearchText = EntityPropertyShortcut_TestData.Get_TestData().First().Reference;
