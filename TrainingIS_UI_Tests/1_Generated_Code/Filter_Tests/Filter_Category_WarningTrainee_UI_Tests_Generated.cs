...
namespace TrainingIS_UI_Tests.Category_WarningTrainees
{
    ...
    public class Base_Filter_Category_WarningTrainee_UI_Tests : Index_Entity_UI_Test<Category_WarningTrainee>
    {
        // GApp Context
        ...
        public virtual void Search_Test()
        {
            ...
            string SearchText = Category_WarningTrainee_TestData.Get_TestData().First().Reference;
