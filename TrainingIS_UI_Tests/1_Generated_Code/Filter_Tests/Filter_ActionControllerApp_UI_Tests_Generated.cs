...
namespace TrainingIS_UI_Tests.ActionControllerApps
{
    ...
    public class Base_Filter_ActionControllerApp_UI_Tests : Index_Entity_UI_Test<ActionControllerApp>
    {
        // GApp Context
        ...
        public virtual void Search_Test()
        {
            ...
            string SearchText = ActionControllerApp_TestData.Get_TestData().First().Reference;
