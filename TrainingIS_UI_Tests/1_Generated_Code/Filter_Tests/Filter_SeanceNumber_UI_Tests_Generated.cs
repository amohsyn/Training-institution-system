...
namespace TrainingIS_UI_Tests.SeanceNumbers
{
    ...
    public class Base_Filter_SeanceNumber_UI_Tests : Base_Index_Entity_UI_Test<SeanceNumber>
    {
        // GApp Context
        ...
        public Base_Filter_SeanceNumber_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context)
        {
        }
		...
		[TestMethod]
        public virtual void SeanceNumber_Search_Test()
        {
            // Arrange
    ...
    [TestClass]
    [TestCategory("SeanceNumbers")]
	public partial class Filter_SeanceNumber_UI_Tests : Base_Filter_SeanceNumber_UI_Tests
    {
		public Filter_SeanceNumber_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Filter_SeanceNumber_UI_Tests() : base(null){}
    }
}
