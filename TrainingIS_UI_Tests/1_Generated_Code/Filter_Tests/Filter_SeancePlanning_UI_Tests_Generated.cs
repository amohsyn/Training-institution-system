...
namespace TrainingIS_UI_Tests.SeancePlannings
{
    ...
    public class Base_Filter_SeancePlanning_UI_Tests : Index_Entity_UI_Test<SeancePlanning>
    {
        // GApp Context
        ...
        public virtual void Search_Test()
        {
            ...
            string SearchText = SeancePlanning_TestData.Get_TestData().First().Reference;
