...
namespace TrainingIS_UI_Tests.TaskProjects
{
    ...
    public class Base_Filter_TaskProject_UI_Tests : Base_Index_Entity_UI_Test<TaskProject>
    {
        // GApp Context
        ...
        public virtual void Search_Test()
        {
            ...
            string SearchText = TaskProject_TestData.Get_TestData().First().Reference;
    ...
    [TestClass]
    [TestCategory("TaskProjects")]
	public partial class Filter_TaskProject_UI_Tests : Base_Filter_TaskProject_UI_Tests
    {
		public Filter_TaskProject_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Filter_TaskProject_UI_Tests() : base(null){}
    }
}
