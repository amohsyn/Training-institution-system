...
namespace TrainingIS_UI_Tests.StateOfAbseces
{
    ...
    public class Base_Filter_StateOfAbsece_UI_Tests : Base_Index_Entity_UI_Test<StateOfAbsece>
    {
        // GApp Context
        ...
        public Base_Filter_StateOfAbsece_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context)
        {
        }
        ...
        public virtual void Search_Test()
        {
            ...
            string SearchText = StateOfAbsece_TestData.Get_TestData().First().Reference;
    ...
    [TestClass]
    [TestCategory("StateOfAbseces")]
	public partial class Filter_StateOfAbsece_UI_Tests : Base_Filter_StateOfAbsece_UI_Tests
    {
		public Filter_StateOfAbsece_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Filter_StateOfAbsece_UI_Tests() : base(null){}
    }
}
