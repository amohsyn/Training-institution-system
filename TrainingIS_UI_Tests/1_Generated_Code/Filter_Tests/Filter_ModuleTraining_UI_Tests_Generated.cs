...
namespace TrainingIS_UI_Tests.ModuleTrainings
{
    ...
    public class Base_Filter_ModuleTraining_UI_Tests : Base_Index_Entity_UI_Test<ModuleTraining>
    {
        // GApp Context
        ...
        public Base_Filter_ModuleTraining_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context)
        {
        }
 
        
		[TestMethod]
        public virtual void ModuleTraining_Search_Test()
        {
            // Arrange
            // Add ModuleTraining to be Edited
    ...
    [TestClass]
    [TestCategory("ModuleTrainings")]
	public partial class Filter_ModuleTraining_UI_Tests : Base_Filter_ModuleTraining_UI_Tests
    {
		public Filter_ModuleTraining_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Filter_ModuleTraining_UI_Tests() : base(null){}
    }
}
