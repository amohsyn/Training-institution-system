...
namespace TrainingIS_UI_Tests.Specialties
{
    ...
    public class Base_Filter_Specialty_UI_Tests : Index_Entity_UI_Test<Specialty>
    {
        // GApp Context
        ...
        public Base_Filter_Specialty_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context)
        {
        }
        ...
        public virtual void Search_Test()
        {
            ...
            string SearchText = Specialty_TestData.Get_TestData().First().Reference;
    ...
    [TestClass]
    [TestCategory("Specialties")]
	public partial class Filter_Specialty_UI_Tests : Base_Filter_Specialty_UI_Tests
    {
		public Filter_Specialty_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Filter_Specialty_UI_Tests() : base(null){}
    }
}
