...
namespace TrainingIS_UI_Tests.Functions
{
    ...
    public class Base_Filter_Function_UI_Tests : Base_Index_Entity_UI_Test<Function>
    {
        // GApp Context
        ...
        public virtual void Search_Test()
        {
            ...
            string SearchText = Function_TestData.Get_TestData().First().Reference;
	...
	public partial class Filter_Function_UI_Tests : Base_Filter_Function_UI_Tests
    {
		public Filter_Function_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Filter_Function_UI_Tests() : base(null){}
    }
}
