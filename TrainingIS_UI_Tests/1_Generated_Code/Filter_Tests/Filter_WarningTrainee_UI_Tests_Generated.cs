...
namespace TrainingIS_UI_Tests.WarningTrainees
{
    ...
    public class Base_Filter_WarningTrainee_UI_Tests : Index_Entity_UI_Test<WarningTrainee>
    {
        // GApp Context
        ...
        public virtual void Search_Test()
        {
            ...
            string SearchText = WarningTrainee_TestData.Get_TestData().First().Reference;
