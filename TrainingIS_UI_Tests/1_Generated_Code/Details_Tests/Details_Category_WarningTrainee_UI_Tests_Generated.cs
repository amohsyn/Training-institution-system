...
namespace TrainingIS_UI_Tests.Category_WarningTrainees
{
    ...
    public class Base_Details_Category_WarningTrainee_UI_Tests : Base_Delete_Entity_UI_Test<Category_WarningTrainee>
    {
		// GApp Context
		...
		public Base_Details_Category_WarningTrainee_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void Category_WarningTrainee_Details_Edit_Test()
        {
	...
	public partial class Details_Category_WarningTrainee_UI_Tests : Base_Details_Category_WarningTrainee_UI_Tests
    {
		public Details_Category_WarningTrainee_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Details_Category_WarningTrainee_UI_Tests() : base(null){}
    }
}
