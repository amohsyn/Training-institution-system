...
namespace TrainingIS_UI_Tests.Schedules
{
    ...
    public class Base_Details_Schedule_UI_Tests : Base_Delete_Entity_UI_Test<Schedule>
    {
		// GApp Context
		...
		public Base_Details_Schedule_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void Schedule_Details_Edit_Test()
        {
	...
	public partial class Details_Schedule_UI_Tests : Base_Details_Schedule_UI_Tests
    {
		public Details_Schedule_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Details_Schedule_UI_Tests() : base(null){}
    }
}
