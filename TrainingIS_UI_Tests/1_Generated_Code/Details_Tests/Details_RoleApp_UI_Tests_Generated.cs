...
namespace TrainingIS_UI_Tests.RoleApps
{
    ...
    public class Base_Details_RoleApp_UI_Tests : Base_Delete_Entity_UI_Test<RoleApp>
    {
		// GApp Context
		...
		public Base_Details_RoleApp_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
	...
	public partial class Details_RoleApp_UI_Tests : Base_Details_RoleApp_UI_Tests
    {
		public Details_RoleApp_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Details_RoleApp_UI_Tests() : base(null){}
    }
}
