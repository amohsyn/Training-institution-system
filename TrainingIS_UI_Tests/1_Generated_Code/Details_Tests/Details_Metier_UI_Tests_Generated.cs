...
namespace TrainingIS_UI_Tests.Metiers
{
	...
	[TestCategory("Metier")]
    public class Base_Details_Metier_UI_Tests : Base_Delete_Entity_UI_Test<Metier>
    {
		// GApp Context
		...
		public Base_Details_Metier_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void Metier_Details_Edit_Test()
        {
	...
	public partial class Details_Metier_UI_Tests : Base_Details_Metier_UI_Tests
    {
		public Details_Metier_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Details_Metier_UI_Tests() : base(null){}
    }
}
