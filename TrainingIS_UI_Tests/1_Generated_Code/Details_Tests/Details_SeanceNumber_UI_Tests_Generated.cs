...
namespace TrainingIS_UI_Tests.SeanceNumbers
{
    ...
    public class Base_Details_SeanceNumber_UI_Tests : Base_Delete_Entity_UI_Test<SeanceNumber>
    {
		...
		public Base_Details_SeanceNumber_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void SeanceNumber_Details_Edit_Test()
        {
	...
	public partial class Details_SeanceNumber_UI_Tests : Base_Details_SeanceNumber_UI_Tests
    {
		public Details_SeanceNumber_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Details_SeanceNumber_UI_Tests() : base(null){}
    }
}
