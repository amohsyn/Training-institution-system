...
namespace TrainingIS_UI_Tests.FormerSpecialties
{
    ...
    public class Base_Details_FormerSpecialty_UI_Tests : Base_Delete_Entity_UI_Test<FormerSpecialty>
    {
		// GApp Context
		...
		public Base_Details_FormerSpecialty_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void FormerSpecialty_Details_Edit_Test()
        {
	...
	public partial class Details_FormerSpecialty_UI_Tests : Base_Details_FormerSpecialty_UI_Tests
    {
		public Details_FormerSpecialty_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Details_FormerSpecialty_UI_Tests() : base(null){}
    }
}
