...
namespace TrainingIS_UI_Tests.DisciplineCategories
{
    ...
    public class Base_Details_DisciplineCategory_UI_Tests : Create_Entity_UI_Test<DisciplineCategory>
    {
		// GApp Context
		...
		public Base_Details_DisciplineCategory_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void DisciplineCategory_Details_Test()
        {
	...
	public partial class Details_DisciplineCategory_UI_Tests : Base_Details_DisciplineCategory_UI_Tests
    {
		public Details_DisciplineCategory_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Details_DisciplineCategory_UI_Tests() : base(null){}
    }
}
