...
namespace TrainingIS_UI_Tests.Nationalities
{
    ...
    public class Base_Details_Nationality_UI_Tests : Base_Delete_Entity_UI_Test<Nationality>
    {
		// GApp Context
		...
		public Base_Details_Nationality_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void Nationality_Details_Edit_Test()
        {
	...
	public partial class Details_Nationality_UI_Tests : Base_Details_Nationality_UI_Tests
    {
		public Details_Nationality_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Details_Nationality_UI_Tests() : base(null){}
    }
}
