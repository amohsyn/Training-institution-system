...
namespace TrainingIS_UI_Tests.CalendarDays
{
    ...
    public class Base_Details_CalendarDay_UI_Tests : Base_Delete_Entity_UI_Test<CalendarDay>
    {
		// GApp Context
		...
		public Base_Details_CalendarDay_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void CalendarDay_Details_Edit_Test()
        {
	...
	public partial class Details_CalendarDay_UI_Tests : Base_Details_CalendarDay_UI_Tests
    {
		public Details_CalendarDay_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Details_CalendarDay_UI_Tests() : base(null){}
    }
}
