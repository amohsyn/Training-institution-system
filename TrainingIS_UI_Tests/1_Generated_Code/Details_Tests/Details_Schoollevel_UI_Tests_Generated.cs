...
namespace TrainingIS_UI_Tests.Schoollevels
{
    ...
    public class Base_Details_Schoollevel_UI_Tests : Base_Delete_Entity_UI_Test<Schoollevel>
    {
		// GApp Context
		...
		public Base_Details_Schoollevel_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void Schoollevel_Details_Edit_Test()
        {
	...
	public partial class Details_Schoollevel_UI_Tests : Base_Details_Schoollevel_UI_Tests
    {
		public Details_Schoollevel_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Details_Schoollevel_UI_Tests() : base(null){}
    }
}
