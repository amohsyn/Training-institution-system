...
namespace TrainingIS_UI_Tests.ControllerApps
{
	...
	[TestCategory("ControllerApp")]
    public class Base_Details_ControllerApp_UI_Tests : Base_Delete_Entity_UI_Test<ControllerApp>
    {
		// GApp Context
		...
		public Base_Details_ControllerApp_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void ControllerApp_Details_Edit_Test()
        {
            // Add ControllerApp to be Edited
	...
	public partial class Details_ControllerApp_UI_Tests : Base_Details_ControllerApp_UI_Tests
    {
		public Details_ControllerApp_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Details_ControllerApp_UI_Tests() : base(null){}
    }
}
