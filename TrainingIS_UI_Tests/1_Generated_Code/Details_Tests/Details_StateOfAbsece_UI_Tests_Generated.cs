...
namespace TrainingIS_UI_Tests.StateOfAbseces
{
    ...
    public class Base_Details_StateOfAbsece_UI_Tests : Create_Entity_UI_Test<StateOfAbsece>
    {
		// GApp Context
		...
		public Base_Details_StateOfAbsece_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void StateOfAbsece_Details_Test()
        {
	...
	public partial class Details_StateOfAbsece_UI_Tests : Base_Details_StateOfAbsece_UI_Tests
    {
		public Details_StateOfAbsece_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Details_StateOfAbsece_UI_Tests() : base(null){}
    }
}
