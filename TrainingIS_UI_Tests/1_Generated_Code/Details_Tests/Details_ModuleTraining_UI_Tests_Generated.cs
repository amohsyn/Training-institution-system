...
namespace TrainingIS_UI_Tests.ModuleTrainings
{
    ...
    public class Base_Details_ModuleTraining_UI_Tests : Base_Delete_Entity_UI_Test<ModuleTraining>
    {
		// GApp Context
		...
		public Base_Details_ModuleTraining_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void ModuleTraining_Details_Edit_Test()
        {
	...
	public partial class Details_ModuleTraining_UI_Tests : Base_Details_ModuleTraining_UI_Tests
    {
		public Details_ModuleTraining_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Details_ModuleTraining_UI_Tests() : base(null){}
    }
}
