...
namespace TrainingIS_UI_Tests.LogWorks
{
    ...
    public class Base_Details_LogWork_UI_Tests : Base_Delete_Entity_UI_Test<LogWork>
    {
		// GApp Context
        ...
        protected override void Constructor(UI_Test_Context UI_Test_Context)
        {
            ...
            this.Valide_Entity_Instance = LogWork_TestData.Create_CRUD_LogWork_Test_Instance();
            this.Valide_Entity_Instance.Reference = this.Entity_Reference;
        }

		public Base_Details_LogWork_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void LogWork_Details_Edit_Test()
        {
	...
	public partial class Details_LogWork_UI_Tests : Base_Details_LogWork_UI_Tests
    {
		public Details_LogWork_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Details_LogWork_UI_Tests() : base(null){}
    }
}
