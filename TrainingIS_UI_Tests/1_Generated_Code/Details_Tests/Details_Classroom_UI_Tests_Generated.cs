...
namespace TrainingIS_UI_Tests.Classrooms
{
    ...
    public class Base_Details_Classroom_UI_Tests : Base_Delete_Entity_UI_Test<Classroom>
    {
		// GApp Context
		...
		public Base_Details_Classroom_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void Classroom_Details_Edit_Test()
        {
	...
	public partial class Details_Classroom_UI_Tests : Base_Details_Classroom_UI_Tests
    {
		public Details_Classroom_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Details_Classroom_UI_Tests() : base(null){}
    }
}
