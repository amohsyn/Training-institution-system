...
namespace TrainingIS_UI_Tests.WorkGroups
{
    ...
    public class Base_Details_WorkGroup_UI_Tests : Create_Entity_UI_Test<WorkGroup>
    {
		// GApp Context
		...
		public Base_Details_WorkGroup_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void WorkGroup_Details_Test()
        {
	...
	public partial class Details_WorkGroup_UI_Tests : Base_Details_WorkGroup_UI_Tests
    {
		public Details_WorkGroup_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Details_WorkGroup_UI_Tests() : base(null){}
    }
}
