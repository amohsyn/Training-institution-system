...
namespace TrainingIS_UI_Tests.Groups
{
	...
	[TestCategory("Group")]
    public class Base_Details_Group_UI_Tests : Base_Delete_Entity_UI_Test<Group>
    {
		// GApp Context
		...
		public Base_Details_Group_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void Group_Details_Edit_Test()
        {
	...
	public partial class Details_Group_UI_Tests : Base_Details_Group_UI_Tests
    {
		public Details_Group_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Details_Group_UI_Tests() : base(null){}
    }
}
