...
{
    public class Base_FormerSpecialty_Create_UI_Tests : Base_UI_Tests
    {
       

        public Base_FormerSpecialty_Create_UI_Tests()
        {
    ...
    [TestClass]
	public partial class FormerSpecialty_Create_UI_Tests : Base_FormerSpecialty_Create_UI_Tests
    {
