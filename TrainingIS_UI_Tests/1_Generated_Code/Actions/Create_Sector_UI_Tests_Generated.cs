...
namespace TrainingIS_UI_Tests.Sectors
{
    public class Base_Create_Sector_UI_Tests : Create_Entity_UI_Test<Sector>
    {
        ...
        public virtual void InitData()
        {
            ...
            {
                Sector_TestData.Insert_Test_Data_If_Not_Exist();
                this.CleanData();
        ...
        {
            Sector_UI_Create(this.Valide_Entity_Insrance);
        ...
        public virtual void Sector_UI_Create(Sector Sector)
        {
			...
			var Reference = b.FindElement(By.Id(nameof(Default_Form_Sector_Model.Reference)));
            Reference.SendKeys(Default_Form_Sector_Model.Reference.ToString());
