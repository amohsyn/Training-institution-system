...
namespace TrainingIS_UI_Tests.Schoollevels
{
    public class Base_Create_Schoollevel_UI_Tests : Create_Entity_UI_Test<Schoollevel>
    {
        ...
        {
            Schoollevel_Create(this.Valide_Entity_Insrance);
        }
 
        public virtual void Schoollevel_Create(Schoollevel Schoollevel)
        {
             this.GoTo_Index_And_Login_If_Not_Ahenticated();
        ...
        {
            this.CleanData();
            this.Valide_Entity_Insrance = new SchoollevelTestDataFactory(null, this.GAppContext).CreateValideSchoollevelInstance();
        ...
        {
            base.CleanData();
            // Delete Schoollevel_CRUD_Test if Exist
            SchoollevelBLO SchoollevelBLO = new SchoollevelBLO(this.UnitOfWork, this.GAppContext);
            Schoollevel existante_entity = SchoollevelBLO.FindBaseEntityByReference(this.Entity_Reference);
            if (existante_entity != null)
                SchoollevelBLO.Delete(existante_entity);
