...
{
    public class Base_Schoollevel_UI_Tests : Base_UI_Tests
    {
       

        public Base_Schoollevel_UI_Tests()
        {
    ...
    [TestClass]
	public partial class Schoollevel_UI_Tests : Base_Schoollevel_UI_Tests
    {
