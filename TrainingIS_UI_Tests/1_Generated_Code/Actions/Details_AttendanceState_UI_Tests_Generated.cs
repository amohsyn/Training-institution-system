...
namespace TrainingIS_UI_Tests.AttendanceStates
{
    ...
    public class Base_Details_AttendanceState_UI_Tests : Create_Entity_UI_Test<AttendanceState>
    {
		// GApp Context
		...
		public Base_Details_AttendanceState_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void AttendanceState_Details_Test()
        {
	...
	public partial class Details_AttendanceState_UI_Tests : Base_Details_AttendanceState_UI_Tests
    {
		public Details_AttendanceState_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Details_AttendanceState_UI_Tests() : base(null){}
    }
}
