...
{
    public class Base_ClassroomCategory_UI_Tests : Base_UI_Tests
    {
       

        public Base_ClassroomCategory_UI_Tests()
        {
    ...
    [TestClass]
	public partial class ClassroomCategory_UI_Tests : Base_ClassroomCategory_UI_Tests
    {
