...
namespace TrainingIS_UI_Tests.WarningTrainees
{
    ...
    public class Base_Edit_WarningTrainee_UI_Tests : Create_Entity_UI_Test<WarningTrainee>
    {
		// GApp Context
		...
		public Base_Edit_WarningTrainee_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void WarningTrainee_Edit_Test()
        {
	...
	public partial class Edit_WarningTrainee_UI_Tests : Base_Edit_WarningTrainee_UI_Tests
    {
		public Edit_WarningTrainee_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Edit_WarningTrainee_UI_Tests() : base(null){}
    }
}
