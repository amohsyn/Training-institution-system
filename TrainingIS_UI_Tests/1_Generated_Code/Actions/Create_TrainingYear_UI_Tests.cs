...
namespace TrainingIS_UI_Tests.TrainingYears
{
    public class Base_Create_TrainingYear_UI_Tests : Create_Entity_UI_Test<TrainingYear>
    {
        ...
        public virtual void TrainingYear_Create(TrainingYear TrainingYear)
        {
             this.GoTo_Index_And_Login_If_Not_Ahenticated();
        ...
        {
            this.CleanData();
            this.Valide_Entity_Insrance = new TrainingYearTestDataFactory(null, this.GAppContext).CreateValideTrainingYearInstance();
        ...
        {
            base.CleanData();
            // Delete TrainingYear_CRUD_Test if Exist
            TrainingYearBLO TrainingYearBLO = new TrainingYearBLO(this.UnitOfWork, this.GAppContext);
            TrainingYear existante_entity = TrainingYearBLO.FindBaseEntityByReference(this.Entity_Reference);
            if (existante_entity != null)
                TrainingYearBLO.Delete(existante_entity);
