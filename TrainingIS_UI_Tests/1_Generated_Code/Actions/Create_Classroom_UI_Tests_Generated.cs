...
namespace TrainingIS_UI_Tests.Classrooms
{
    public class Base_Create_Classroom_UI_Tests : Create_Entity_UI_Test<Classroom>
    {
        ...
        {
            Classroom_Create(this.Valide_Entity_Insrance);
        }
 
        public virtual void Classroom_Create(Classroom Classroom)
        {
             this.GoTo_Index_And_Login_If_Not_Ahenticated();
        ...
        {
            this.CleanData();
            this.Valide_Entity_Insrance = new ClassroomTestDataFactory(null, this.GAppContext).CreateValideClassroomInstance();
        ...
        {
            base.CleanData();
            // Delete Classroom_CRUD_Test if Exist
            ClassroomBLO ClassroomBLO = new ClassroomBLO(this.UnitOfWork, this.GAppContext);
            Classroom existante_entity = ClassroomBLO.FindBaseEntityByReference(this.Entity_Reference);
            if (existante_entity != null)
                ClassroomBLO.Delete(existante_entity);
