...
{
    public class Base_TrainingLevel_Create_UI_Tests : Base_UI_Tests
    {
       

        public Base_TrainingLevel_Create_UI_Tests()
        {
    ...
    [TestClass]
	public partial class TrainingLevel_Create_UI_Tests : Base_TrainingLevel_Create_UI_Tests
    {
