...
{
    public class Base_YearStudy_Create_UI_Tests : Base_UI_Tests
    {
       

        public Base_YearStudy_Create_UI_Tests()
        {
    ...
    [TestClass]
	public partial class YearStudy_Create_UI_Tests : Base_YearStudy_Create_UI_Tests
    {
