...
{
    public class Base_TrainingType_Create_UI_Tests : Base_UI_Tests
    {
       

        public Base_TrainingType_Create_UI_Tests()
        {
    ...
    [TestClass]
	public partial class TrainingType_Create_UI_Tests : Base_TrainingType_Create_UI_Tests
    {
