...
namespace TrainingIS_UI_Tests.Category_WarningTrainees
{
    ...
    public class Base_Filter_Category_WarningTrainee_UI_Tests : Create_Entity_UI_Test<Category_WarningTrainee>
    {
		// GApp Context
		...
		[TestMethod]
        public virtual void Category_WarningTrainee_Filter_Test()
        {
