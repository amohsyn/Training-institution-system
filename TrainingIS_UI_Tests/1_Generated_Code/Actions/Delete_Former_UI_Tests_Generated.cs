...
namespace TrainingIS_UI_Tests.Formers
{
    ...
    public class Base_Delete_Former_UI_Tests : Create_Entity_UI_Test<Former>
    {
		// GApp Context
		...
		public Base_Delete_Former_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void Former_Delete_Test()
        {
	...
	public partial class Delete_Former_UI_Tests : Base_Delete_Former_UI_Tests
    {
		public Delete_Former_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Delete_Former_UI_Tests() : base(null){}
    }
}
