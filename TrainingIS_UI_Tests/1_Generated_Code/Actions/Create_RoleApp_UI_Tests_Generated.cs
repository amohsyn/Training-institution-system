...
{
    public class Base_Create_RoleApp_UI_Tests : Create_Entity_UI_Test<RoleApp>
    {
		// GApp Context
        ...
        {
            RoleApp_Create(this.Valide_Entity_Insrance);
        }
 
        public virtual void RoleApp_Create(RoleApp RoleApp)
        {
             this.GoTo_Index_And_Login_If_Not_Ahenticated();
        ...
        {
            this.CleanData();
            this.Valide_Entity_Insrance = new RoleAppTestDataFactory(null, this.GAppContext).CreateValideRoleAppInstance();
        ...
        {
            base.CleanData();
            // Delete RoleApp_CRUD_Test if Exist
            RoleAppBLO RoleAppBLO = new RoleAppBLO(this.UnitOfWork, this.GAppContext);
            RoleApp existante_entity = RoleAppBLO.FindBaseEntityByReference(this.Entity_Reference);
            if (existante_entity != null)
                RoleAppBLO.Delete(existante_entity);
