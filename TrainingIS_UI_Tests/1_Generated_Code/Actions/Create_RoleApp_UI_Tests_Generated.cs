...
namespace TrainingIS_UI_Tests.RoleApps
{
    public class Base_Create_RoleApp_UI_Tests : Create_Entity_UI_Test<RoleApp>
    {
        ...
        public virtual void InitData()
        {
            ...
            {
                RoleApp_TestData.Insert_Test_Data_If_Not_Exist();
                this.CleanData();
        ...
        {
            RoleApp_UI_Create(this.Valide_Entity_Insrance);
        ...
        public virtual void RoleApp_UI_Create(RoleApp RoleApp)
        {
			...
			var Reference = b.FindElement(By.Id(nameof(Default_Form_RoleApp_Model.Reference)));
            Reference.SendKeys(Default_Form_RoleApp_Model.Reference.ToString());
