...
namespace TrainingIS_UI_Tests.Category_JustificationAbsences
{
    ...
    public class Base_Filter_Category_JustificationAbsence_UI_Tests : Create_Entity_UI_Test<Category_JustificationAbsence>
    {
		// GApp Context
		...
		[TestMethod]
        public virtual void Category_JustificationAbsence_Filter_Test()
        {
