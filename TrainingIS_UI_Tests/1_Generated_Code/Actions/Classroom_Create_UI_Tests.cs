...
{
    public class Base_Classroom_Create_UI_Tests : Base_UI_Tests
    {
       

        public Base_Classroom_Create_UI_Tests()
        {
    ...
    [TestClass]
	public partial class Classroom_Create_UI_Tests : Base_Classroom_Create_UI_Tests
    {
