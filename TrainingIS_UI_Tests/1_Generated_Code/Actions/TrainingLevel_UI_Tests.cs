...
{
    public class Base_TrainingLevel_UI_Tests : Base_UI_Tests
    {
       

        public Base_TrainingLevel_UI_Tests()
        {
    ...
    [TestClass]
	public partial class TrainingLevel_UI_Tests : Base_TrainingLevel_UI_Tests
    {
