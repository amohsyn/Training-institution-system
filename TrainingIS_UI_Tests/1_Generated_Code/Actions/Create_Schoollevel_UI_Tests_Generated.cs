...
namespace TrainingIS_UI_Tests.Schoollevels
{
    public class Base_Create_Schoollevel_UI_Tests : Create_Entity_UI_Test<Schoollevel>
    {
        ...
        public virtual void InitData()
        {
            ...
            {
                Schoollevel_TestData.Insert_Test_Data_If_Not_Exist();
                this.CleanData();
        ...
        {
            Schoollevel_UI_Create(this.Valide_Entity_Insrance);
        ...
        public virtual void Schoollevel_UI_Create(Schoollevel Schoollevel)
        {
			...
			var Reference = b.FindElement(By.Id(nameof(Default_Form_Schoollevel_Model.Reference)));
            Reference.SendKeys(Default_Form_Schoollevel_Model.Reference.ToString());
