...
{
    public class Base_Create_YearStudy_UI_Tests : Create_Entity_UI_Test<YearStudy>
    {
		// GApp Context
        ...
        {
            YearStudy_Create(this.Valide_Entity_Insrance);
        }
 
        public virtual void YearStudy_Create(YearStudy YearStudy)
        {
             this.GoTo_Index_And_Login_If_Not_Ahenticated();
        ...
        {
            this.CleanData();
            this.Valide_Entity_Insrance = new YearStudyTestDataFactory(null, this.GAppContext).CreateValideYearStudyInstance();
        ...
        {
            base.CleanData();
            // Delete YearStudy_CRUD_Test if Exist
            YearStudyBLO YearStudyBLO = new YearStudyBLO(this.UnitOfWork, this.GAppContext);
            YearStudy existante_entity = YearStudyBLO.FindBaseEntityByReference(this.Entity_Reference);
            if (existante_entity != null)
                YearStudyBLO.Delete(existante_entity);
