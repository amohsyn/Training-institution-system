...
namespace TrainingIS_UI_Tests.SanctionCategories
{
    public class Base_Create_SanctionCategory_UI_Tests : Create_Entity_UI_Test<SanctionCategory>
    {
        ...
        {
            SanctionCategory_Create(this.Valide_Entity_Insrance);
        }
 
        public virtual void SanctionCategory_Create(SanctionCategory SanctionCategory)
        {
             this.GoTo_Index_And_Login_If_Not_Ahenticated();
        ...
        {
            this.CleanData();
            this.Valide_Entity_Insrance = new SanctionCategoryTestDataFactory(null, this.GAppContext).CreateValideSanctionCategoryInstance();
        ...
        {
            base.CleanData();
            // Delete SanctionCategory_CRUD_Test if Exist
            SanctionCategoryBLO SanctionCategoryBLO = new SanctionCategoryBLO(this.UnitOfWork, this.GAppContext);
            SanctionCategory existante_entity = SanctionCategoryBLO.FindBaseEntityByReference(this.Entity_Reference);
            if (existante_entity != null)
                SanctionCategoryBLO.Delete(existante_entity);
