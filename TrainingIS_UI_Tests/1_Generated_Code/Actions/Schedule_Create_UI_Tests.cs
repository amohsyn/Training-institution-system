...
{
    public class Base_Schedule_Create_UI_Tests : Base_UI_Tests
    {
       

        public Base_Schedule_Create_UI_Tests()
        {
    ...
    [TestClass]
	public partial class Schedule_Create_UI_Tests : Base_Schedule_Create_UI_Tests
    {
