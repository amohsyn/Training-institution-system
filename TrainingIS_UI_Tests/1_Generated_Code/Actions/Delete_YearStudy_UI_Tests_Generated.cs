...
namespace TrainingIS_UI_Tests.YearStudies
{
    ...
    public class Base_Delete_YearStudy_UI_Tests : Create_Entity_UI_Test<YearStudy>
    {
		// GApp Context
		...
		public Base_Delete_YearStudy_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void YearStudy_Delete_Test()
        {
	...
	public partial class Delete_YearStudy_UI_Tests : Base_Delete_YearStudy_UI_Tests
    {
		public Delete_YearStudy_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Delete_YearStudy_UI_Tests() : base(null){}
    }
}
