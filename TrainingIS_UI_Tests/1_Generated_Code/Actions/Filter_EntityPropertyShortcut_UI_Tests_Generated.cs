...
namespace TrainingIS_UI_Tests.EntityPropertyShortcuts
{
    ...
    public class Base_Filter_EntityPropertyShortcut_UI_Tests : Create_Entity_UI_Test<EntityPropertyShortcut>
    {
		// GApp Context
		...
		[TestMethod]
        public virtual void EntityPropertyShortcut_Filter_Test()
        {
