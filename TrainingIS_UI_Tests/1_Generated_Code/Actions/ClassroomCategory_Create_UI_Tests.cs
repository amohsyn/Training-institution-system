...
{
    public class Base_ClassroomCategory_Create_UI_Tests : Base_UI_Tests
    {
       

        public Base_ClassroomCategory_Create_UI_Tests()
        {
        ...
        public virtual void ClassroomCategory_Create_Test()
        {
            ...
            // Insert Former
            ClassroomCategory ClassroomCategory = new ClassroomCategoriesControllerTests_Service().CreateValideClassroomCategoryInstance(null,GAppContext);
    ...
    [TestClass]
	public partial class ClassroomCategory_Create_UI_Tests : Base_ClassroomCategory_Create_UI_Tests
    {
