...
{
    public class Base_Sector_Create_UI_Tests : Base_UI_Tests
    {
       

        public Base_Sector_Create_UI_Tests()
        {
    ...
    [TestClass]
	public partial class Sector_Create_UI_Tests : Base_Sector_Create_UI_Tests
    {
