...
namespace TrainingIS_UI_Tests.EntityPropertyShortcuts
{
    ...
    public class Base_Details_EntityPropertyShortcut_UI_Tests : Create_Entity_UI_Test<EntityPropertyShortcut>
    {
		// GApp Context
		...
		public Base_Details_EntityPropertyShortcut_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void EntityPropertyShortcut_Details_Test()
        {
	...
	public partial class Details_EntityPropertyShortcut_UI_Tests : Base_Details_EntityPropertyShortcut_UI_Tests
    {
		public Details_EntityPropertyShortcut_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Details_EntityPropertyShortcut_UI_Tests() : base(null){}
    }
}
