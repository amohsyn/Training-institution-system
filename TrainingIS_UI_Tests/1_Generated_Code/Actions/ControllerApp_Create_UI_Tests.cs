...
{
    public class Base_ControllerApp_Create_UI_Tests : Base_UI_Tests
    {
       

        public Base_ControllerApp_Create_UI_Tests()
        {
    ...
    [TestClass]
	public partial class ControllerApp_Create_UI_Tests : Base_ControllerApp_Create_UI_Tests
    {
