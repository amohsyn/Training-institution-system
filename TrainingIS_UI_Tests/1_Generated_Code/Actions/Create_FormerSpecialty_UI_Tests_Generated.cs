...
namespace TrainingIS_UI_Tests.FormerSpecialties
{
    public class Base_Create_FormerSpecialty_UI_Tests : Create_Entity_UI_Test<FormerSpecialty>
    {
        ...
        public virtual void InitData()
        {
            ...
            {
                FormerSpecialty_TestData.Insert_Test_Data_If_Not_Exist();
                this.CleanData();
        ...
        {
            FormerSpecialty_UI_Create(this.Valide_Entity_Insrance);
        ...
        public virtual void FormerSpecialty_UI_Create(FormerSpecialty FormerSpecialty)
        {
			...
			var Reference = b.FindElement(By.Id(nameof(Default_Form_FormerSpecialty_Model.Reference)));
            Reference.SendKeys(Default_Form_FormerSpecialty_Model.Reference.ToString());
