...
{
    public class Base_Create_TrainingLevel_UI_Tests : Create_Entity_UI_Test<TrainingLevel>
    {
		// GApp Context
        ...
        {
            TrainingLevel_Create(this.Valide_Entity_Insrance);
        }
 
        public virtual void TrainingLevel_Create(TrainingLevel TrainingLevel)
        {
             this.GoTo_Index_And_Login_If_Not_Ahenticated();
        ...
        {
            this.CleanData();
            this.Valide_Entity_Insrance = new TrainingLevelTestDataFactory(null, this.GAppContext).CreateValideTrainingLevelInstance();
        ...
        {
            base.CleanData();
            // Delete TrainingLevel_CRUD_Test if Exist
            TrainingLevelBLO TrainingLevelBLO = new TrainingLevelBLO(this.UnitOfWork, this.GAppContext);
            TrainingLevel existante_entity = TrainingLevelBLO.FindBaseEntityByReference(this.Entity_Reference);
            if (existante_entity != null)
                TrainingLevelBLO.Delete(existante_entity);
