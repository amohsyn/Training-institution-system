...
namespace TrainingIS_UI_Tests.TrainingLevels
{
    public class Base_Create_TrainingLevel_UI_Tests : Create_Entity_UI_Test<TrainingLevel>
    {
        ...
        public virtual void InitData()
        {
            ...
            {
                TrainingLevel_TestData.Insert_Test_Data_If_Not_Exist();
                this.CleanData();
        ...
        {
            TrainingLevel_UI_Create(this.Valide_Entity_Insrance);
        ...
        public virtual void TrainingLevel_UI_Create(TrainingLevel TrainingLevel)
        {
			...
			var Reference = b.FindElement(By.Id(nameof(Default_Form_TrainingLevel_Model.Reference)));
            Reference.SendKeys(Default_Form_TrainingLevel_Model.Reference.ToString());
