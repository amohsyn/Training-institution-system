...
namespace TrainingIS_UI_Tests.Functions
{
    public class Base_Create_Function_UI_Tests : Create_Entity_UI_Test<Function>
    {
        ...
        public virtual void InitData()
        {
            ...
            {
                Function_TestData.Insert_Test_Data_If_Not_Exist();
                this.CleanData();
        ...
        public virtual void Function_UI_Create(Function Function)
        {
			...
			var Reference = b.FindElement(By.Id(nameof(Default_Form_Function_Model.Reference)));
            Reference.SendKeys(Default_Form_Function_Model.Reference.ToString());
