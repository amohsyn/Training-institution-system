...
{
    public class Base_Nationality_Create_UI_Tests : Base_UI_Tests
    {
       

        public Base_Nationality_Create_UI_Tests()
        {
    ...
    [TestClass]
	public partial class Nationality_Create_UI_Tests : Base_Nationality_Create_UI_Tests
    {
