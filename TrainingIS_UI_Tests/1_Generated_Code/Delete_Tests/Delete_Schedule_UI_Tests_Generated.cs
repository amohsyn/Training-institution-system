...
namespace TrainingIS_UI_Tests.Schedules
{
    ...
    public class Base_Delete_Schedule_UI_Tests : Base_Create_Entity_UI_Test<Schedule>
    {
		// GApp Context
		...
		public Base_Delete_Schedule_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void Schedule_Delete_Test()
        {
            // Arrange
            // Add Schedule to be delete
	...
	public partial class Delete_Schedule_UI_Tests : Base_Delete_Schedule_UI_Tests
    {
		public Delete_Schedule_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Delete_Schedule_UI_Tests() : base(null){}
    }
}
