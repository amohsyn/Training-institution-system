...
namespace TrainingIS_UI_Tests.SeancePlannings
{
    ...
    public class Base_Delete_SeancePlanning_UI_Tests : Base_Create_Entity_UI_Test<SeancePlanning>
    {
		// GApp Context
		...
		public Base_Delete_SeancePlanning_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void SeancePlanning_Delete_Test()
        {
            // Arrange
            // Add SeancePlanning to be delete
	...
	public partial class Delete_SeancePlanning_UI_Tests : Base_Delete_SeancePlanning_UI_Tests
    {
		public Delete_SeancePlanning_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Delete_SeancePlanning_UI_Tests() : base(null){}
    }
}
