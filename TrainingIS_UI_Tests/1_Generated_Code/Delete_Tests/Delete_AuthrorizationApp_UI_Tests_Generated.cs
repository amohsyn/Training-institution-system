...
namespace TrainingIS_UI_Tests.AuthrorizationApps
{
    ...
    public class Base_Delete_AuthrorizationApp_UI_Tests : Base_Create_Entity_UI_Test<AuthrorizationApp>
    {
		// GApp Context
		...
		public Base_Delete_AuthrorizationApp_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void AuthrorizationApp_Delete_Test()
        {
            // Arrange
            // Add AuthrorizationApp to be delete
	...
	public partial class Delete_AuthrorizationApp_UI_Tests : Base_Delete_AuthrorizationApp_UI_Tests
    {
		public Delete_AuthrorizationApp_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Delete_AuthrorizationApp_UI_Tests() : base(null){}
    }
}
