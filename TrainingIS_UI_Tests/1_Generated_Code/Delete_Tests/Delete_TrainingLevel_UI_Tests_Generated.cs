...
namespace TrainingIS_UI_Tests.TrainingLevels
{
    ...
    public class Base_Delete_TrainingLevel_UI_Tests : Base_Create_Entity_UI_Test<TrainingLevel>
    {
		// GApp Context
		...
		public Base_Delete_TrainingLevel_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void TrainingLevel_Delete_Test()
        {
            // Arrange
            // Add TrainingLevel to be delete
	...
	public partial class Delete_TrainingLevel_UI_Tests : Base_Delete_TrainingLevel_UI_Tests
    {
		public Delete_TrainingLevel_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Delete_TrainingLevel_UI_Tests() : base(null){}
    }
}
