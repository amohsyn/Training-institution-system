...
namespace TrainingIS_UI_Tests.Projects
{
    ...
    public class Base_Delete_Project_UI_Tests : Base_Create_Entity_UI_Test<Project>
    {
		// GApp Context
		...
		public Base_Delete_Project_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void Project_Delete_Test()
        {
            // Arrange
            // Add Project to be delete
	...
	public partial class Delete_Project_UI_Tests : Base_Delete_Project_UI_Tests
    {
		public Delete_Project_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Delete_Project_UI_Tests() : base(null){}
    }
}
