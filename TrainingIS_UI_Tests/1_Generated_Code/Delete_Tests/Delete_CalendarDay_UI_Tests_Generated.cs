...
namespace TrainingIS_UI_Tests.CalendarDays
{
    ...
    public class Base_Delete_CalendarDay_UI_Tests : Create_Entity_UI_Test<CalendarDay>
    {
		// GApp Context
		...
		public Base_Delete_CalendarDay_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void CalendarDay_Delete_Test()
        {
	...
	public partial class Delete_CalendarDay_UI_Tests : Base_Delete_CalendarDay_UI_Tests
    {
		public Delete_CalendarDay_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Delete_CalendarDay_UI_Tests() : base(null){}
    }
}
