...
namespace TrainingIS_UI_Tests.LogWorks
{
    ...
    public class Base_Delete_LogWork_UI_Tests : Base_Create_Entity_UI_Test<LogWork>
    {
		...
		public Base_Delete_LogWork_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void LogWork_Delete_Test()
        {
            // Arrange
            // Add LogWork to be delete
	...
	public partial class Delete_LogWork_UI_Tests : Base_Delete_LogWork_UI_Tests
    {
		public Delete_LogWork_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Delete_LogWork_UI_Tests() : base(null){}
    }
}
