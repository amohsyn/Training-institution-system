...
namespace TrainingIS_UI_Tests.ActionControllerApps
{
    ...
    public class Base_Delete_ActionControllerApp_UI_Tests : Base_Create_Entity_UI_Test<ActionControllerApp>
    {
		// GApp Context
		...
		public Base_Delete_ActionControllerApp_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void ActionControllerApp_Delete_Test()
        {
            // Arrange
            // Add ActionControllerApp to be delete
	...
	public partial class Delete_ActionControllerApp_UI_Tests : Base_Delete_ActionControllerApp_UI_Tests
    {
		public Delete_ActionControllerApp_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Delete_ActionControllerApp_UI_Tests() : base(null){}
    }
}
