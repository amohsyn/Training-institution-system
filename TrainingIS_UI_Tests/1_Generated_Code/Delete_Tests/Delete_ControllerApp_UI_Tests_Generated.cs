...
namespace TrainingIS_UI_Tests.ControllerApps
{
    ...
    public class Base_Delete_ControllerApp_UI_Tests : Base_Create_Entity_UI_Test<ControllerApp>
    {
		// GApp Context
		...
		public Base_Delete_ControllerApp_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void ControllerApp_Delete_Test()
        {
            // Arrange
            // Add ControllerApp to be delete
	...
	public partial class Delete_ControllerApp_UI_Tests : Base_Delete_ControllerApp_UI_Tests
    {
		public Delete_ControllerApp_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Delete_ControllerApp_UI_Tests() : base(null){}
    }
}
