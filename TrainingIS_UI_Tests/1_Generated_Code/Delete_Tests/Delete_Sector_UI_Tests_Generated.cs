...
namespace TrainingIS_UI_Tests.Sectors
{
	...
	[TestCategory("Sector")]
    public class Base_Delete_Sector_UI_Tests : Base_Create_Entity_UI_Test<Sector>
    {
		// GApp Context
        ...
        protected override void Constructor(UI_Test_Context UI_Test_Context)
        {
            ...
            this.Valide_Entity_Instance = Sector_TestData.Create_CRUD_Sector_Test_Instance();
            this.Valide_Entity_Instance.Reference = this.Entity_Reference;
        }

		public Base_Delete_Sector_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void Sector_Delete_Test()
        {
            // Arrange
            // Add Sector to be delete
	...
	public partial class Delete_Sector_UI_Tests : Base_Delete_Sector_UI_Tests
    {
		public Delete_Sector_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Delete_Sector_UI_Tests() : base(null){}
    }
}
