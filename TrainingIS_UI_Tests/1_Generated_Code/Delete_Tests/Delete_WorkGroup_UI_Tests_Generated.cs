...
namespace TrainingIS_UI_Tests.WorkGroups
{
    ...
    public class Base_Delete_WorkGroup_UI_Tests : Base_Create_Entity_UI_Test<WorkGroup>
    {
		// GApp Context
		...
		public Base_Delete_WorkGroup_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void WorkGroup_Delete_Test()
        {
            // Arrange
            // Add WorkGroup to be delete
	...
	public partial class Delete_WorkGroup_UI_Tests : Base_Delete_WorkGroup_UI_Tests
    {
		public Delete_WorkGroup_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Delete_WorkGroup_UI_Tests() : base(null){}
    }
}
