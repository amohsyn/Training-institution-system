...
namespace TrainingIS_UI_Tests.Classrooms
{
    ...
    public class Base_Delete_Classroom_UI_Tests : Base_Create_Entity_UI_Test<Classroom>
    {
		// GApp Context
		...
		public Base_Delete_Classroom_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void Classroom_Delete_Test()
        {
            // Arrange
            // Add Classroom to be delete
	...
	public partial class Delete_Classroom_UI_Tests : Base_Delete_Classroom_UI_Tests
    {
		public Delete_Classroom_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Delete_Classroom_UI_Tests() : base(null){}
    }
}
