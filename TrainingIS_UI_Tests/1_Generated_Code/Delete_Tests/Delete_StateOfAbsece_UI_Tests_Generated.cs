...
namespace TrainingIS_UI_Tests.StateOfAbseces
{
    ...
    public class Base_Delete_StateOfAbsece_UI_Tests : Base_Create_Entity_UI_Test<StateOfAbsece>
    {
		// GApp Context
		...
		public Base_Delete_StateOfAbsece_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void StateOfAbsece_Delete_Test()
        {
            // Arrange
            // Add StateOfAbsece to be delete
	...
	public partial class Delete_StateOfAbsece_UI_Tests : Base_Delete_StateOfAbsece_UI_Tests
    {
		public Delete_StateOfAbsece_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Delete_StateOfAbsece_UI_Tests() : base(null){}
    }
}
