...
namespace TrainingIS_UI_Tests.Mission_Working_Groups
{
    ...
    public class Base_Delete_Mission_Working_Group_UI_Tests : Base_Create_Entity_UI_Test<Mission_Working_Group>
    {
		// GApp Context
		...
		public Base_Delete_Mission_Working_Group_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void Mission_Working_Group_Delete_Test()
        {
            // Arrange
            // Add Mission_Working_Group to be delete
	...
	public partial class Delete_Mission_Working_Group_UI_Tests : Base_Delete_Mission_Working_Group_UI_Tests
    {
		public Delete_Mission_Working_Group_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Delete_Mission_Working_Group_UI_Tests() : base(null){}
    }
}
