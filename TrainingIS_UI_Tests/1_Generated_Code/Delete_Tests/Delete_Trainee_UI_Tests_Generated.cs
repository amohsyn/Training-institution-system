...
namespace TrainingIS_UI_Tests.Trainees
{
    ...
    public class Base_Delete_Trainee_UI_Tests : Base_Create_Entity_UI_Test<Trainee>
    {
		// GApp Context
		...
		public Base_Delete_Trainee_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void Trainee_Delete_Test()
        {
            // Arrange
            // Add Trainee to be delete
	...
	public partial class Delete_Trainee_UI_Tests : Base_Delete_Trainee_UI_Tests
    {
		public Delete_Trainee_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Delete_Trainee_UI_Tests() : base(null){}
    }
}
