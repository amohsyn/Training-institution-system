...
namespace TrainingIS_UI_Tests.JustificationAbsences
{
    ...
    public class Base_Delete_JustificationAbsence_UI_Tests : Base_Create_Entity_UI_Test<JustificationAbsence>
    {
		// GApp Context
		...
		public Base_Delete_JustificationAbsence_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void JustificationAbsence_Delete_Test()
        {
            // Arrange
            // Add JustificationAbsence to be delete
	...
	public partial class Delete_JustificationAbsence_UI_Tests : Base_Delete_JustificationAbsence_UI_Tests
    {
		public Delete_JustificationAbsence_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Delete_JustificationAbsence_UI_Tests() : base(null){}
    }
}
