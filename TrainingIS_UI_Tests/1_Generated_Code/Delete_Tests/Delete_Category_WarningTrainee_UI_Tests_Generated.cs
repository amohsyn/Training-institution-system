...
namespace TrainingIS_UI_Tests.Category_WarningTrainees
{
    ...
    public class Base_Delete_Category_WarningTrainee_UI_Tests : Base_Create_Entity_UI_Test<Category_WarningTrainee>
    {
		// GApp Context
		...
		public Base_Delete_Category_WarningTrainee_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void Category_WarningTrainee_Delete_Test()
        {
            // Arrange
            // Add Category_WarningTrainee to be delete
	...
	public partial class Delete_Category_WarningTrainee_UI_Tests : Base_Delete_Category_WarningTrainee_UI_Tests
    {
		public Delete_Category_WarningTrainee_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Delete_Category_WarningTrainee_UI_Tests() : base(null){}
    }
}
