...
namespace TrainingIS_UI_Tests.WarningTrainees
{
    ...
    public class Base_Delete_WarningTrainee_UI_Tests : Base_Create_Entity_UI_Test<WarningTrainee>
    {
		// GApp Context
		...
		public Base_Delete_WarningTrainee_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void WarningTrainee_Delete_Test()
        {
            // Arrange
            // Add WarningTrainee to be delete
	...
	public partial class Delete_WarningTrainee_UI_Tests : Base_Delete_WarningTrainee_UI_Tests
    {
		public Delete_WarningTrainee_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Delete_WarningTrainee_UI_Tests() : base(null){}
    }
}
