...
namespace TrainingIS_UI_Tests.ClassroomCategories
{
    ...
    public class Base_Delete_ClassroomCategory_UI_Tests : Base_Create_Entity_UI_Test<ClassroomCategory>
    {
		// GApp Context
		...
		public Base_Delete_ClassroomCategory_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void ClassroomCategory_Delete_Test()
        {
            // Arrange
            // Add ClassroomCategory to be delete
	...
	public partial class Delete_ClassroomCategory_UI_Tests : Base_Delete_ClassroomCategory_UI_Tests
    {
		public Delete_ClassroomCategory_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Delete_ClassroomCategory_UI_Tests() : base(null){}
    }
}
