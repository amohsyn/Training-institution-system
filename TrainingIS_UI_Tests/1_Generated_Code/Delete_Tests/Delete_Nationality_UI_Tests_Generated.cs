...
namespace TrainingIS_UI_Tests.Nationalities
{
    ...
    public class Base_Delete_Nationality_UI_Tests : Base_Create_Entity_UI_Test<Nationality>
    {
		// GApp Context
		...
		public Base_Delete_Nationality_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void Nationality_Delete_Test()
        {
            // Arrange
            // Add Nationality to be delete
	...
	public partial class Delete_Nationality_UI_Tests : Base_Delete_Nationality_UI_Tests
    {
		public Delete_Nationality_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Delete_Nationality_UI_Tests() : base(null){}
    }
}
