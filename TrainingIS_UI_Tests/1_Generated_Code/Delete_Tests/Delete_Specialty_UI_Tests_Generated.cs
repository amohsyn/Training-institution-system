...
namespace TrainingIS_UI_Tests.Specialties
{
    ...
    public class Base_Delete_Specialty_UI_Tests : Base_Create_Entity_UI_Test<Specialty>
    {
		// GApp Context
		...
		public Base_Delete_Specialty_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context) {}
		...
		[TestMethod]
        public virtual void Specialty_Delete_Test()
        {
            // Arrange
            // Add Specialty to be delete
	...
	public partial class Delete_Specialty_UI_Tests : Base_Delete_Specialty_UI_Tests
    {
		public Delete_Specialty_UI_Tests(UI_Test_Context UI_Test_Context) : base(UI_Test_Context){}
        public Delete_Specialty_UI_Tests() : base(null){}
    }
}
