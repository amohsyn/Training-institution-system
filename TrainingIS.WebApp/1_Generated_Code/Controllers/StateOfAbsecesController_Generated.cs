...
{  
    ...
    public class BaseStateOfAbsecesController : BaseController<TrainingISModel>
    {
        ...
        {
		    msgHelper.Index(msg);
            List<Default_Details_StateOfAbsece_Model> listDefault_Details_StateOfAbsece_Model = new List<Default_Details_StateOfAbsece_Model>();
			foreach (var item in StateOfAbseceBLO.FindAll()){
                Default_Details_StateOfAbsece_Model Default_Details_StateOfAbsece_Model = new Default_Details_StateOfAbsece_ModelBLM(this._UnitOfWork)
                    .ConverTo_Default_Details_StateOfAbsece_Model(item);
                listDefault_Details_StateOfAbsece_Model.Add(Default_Details_StateOfAbsece_Model);
            }
			return View(listDefault_Details_StateOfAbsece_Model);
		}
		...
		public virtual ActionResult Create()
        {
			...
			Default_Form_StateOfAbsece_Model default_form_stateofabsece_model = new Default_Form_StateOfAbsece_ModelBLM(this._UnitOfWork).CreateNew();
		...
		public virtual ActionResult Create([Bind(Include = "Name,Category,Value")] Default_Form_StateOfAbsece_Model Default_Form_StateOfAbsece_Model)
        {
            ...
            if (ModelState.IsValid)
            {
				...
				try
                {
					...
					Alert(string.Format(msgManager.The_Entity_was_well_created, msgHelper.DefinitArticle().FirstLetterToUpperCase(), msg_StateOfAbsece.SingularName.ToLower(), StateOfAbsece), NotificationType.success);
		...
		public virtual ActionResult Edit(long? id)
        {
			...
			Default_Form_StateOfAbsece_Model Default_Form_StateOfAbsece_Model = new Default_Form_StateOfAbsece_ModelBLM(this._UnitOfWork)
		...
		public virtual ActionResult Edit([Bind(Include = "Name,Category,Value,Id")] Default_Form_StateOfAbsece_Model Default_Form_StateOfAbsece_Model)	
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    StateOfAbseceBLO.Save(StateOfAbsece);
					Alert(string.Format(msgManager.The_entity_has_been_changed,msgHelper.DefinitArticle().FirstLetterToUpperCase(), msg_StateOfAbsece.SingularName.ToLower(), StateOfAbsece), NotificationType.success);
					return RedirectToAction("Index");
                }
                catch (GAppDbException ex)
                {
		...
		public virtual ActionResult Details(long? id)
        {
            ...
            if (StateOfAbsece == null)
            {
                string msg = string.Format(msgManager.You_try_to_show_that_does_not_exist, msgHelper.UndefindedArticle(), msg_StateOfAbsece.SingularName.ToLower());
                Alert(msg, NotificationType.error);
                return RedirectToAction("Index");
            }
			Default_Details_StateOfAbsece_Model Default_Details_StateOfAbsece_Model = new Default_Details_StateOfAbsece_Model();
		    Default_Details_StateOfAbsece_Model = new Default_Details_StateOfAbsece_ModelBLM(this._UnitOfWork)
		 ...
		 public virtual ActionResult Delete(long? id)
        {
            ...
            if (StateOfAbsece == null)
            {
			    string msg = string.Format(msgManager.You_try_to_delete_that_does_not_exist, msgHelper.UndefindedArticle(), msg_StateOfAbsece.SingularName.ToLower());
                Alert(msg, NotificationType.error);
                return RedirectToAction("Index");
            }
        ...
        public virtual ActionResult DeleteConfirmed(long id)
        {
            ...
            {
                string msg = string.Format(msgManager.You_can_not_delete_this_entity_because_it_is_already_related_to_another_object, StateOfAbsece.ToString());
                Alert(msg, NotificationType.error);
                return RedirectToAction("Index");
            }
            catch (GAppDbException ex)
			...
			Alert(string.Format(msgManager.The_entity_has_been_removed,msgHelper.DefinitArticle().FirstLetterToUpperCase(), msg_StateOfAbsece.SingularName.ToLower(), StateOfAbsece), NotificationType.success);
            return RedirectToAction("Index");
        }
