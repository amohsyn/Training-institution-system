...
{  
    ...
    public class BaseStateOfAbsecesController : BaseController<TrainingISModel>
    {
		...
		public ActionResult Index(FilterRequestParams filterRequestParams)
        {
            ...
            List<Default_Details_StateOfAbsece_Model> _ListDefault_Details_StateOfAbsece_Model = new Default_Details_StateOfAbsece_ModelBLM(this._UnitOfWork, this.GAppContext)
