...
{  
    ...
    public class BaseSchoollevelsController : TrainingIS_BaseController
    {
		...
		public virtual ActionResult Index(FilterRequestParams filterRequestParams)
        {
            ...
            List<Default_Details_Schoollevel_Model> _ListDefault_Details_Schoollevel_Model = null;
            try
            {
                filterRequestParams = this.Save_OR_Load_filterRequestParams_State(filterRequestParams);
               _ListDefault_Details_Schoollevel_Model = new Default_Details_Schoollevel_ModelBLM(this._UnitOfWork, this.GAppContext)
            ...
            return View(_ListDefault_Details_Schoollevel_Model);
        }


		protected virtual void Fill_ViewBag_Create(Default_Form_Schoollevel_Model Default_Form_Schoollevel_Model)
        {
		...
		public virtual ActionResult Create(Default_Form_Schoollevel_Model Default_Form_Schoollevel_Model)
        {
			...
			msgHelper.Create(msg);
			this.Fill_ViewBag_Create(Default_Form_Schoollevel_Model);
			Default_Form_Schoollevel_Model = new Default_Form_Schoollevel_ModelBLM(this._UnitOfWork, this.GAppContext).ConverTo_Default_Form_Schoollevel_Model(Schoollevel);
			return View(Default_Form_Schoollevel_Model);
        }

		protected virtual void Fill_Edit_ViewBag(Default_Form_Schoollevel_Model Default_Form_Schoollevel_Model)
        {
		...
		[HttpPost]
        [ValidateAntiForgeryToken]
		public virtual ActionResult Edit(Default_Form_Schoollevel_Model Default_Form_Schoollevel_Model)	
        {
		...
		public virtual ActionResult Details(long? id)
        {
			...
			return View(Default_Details_Schoollevel_Model);
        } 
