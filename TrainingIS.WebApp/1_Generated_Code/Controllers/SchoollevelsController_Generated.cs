...
{  
    ...
    public class BaseSchoollevelsController : TrainingIS_BaseController
    {
		...
		public virtual ActionResult Index(FilterRequestParams filterRequestParams)
        {
            ...
            List<string> SearchCreteria = this.SchoollevelBLO.GetSearchCreteria();

            List<Default_Schoollevel_Index_Model> _ListDefault_Schoollevel_Index_Model = null;
            try
            {
                filterRequestParams = this.Save_OR_Load_filterRequestParams_State(filterRequestParams);
               _ListDefault_Schoollevel_Index_Model = new Default_Schoollevel_Index_ModelBLM(this._UnitOfWork, this.GAppContext)
            ...
            return View(_ListDefault_Schoollevel_Index_Model);
        }


		protected virtual void Fill_ViewBag_Create(Default_Schoollevel_Create_Model Default_Schoollevel_Create_Model)
        {
		...
		public virtual ActionResult Create()
        {
			...
			Default_Schoollevel_Create_Model default_schoollevel_create_model = new Default_Schoollevel_Create_ModelBLM(this._UnitOfWork, this.GAppContext) .CreateNew();
			this.Fill_ViewBag_Create(default_schoollevel_create_model);
			return View(default_schoollevel_create_model);
        } 

		[HttpPost] 
        [ValidateAntiForgeryToken]
		public virtual ActionResult Create(Default_Schoollevel_Create_Model Default_Schoollevel_Create_Model)
        {
			Schoollevel Schoollevel = null ;
			Schoollevel = new Default_Schoollevel_Create_ModelBLM(this._UnitOfWork, this.GAppContext) 
										.ConverTo_Schoollevel(Default_Schoollevel_Create_Model);
			...
			msgHelper.Create(msg);
			this.Fill_ViewBag_Create(Default_Schoollevel_Create_Model);
			Default_Schoollevel_Create_Model = new Default_Schoollevel_Create_ModelBLM(this._UnitOfWork, this.GAppContext).ConverTo_Default_Schoollevel_Create_Model(Schoollevel);
			return View(Default_Schoollevel_Create_Model);
        }

		protected virtual void Fill_Edit_ViewBag(Default_Schoollevel_Edit_Model Default_Schoollevel_Edit_Model)
        {
		...
		public virtual ActionResult Edit(long? id)
        {
			...
			Default_Schoollevel_Edit_Model Default_Schoollevel_Edit_Model = new Default_Schoollevel_Edit_ModelBLM(this._UnitOfWork, this.GAppContext) 
                                                                .ConverTo_Default_Schoollevel_Edit_Model(Schoollevel) ;

			this.Fill_Edit_ViewBag(Default_Schoollevel_Edit_Model);
			return View(Default_Schoollevel_Edit_Model);
        }

		[HttpPost]
        [ValidateAntiForgeryToken]
		public virtual ActionResult Edit(Default_Schoollevel_Edit_Model Default_Schoollevel_Edit_Model)	
        {
			if(Default_Schoollevel_Edit_Model.Id == 0)
            {
                string msg = string.Format(msgManager.You_try_to_edit_that_does_not_exist, msgHelper.UndefindedArticle(), msg_Schoollevel.SingularName.ToLower());
                Alert(msg, NotificationType.error);
                return RedirectToAction("Index");
			...
			Schoollevel Schoollevel = new Default_Schoollevel_Edit_ModelBLM(this._UnitOfWork, this.GAppContext) 
                .ConverTo_Schoollevel( Default_Schoollevel_Edit_Model);
			...
			msgHelper.Edit(msg);
			this.Fill_Edit_ViewBag(Default_Schoollevel_Edit_Model);
			Default_Schoollevel_Edit_Model = new Default_Schoollevel_Edit_ModelBLM(this._UnitOfWork, this.GAppContext).ConverTo_Default_Schoollevel_Edit_Model(Schoollevel);
			return View(Default_Schoollevel_Edit_Model);
        }
		...
		public virtual ActionResult Details(long? id)
        {
		    ...
		    Default_Schoollevel_Details_Model = new Default_Schoollevel_Details_ModelBLM(this._UnitOfWork, this.GAppContext) 
                .ConverTo_Default_Schoollevel_Details_Model(Schoollevel);


			return View(Default_Schoollevel_Details_Model);
        } 
		 ...
		 public virtual ActionResult Delete(long? id)
        {
			...
			Default_Schoollevel_Details_Model Default_Schoollevel_Details_Model = new Default_Schoollevel_Details_ModelBLM(this._UnitOfWork, this.GAppContext) 
							.ConverTo_Default_Schoollevel_Details_Model(Schoollevel);
        ...
        { 
            ...
            try
            {
                ...
                using (XLWorkbook wb = new XLWorkbook())
                {
					...
					Session["repport_name"] = msg_Schoollevel.PluralName;
        ...
        /// <summary>
        /// [Generalize] Export the filterted Schoollevels
        /// </summary>
        /// <returns></returns>
        public virtual FileResult Export()
        {
            var dataTable = this.SchoollevelBLO.Export(this.GetType().Name);
            ...
            using (XLWorkbook wb = new XLWorkbook())
            {
                ...
                {
                    wb.SaveAs(stream);
                    string FileName = SchoollevelBLO.Get_Export_File_Name();
        ...
        public virtual FileResult Import_File_Example()
        {
            using (XLWorkbook wb = new XLWorkbook())
            {
                DataTable dataTable = SchoollevelBLO.Import_File_Example();
                wb.Worksheets.Add(dataTable);
                using (MemoryStream stream = new MemoryStream())
                {
                    wb.SaveAs(stream);
                    string FileName = this.SchoollevelBLO.Get_Import_File_Name();
                    return File(stream.ToArray(), "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", FileName);
                }
            }
        }
