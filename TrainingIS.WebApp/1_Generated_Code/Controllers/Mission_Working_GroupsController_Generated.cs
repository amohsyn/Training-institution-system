...
{  
    ...
    public class BaseMission_Working_GroupsController : TrainingIS_BaseController
    {
		...
		public virtual ActionResult Index(FilterRequestParams filterRequestParams)
        {
            ...
            List<Default_Details_Mission_Working_Group_Model> _ListDefault_Details_Mission_Working_Group_Model = null;
            try
            {
                filterRequestParams = this.Save_OR_Load_filterRequestParams_State(filterRequestParams);
               _ListDefault_Details_Mission_Working_Group_Model = new Default_Details_Mission_Working_Group_ModelBLM(this._UnitOfWork, this.GAppContext)
            ...
            return View(_ListDefault_Details_Mission_Working_Group_Model);
        }


		protected virtual void Fill_ViewBag_Create(Default_Form_Mission_Working_Group_Model Default_Form_Mission_Working_Group_Model)
        {
		...
		public virtual ActionResult Create()
        {
			...
			Default_Form_Mission_Working_Group_Model default_form_mission_working_group_model = new Default_Form_Mission_Working_Group_ModelBLM(this._UnitOfWork, this.GAppContext) .CreateNew();
			this.Fill_ViewBag_Create(default_form_mission_working_group_model);
			return View(default_form_mission_working_group_model);
        } 

		[HttpPost] 
        [ValidateAntiForgeryToken]
		public virtual ActionResult Create(Default_Form_Mission_Working_Group_Model Default_Form_Mission_Working_Group_Model)
        {
			Mission_Working_Group Mission_Working_Group = null ;
			Mission_Working_Group = new Default_Form_Mission_Working_Group_ModelBLM(this._UnitOfWork, this.GAppContext) 
										.ConverTo_Mission_Working_Group(Default_Form_Mission_Working_Group_Model);
			...
			msgHelper.Create(msg);
			this.Fill_ViewBag_Create(Default_Form_Mission_Working_Group_Model);
			Default_Form_Mission_Working_Group_Model = new Default_Form_Mission_Working_Group_ModelBLM(this._UnitOfWork, this.GAppContext).ConverTo_Default_Form_Mission_Working_Group_Model(Mission_Working_Group);
			return View(Default_Form_Mission_Working_Group_Model);
        }

		protected virtual void Fill_Edit_ViewBag(Default_Form_Mission_Working_Group_Model Default_Form_Mission_Working_Group_Model)
        {
		...
		public virtual ActionResult Edit(long? id)
        {
			...
			Default_Form_Mission_Working_Group_Model Default_Form_Mission_Working_Group_Model = new Default_Form_Mission_Working_Group_ModelBLM(this._UnitOfWork, this.GAppContext) 
                                                                .ConverTo_Default_Form_Mission_Working_Group_Model(Mission_Working_Group) ;

			this.Fill_Edit_ViewBag(Default_Form_Mission_Working_Group_Model);
			return View(Default_Form_Mission_Working_Group_Model);
        }

		[HttpPost]
        [ValidateAntiForgeryToken]
		public virtual ActionResult Edit(Default_Form_Mission_Working_Group_Model Default_Form_Mission_Working_Group_Model)	
        {
			Mission_Working_Group Mission_Working_Group = new Default_Form_Mission_Working_Group_ModelBLM(this._UnitOfWork, this.GAppContext) 
                .ConverTo_Mission_Working_Group( Default_Form_Mission_Working_Group_Model);
		...
		public virtual ActionResult Details(long? id)
        {
		    ...
		    Default_Details_Mission_Working_Group_Model = new Default_Details_Mission_Working_Group_ModelBLM(this._UnitOfWork, this.GAppContext) 
                .ConverTo_Default_Details_Mission_Working_Group_Model(Mission_Working_Group);


			return View(Default_Details_Mission_Working_Group_Model);
        } 
		 ...
		 public virtual ActionResult Delete(long? id)
        {
			...
			Default_Details_Mission_Working_Group_Model Default_Details_Mission_Working_Group_Model = new Default_Details_Mission_Working_Group_ModelBLM(this._UnitOfWork, this.GAppContext) 
							.ConverTo_Default_Details_Mission_Working_Group_Model(Mission_Working_Group);
