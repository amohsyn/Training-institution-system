...
{  
    ...
    public class BaseClassroomCategoriesController : TrainingIS_BaseController
    {
		...
		public virtual ActionResult Index(FilterRequestParams filterRequestParams)
        {
            ...
            List<string> SearchCreteria = this.ClassroomCategoryBLO.GetSearchCreteria();

            List<Default_ClassroomCategory_Index_Model> _ListDefault_ClassroomCategory_Index_Model = null;
            try
            {
                filterRequestParams = this.Save_OR_Load_filterRequestParams_State(filterRequestParams);
               _ListDefault_ClassroomCategory_Index_Model = new Default_ClassroomCategory_Index_ModelBLM(this._UnitOfWork, this.GAppContext)
            ...
            return View(_ListDefault_ClassroomCategory_Index_Model);
        }


		protected virtual void Fill_ViewBag_Create(Default_ClassroomCategory_Create_Model Default_ClassroomCategory_Create_Model)
        {
		...
		public virtual ActionResult Create()
        {
			...
			Default_ClassroomCategory_Create_Model default_classroomcategory_create_model = new Default_ClassroomCategory_Create_ModelBLM(this._UnitOfWork, this.GAppContext) .CreateNew();
			this.Fill_ViewBag_Create(default_classroomcategory_create_model);
			return View(default_classroomcategory_create_model);
        } 

		[HttpPost] 
        [ValidateAntiForgeryToken]
		public virtual ActionResult Create(Default_ClassroomCategory_Create_Model Default_ClassroomCategory_Create_Model)
        {
			ClassroomCategory ClassroomCategory = null ;
			ClassroomCategory = new Default_ClassroomCategory_Create_ModelBLM(this._UnitOfWork, this.GAppContext) 
										.ConverTo_ClassroomCategory(Default_ClassroomCategory_Create_Model);
			...
			msgHelper.Create(msg);
			this.Fill_ViewBag_Create(Default_ClassroomCategory_Create_Model);
			Default_ClassroomCategory_Create_Model = new Default_ClassroomCategory_Create_ModelBLM(this._UnitOfWork, this.GAppContext).ConverTo_Default_ClassroomCategory_Create_Model(ClassroomCategory);
			return View(Default_ClassroomCategory_Create_Model);
        }

		protected virtual void Fill_Edit_ViewBag(Default_ClassroomCategory_Edit_Model Default_ClassroomCategory_Edit_Model)
        {
		...
		public virtual ActionResult Edit(long? id)
        {
			...
			Default_ClassroomCategory_Edit_Model Default_ClassroomCategory_Edit_Model = new Default_ClassroomCategory_Edit_ModelBLM(this._UnitOfWork, this.GAppContext) 
                                                                .ConverTo_Default_ClassroomCategory_Edit_Model(ClassroomCategory) ;

			this.Fill_Edit_ViewBag(Default_ClassroomCategory_Edit_Model);
			return View(Default_ClassroomCategory_Edit_Model);
        }
		...
		public virtual ActionResult Edit(Default_ClassroomCategory_Edit_Model Default_ClassroomCategory_Edit_Model)	
        {
			...
			msgHelper.Edit(msg);
			this.Fill_Edit_ViewBag(Default_ClassroomCategory_Edit_Model);
			Default_ClassroomCategory_Edit_Model = new Default_ClassroomCategory_Edit_ModelBLM(this._UnitOfWork, this.GAppContext).ConverTo_Default_ClassroomCategory_Edit_Model(ClassroomCategory);
			return View(Default_ClassroomCategory_Edit_Model);
        }
		...
		public virtual ActionResult Details(long? id)
        {
		    ...
		    Default_ClassroomCategory_Details_Model = new Default_ClassroomCategory_Details_ModelBLM(this._UnitOfWork, this.GAppContext) 
                .ConverTo_Default_ClassroomCategory_Details_Model(ClassroomCategory);


			return View(Default_ClassroomCategory_Details_Model);
        } 
		 ...
		 public virtual ActionResult Delete(long? id)
        {
			...
			Default_ClassroomCategory_Details_Model Default_ClassroomCategory_Details_Model = new Default_ClassroomCategory_Details_ModelBLM(this._UnitOfWork, this.GAppContext) 
							.ConverTo_Default_ClassroomCategory_Details_Model(ClassroomCategory);
        ...
        /// <summary>
        /// [Generalize] Export the filterted ClassroomCategorys
        /// </summary>
        /// <returns></returns>
        public virtual FileResult Export()
        {
            var dataTable = this.ClassroomCategoryBLO.Export(this.GetType().Name);
            ...
            using (XLWorkbook wb = new XLWorkbook())
            {
                ...
                {
                    wb.SaveAs(stream);
                    string FileName = ClassroomCategoryBLO.Get_Export_File_Name();
        ...
        public virtual FileResult Import_File_Example()
        {
            using (XLWorkbook wb = new XLWorkbook())
            {
                DataTable dataTable = ClassroomCategoryBLO.Import_File_Example();
                wb.Worksheets.Add(dataTable);
                using (MemoryStream stream = new MemoryStream())
                {
                    wb.SaveAs(stream);
                    string FileName = this.ClassroomCategoryBLO.Get_Import_File_Name();
                    return File(stream.ToArray(), "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", FileName);
                }
            }
        }
