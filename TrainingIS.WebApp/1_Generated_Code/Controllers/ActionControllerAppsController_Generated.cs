...
{  
    ...
    public class BaseActionControllerAppsController : BaseController<TrainingISModel>
    {
		...
		public ActionResult Index(FilterRequestParams filterRequestParams)
        {
            ...
            List<Default_Details_ActionControllerApp_Model> _ListDefault_Details_ActionControllerApp_Model = new Default_Details_ActionControllerApp_ModelBLM(this._UnitOfWork, this.GAppContext)
		...
		protected void Fill_ViewBag_Create(Default_Form_ActionControllerApp_Model Default_Form_ActionControllerApp_Model)
        {
		...
		protected void Fill_Edit_ViewBag(Default_Form_ActionControllerApp_Model Default_Form_ActionControllerApp_Model)
        {
			ViewBag.ControllerAppId = new SelectList(new ControllerAppBLO(this._UnitOfWork, this.GAppContext) .FindAll(), "Id", nameof(TrainingIS_BaseEntity.ToStringValue), Default_Form_ActionControllerApp_Model.ControllerAppId);
