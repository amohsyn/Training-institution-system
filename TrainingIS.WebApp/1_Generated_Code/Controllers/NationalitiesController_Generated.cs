...
{  
    ...
    public class BaseNationalitiesController : TrainingIS_BaseController
    {
		...
		public virtual ActionResult Index(FilterRequestParams filterRequestParams)
        {
            ...
            List<Default_Details_Nationality_Model> _ListDefault_Details_Nationality_Model = new Default_Details_Nationality_ModelBLM(this._UnitOfWork, this.GAppContext)
