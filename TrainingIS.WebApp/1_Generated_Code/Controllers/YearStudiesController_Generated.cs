...
{  
    ...
    public class BaseYearStudiesController : TrainingIS_BaseController
    {
		...
		public BaseYearStudiesController()
        {
			...
			this.YearStudyBLO = new YearStudyBLO(this._UnitOfWork, this.GAppContext) ;
        }
		...
		public virtual ActionResult Index(FilterRequestParams filterRequestParams)
        {
            ...
            List<Default_YearStudy_Index_Model> _ListDefault_YearStudy_Index_Model = null;
            try
            {
                filterRequestParams = this.Save_OR_Load_filterRequestParams_State(filterRequestParams);
               _ListDefault_YearStudy_Index_Model = new Default_YearStudy_Index_ModelBLM(this._UnitOfWork, this.GAppContext)
            ...
            return View(_ListDefault_YearStudy_Index_Model);
        }


		protected virtual void Fill_ViewBag_Create(Default_YearStudy_Create_Model Default_YearStudy_Create_Model)
        {
		...
		public virtual ActionResult Create()
        {
			...
			Default_YearStudy_Create_Model default_yearstudy_create_model = new Default_YearStudy_Create_ModelBLM(this._UnitOfWork, this.GAppContext) .CreateNew();
			this.Fill_ViewBag_Create(default_yearstudy_create_model);
			return View(default_yearstudy_create_model);
        } 

		[HttpPost] 
        [ValidateAntiForgeryToken]
		public virtual ActionResult Create(Default_YearStudy_Create_Model Default_YearStudy_Create_Model)
        {
			YearStudy YearStudy = null ;
			YearStudy = new Default_YearStudy_Create_ModelBLM(this._UnitOfWork, this.GAppContext) 
										.ConverTo_YearStudy(Default_YearStudy_Create_Model);
			...
			msgHelper.Create(msg);
			this.Fill_ViewBag_Create(Default_YearStudy_Create_Model);
			Default_YearStudy_Create_Model = new Default_YearStudy_Create_ModelBLM(this._UnitOfWork, this.GAppContext).ConverTo_Default_YearStudy_Create_Model(YearStudy);
			return View(Default_YearStudy_Create_Model);
        }

		protected virtual void Fill_Edit_ViewBag(Default_YearStudy_Edit_Model Default_YearStudy_Edit_Model)
        {
		...
		public virtual ActionResult Edit(long? id)
        {
			...
			Default_YearStudy_Edit_Model Default_YearStudy_Edit_Model = new Default_YearStudy_Edit_ModelBLM(this._UnitOfWork, this.GAppContext) 
                                                                .ConverTo_Default_YearStudy_Edit_Model(YearStudy) ;

			this.Fill_Edit_ViewBag(Default_YearStudy_Edit_Model);
			return View(Default_YearStudy_Edit_Model);
        }
		...
		public virtual ActionResult Edit(Default_YearStudy_Edit_Model Default_YearStudy_Edit_Model)	
        {
			...
			msgHelper.Edit(msg);
			this.Fill_Edit_ViewBag(Default_YearStudy_Edit_Model);
			Default_YearStudy_Edit_Model = new Default_YearStudy_Edit_ModelBLM(this._UnitOfWork, this.GAppContext).ConverTo_Default_YearStudy_Edit_Model(YearStudy);
			return View(Default_YearStudy_Edit_Model);
        }
		...
		public virtual ActionResult Details(long? id)
        {
		    ...
		    Default_YearStudy_Details_Model = new Default_YearStudy_Details_ModelBLM(this._UnitOfWork, this.GAppContext) 
                .ConverTo_Default_YearStudy_Details_Model(YearStudy);


			return View(Default_YearStudy_Details_Model);
        } 
		 ...
		 public virtual ActionResult Delete(long? id)
        {
			...
			Default_YearStudy_Details_Model Default_YearStudy_Details_Model = new Default_YearStudy_Details_ModelBLM(this._UnitOfWork, this.GAppContext) 
							.ConverTo_Default_YearStudy_Details_Model(YearStudy);
        ...
        { 
            ...
            try
            {
                ...
                using (XLWorkbook wb = new XLWorkbook())
                {
					...
					Session["repport_name"] = msg_YearStudy.PluralName;
        ...
        /// <summary>
        /// [Generalize] Export the filterted YearStudys
        /// </summary>
        /// <returns></returns>
        public virtual FileResult Export()
        {
            var dataTable = this.YearStudyBLO.Export(this.GetType().Name);
            ...
            using (XLWorkbook wb = new XLWorkbook())
            {
                ...
                {
                    wb.SaveAs(stream);
                    string FileName = string.Format("{0}-{1}", msg_YearStudy.PluralName, DateTime.Now.ToShortDateString());
        ...
        public virtual FileResult Import_File_Example()
        {
            using (XLWorkbook wb = new XLWorkbook())
            {
                DataTable dataTable = YearStudyBLO.Import_File_Example();
                wb.Worksheets.Add(dataTable);
                using (MemoryStream stream = new MemoryStream())
                {
                    wb.SaveAs(stream);
