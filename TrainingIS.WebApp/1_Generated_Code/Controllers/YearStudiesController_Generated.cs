...
{  
    ...
    public class BaseYearStudiesController : TrainingIS_BaseController
    {
		...
		public virtual ActionResult Index(FilterRequestParams filterRequestParams)
        {
            ...
            List<Default_Details_YearStudy_Model> _ListDefault_Details_YearStudy_Model = null;
            try
            {
                filterRequestParams = this.Save_OR_Load_filterRequestParams_State(filterRequestParams);
               _ListDefault_Details_YearStudy_Model = new Default_Details_YearStudy_ModelBLM(this._UnitOfWork, this.GAppContext)
            ...
            return View(_ListDefault_Details_YearStudy_Model);
        }


		protected virtual void Fill_ViewBag_Create(Default_Form_YearStudy_Model Default_Form_YearStudy_Model)
        {
		...
		public virtual ActionResult Create()
        {
			...
			Default_Form_YearStudy_Model default_form_yearstudy_model = new Default_Form_YearStudy_ModelBLM(this._UnitOfWork, this.GAppContext) .CreateNew();
			this.Fill_ViewBag_Create(default_form_yearstudy_model);
			return View(default_form_yearstudy_model);
        } 

		[HttpPost] 
        [ValidateAntiForgeryToken]
		public virtual ActionResult Create(Default_Form_YearStudy_Model Default_Form_YearStudy_Model)
        {
			YearStudy YearStudy = null ;
			YearStudy = new Default_Form_YearStudy_ModelBLM(this._UnitOfWork, this.GAppContext) 
										.ConverTo_YearStudy(Default_Form_YearStudy_Model);
			...
			msgHelper.Create(msg);
			this.Fill_ViewBag_Create(Default_Form_YearStudy_Model);
			Default_Form_YearStudy_Model = new Default_Form_YearStudy_ModelBLM(this._UnitOfWork, this.GAppContext).ConverTo_Default_Form_YearStudy_Model(YearStudy);
			return View(Default_Form_YearStudy_Model);
        }

		protected virtual void Fill_Edit_ViewBag(Default_Form_YearStudy_Model Default_Form_YearStudy_Model)
        {
		...
		public virtual ActionResult Edit(long? id)
        {
			...
			Default_Form_YearStudy_Model Default_Form_YearStudy_Model = new Default_Form_YearStudy_ModelBLM(this._UnitOfWork, this.GAppContext) 
                                                                .ConverTo_Default_Form_YearStudy_Model(YearStudy) ;

			this.Fill_Edit_ViewBag(Default_Form_YearStudy_Model);
			return View(Default_Form_YearStudy_Model);
        }

		[HttpPost]
        [ValidateAntiForgeryToken]
		public virtual ActionResult Edit(Default_Form_YearStudy_Model Default_Form_YearStudy_Model)	
        {
			YearStudy YearStudy = new Default_Form_YearStudy_ModelBLM(this._UnitOfWork, this.GAppContext) 
                .ConverTo_YearStudy( Default_Form_YearStudy_Model);
		...
		public virtual ActionResult Details(long? id)
        {
		    ...
		    Default_Details_YearStudy_Model = new Default_Details_YearStudy_ModelBLM(this._UnitOfWork, this.GAppContext) 
                .ConverTo_Default_Details_YearStudy_Model(YearStudy);


			return View(Default_Details_YearStudy_Model);
        } 
		 ...
		 public virtual ActionResult Delete(long? id)
        {
			...
			Default_Details_YearStudy_Model Default_Details_YearStudy_Model = new Default_Details_YearStudy_ModelBLM(this._UnitOfWork, this.GAppContext) 
							.ConverTo_Default_Details_YearStudy_Model(YearStudy);
