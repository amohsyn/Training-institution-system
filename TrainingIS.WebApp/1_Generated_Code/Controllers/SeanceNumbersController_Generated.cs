...
{  
    ...
    public class BaseSeanceNumbersController : TrainingIS_BaseController
    {
		...
		public virtual ActionResult Index(FilterRequestParams filterRequestParams)
        {
            ...
            List<Default_Details_SeanceNumber_Model> _ListDefault_Details_SeanceNumber_Model = null;
            try
            {
                filterRequestParams = this.Save_OR_Load_filterRequestParams_State(filterRequestParams);
               _ListDefault_Details_SeanceNumber_Model = new Default_Details_SeanceNumber_ModelBLM(this._UnitOfWork, this.GAppContext)
		...
		protected virtual void Fill_ViewBag_Create(Default_Form_SeanceNumber_Model Default_Form_SeanceNumber_Model)
        {
		...
		protected virtual void Fill_Edit_ViewBag(Default_Form_SeanceNumber_Model Default_Form_SeanceNumber_Model)
        {
