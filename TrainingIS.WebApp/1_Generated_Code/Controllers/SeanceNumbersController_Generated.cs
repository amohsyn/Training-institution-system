...
{  
    ...
    public class BaseSeanceNumbersController : BaseController<TrainingISModel>
    {
		...
		public ActionResult Index(FilterRequestParams filterRequestParams)
        {
            ...
            List<Default_Details_SeanceNumber_Model> _ListDefault_Details_SeanceNumber_Model = new Default_Details_SeanceNumber_ModelBLM(this._UnitOfWork, this.GAppContext)
            ...
            return View(_ListDefault_Details_SeanceNumber_Model);
        }


		protected void Fill_ViewBag_Create(Default_Form_SeanceNumber_Model Default_Form_SeanceNumber_Model)
        {
		...
		public virtual ActionResult Create()
        {
			...
			Default_Form_SeanceNumber_Model default_form_seancenumber_model = new Default_Form_SeanceNumber_ModelBLM(this._UnitOfWork, this.GAppContext) .CreateNew();
			this.Fill_ViewBag_Create(default_form_seancenumber_model);
		...
		protected void Fill_Edit_ViewBag(Default_Form_SeanceNumber_Model Default_Form_SeanceNumber_Model)
        {
		...
		public virtual ActionResult Edit(long? id)
        {
			...
			Default_Form_SeanceNumber_Model Default_Form_SeanceNumber_Model = new Default_Form_SeanceNumber_ModelBLM(this._UnitOfWork, this.GAppContext) 
		...
		public virtual ActionResult Details(long? id)
        {
		    ...
		    Default_Details_SeanceNumber_Model = new Default_Details_SeanceNumber_ModelBLM(this._UnitOfWork, this.GAppContext) 
                .ConverTo_Default_Details_SeanceNumber_Model(SeanceNumber);


			return View(Default_Details_SeanceNumber_Model);
        } 
		 ...
		 public virtual ActionResult Delete(long? id)
        {
			...
			Default_Details_SeanceNumber_Model Default_Details_SeanceNumber_Model = new Default_Details_SeanceNumber_ModelBLM(this._UnitOfWork, this.GAppContext) 
							.ConverTo_Default_Details_SeanceNumber_Model(SeanceNumber);
        ...
        public virtual FileResult Export()
        {
            using (XLWorkbook wb = new XLWorkbook())
            {
                ...
                {
                    wb.SaveAs(stream);
					string FileName = string.Format("{0}-{1}", msg_SeanceNumber.PluralName, DateTime.Now.ToShortDateString());
