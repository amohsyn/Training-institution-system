...
{  
    ...
    public class BaseRoleAppsController : TrainingIS_BaseController
    {
		...
		public virtual ActionResult Index(FilterRequestParams filterRequestParams)
        {
            ...
            List<string> SearchCreteria = this.RoleAppBLO.GetSearchCreteria();

            List<Default_RoleApp_Index_Model> _ListDefault_RoleApp_Index_Model = null;
            try
            {
                filterRequestParams = this.Save_OR_Load_filterRequestParams_State(filterRequestParams);
               _ListDefault_RoleApp_Index_Model = new Default_RoleApp_Index_ModelBLM(this._UnitOfWork, this.GAppContext)
            ...
            return View(_ListDefault_RoleApp_Index_Model);
        }


		protected virtual void Fill_ViewBag_Create(Default_RoleApp_Create_Model Default_RoleApp_Create_Model)
        {
		...
		public virtual ActionResult Create()
        {
			...
			Default_RoleApp_Create_Model default_roleapp_create_model = new Default_RoleApp_Create_ModelBLM(this._UnitOfWork, this.GAppContext) .CreateNew();
			this.Fill_ViewBag_Create(default_roleapp_create_model);
			return View(default_roleapp_create_model);
        } 

		[HttpPost] 
        [ValidateAntiForgeryToken]
		public virtual ActionResult Create(Default_RoleApp_Create_Model Default_RoleApp_Create_Model)
        {
			RoleApp RoleApp = null ;
			RoleApp = new Default_RoleApp_Create_ModelBLM(this._UnitOfWork, this.GAppContext) 
										.ConverTo_RoleApp(Default_RoleApp_Create_Model);
			...
			msgHelper.Create(msg);
			this.Fill_ViewBag_Create(Default_RoleApp_Create_Model);
			Default_RoleApp_Create_Model = new Default_RoleApp_Create_ModelBLM(this._UnitOfWork, this.GAppContext).ConverTo_Default_RoleApp_Create_Model(RoleApp);
			return View(Default_RoleApp_Create_Model);
        }

		protected virtual void Fill_Edit_ViewBag(Default_RoleApp_Edit_Model Default_RoleApp_Edit_Model)
        {
		...
		public virtual ActionResult Edit(long? id)
        {
			...
			Default_RoleApp_Edit_Model Default_RoleApp_Edit_Model = new Default_RoleApp_Edit_ModelBLM(this._UnitOfWork, this.GAppContext) 
                                                                .ConverTo_Default_RoleApp_Edit_Model(RoleApp) ;

			this.Fill_Edit_ViewBag(Default_RoleApp_Edit_Model);
			return View(Default_RoleApp_Edit_Model);
        }

		[HttpPost]
        [ValidateAntiForgeryToken]
		public virtual ActionResult Edit(Default_RoleApp_Edit_Model Default_RoleApp_Edit_Model)	
        {
			if(Default_RoleApp_Edit_Model.Id == 0)
            {
                string msg = string.Format(msgManager.You_try_to_edit_that_does_not_exist, msgHelper.UndefindedArticle(), msg_RoleApp.SingularName.ToLower());
                Alert(msg, NotificationType.error);
                return RedirectToAction("Index");
			...
			RoleApp RoleApp = new Default_RoleApp_Edit_ModelBLM(this._UnitOfWork, this.GAppContext) 
                .ConverTo_RoleApp( Default_RoleApp_Edit_Model);
			...
			msgHelper.Edit(msg);
			this.Fill_Edit_ViewBag(Default_RoleApp_Edit_Model);
			Default_RoleApp_Edit_Model = new Default_RoleApp_Edit_ModelBLM(this._UnitOfWork, this.GAppContext).ConverTo_Default_RoleApp_Edit_Model(RoleApp);
			return View(Default_RoleApp_Edit_Model);
        }
		...
		public virtual ActionResult Details(long? id)
        {
		    ...
		    Default_RoleApp_Details_Model = new Default_RoleApp_Details_ModelBLM(this._UnitOfWork, this.GAppContext) 
                .ConverTo_Default_RoleApp_Details_Model(RoleApp);


			return View(Default_RoleApp_Details_Model);
        } 
		 ...
		 public virtual ActionResult Delete(long? id)
        {
			...
			Default_RoleApp_Details_Model Default_RoleApp_Details_Model = new Default_RoleApp_Details_ModelBLM(this._UnitOfWork, this.GAppContext) 
							.ConverTo_Default_RoleApp_Details_Model(RoleApp);
        ...
        /// <summary>
        /// [Generalize] Export the filterted RoleApps
        /// </summary>
        /// <returns></returns>
        public virtual FileResult Export()
        {
            var dataTable = this.RoleAppBLO.Export(this.GetType().Name);
            ...
            using (XLWorkbook wb = new XLWorkbook())
            {
                ...
                {
                    wb.SaveAs(stream);
                    string FileName = RoleAppBLO.Get_Export_File_Name();
        ...
        public virtual FileResult Import_File_Example()
        {
            using (XLWorkbook wb = new XLWorkbook())
            {
                DataTable dataTable = RoleAppBLO.Import_File_Example();
                wb.Worksheets.Add(dataTable);
                using (MemoryStream stream = new MemoryStream())
                {
                    wb.SaveAs(stream);
                    string FileName = this.RoleAppBLO.Get_Import_File_Name();
                    return File(stream.ToArray(), "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", FileName);
                }
            }
        }
