...
{  
    ...
    public class BaseRoleAppsController : TrainingIS_BaseController
    {
		...
		public virtual ActionResult Index(FilterRequestParams filterRequestParams)
        {
            ...
            List<Default_Details_RoleApp_Model> _ListDefault_Details_RoleApp_Model = null;
            try
            {
                filterRequestParams = this.Save_OR_Load_filterRequestParams_State(filterRequestParams);
               _ListDefault_Details_RoleApp_Model = new Default_Details_RoleApp_ModelBLM(this._UnitOfWork, this.GAppContext)
            ...
            return View(_ListDefault_Details_RoleApp_Model);
        }


		protected virtual void Fill_ViewBag_Create(Default_Form_RoleApp_Model Default_Form_RoleApp_Model)
        {
		...
		protected virtual void Fill_Edit_ViewBag(Default_Form_RoleApp_Model Default_Form_RoleApp_Model)
        {
