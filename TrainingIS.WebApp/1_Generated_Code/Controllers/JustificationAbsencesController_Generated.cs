...
{  
    ...
    public class BaseJustificationAbsencesController : TrainingIS_BaseController
    {
        protected JustificationAbsenceBLO JustificationAbsenceBLO = null;

		public BaseJustificationAbsencesController()
        {
            this.msgHelper = new MessagesService(typeof(JustificationAbsence));
			this.JustificationAbsenceBLO = new JustificationAbsenceBLO(this._UnitOfWork, this.GAppContext) ;
        }
        ...
        protected virtual void InitFilter(Index_GAppPage index_page, string FilterBy,string SearchBy)
        {
			...
			string All_Trainee_msg = string.Format("tous les {0}",msg_JustificationAbsence.PluralName.ToLower());
			...
			FilterItem_Category_JustificationAbsence.Placeholder = model_property.getLocalName();
			FilterItem_Category_JustificationAbsence.FilterItem_Category = FilterItem_GAppComponent.FilterItem_Categories.Select;
			var filter_info_Category_JustificationAbsence = filters_by_infos
                .Where(f => f.PropertyName == FilterItem_Category_JustificationAbsence.Id.RemoveFromEnd("_Filter"))
                .FirstOrDefault();
            if(filter_info_Category_JustificationAbsence != null)
            {
                FilterItem_Category_JustificationAbsence.Selected = filter_info_Category_JustificationAbsence.Value;
            }

			var All_Data_Category_JustificationAbsence = new Category_JustificationAbsenceBLO(this._UnitOfWork, this.GAppContext).FindAll();
			string All_Category_JustificationAbsence_msg = string.Format("tous les {0}",msg_JustificationAbsence.PluralName.ToLower());
            All_Data_Category_JustificationAbsence.Insert(0, new Category_JustificationAbsence { Id = 0, ToStringValue = All_Category_JustificationAbsence_msg });
            FilterItem_Category_JustificationAbsence.Data = All_Data_Category_JustificationAbsence.ToDictionary(entity => entity.Id.ToString(), entity => entity.ToStringValue);
			index_page.Filter.FilterItems.Add(FilterItem_Category_JustificationAbsence);
		...
		public virtual ActionResult Index(FilterRequestParams filterRequestParams)
        {
            ...
            List<string> SearchCreteria = this.JustificationAbsenceBLO.GetSearchCreteria();
		...
		public virtual ActionResult Create(Default_JustificationAbsence_Create_Model Default_JustificationAbsence_Create_Model)
        {
            ...
            if (ModelState.IsValid)
            {
				...
				try
                {
					...
					Alert(string.Format(msgManager.The_Entity_was_well_created, msgHelper.DefinitArticle().FirstLetterToUpperCase(), msg_JustificationAbsence.SingularName.ToLower(), JustificationAbsence), NotificationType.success);
		...
		public virtual ActionResult Edit(long? id)
        {
            ...
            JustificationAbsence JustificationAbsence = JustificationAbsenceBLO.FindBaseEntityByID((long)id);
            if (JustificationAbsence == null)
            {
                string msg = string.Format(msgManager.You_try_to_edit_that_does_not_exist, msgHelper.UndefindedArticle(), msg_JustificationAbsence.SingularName.ToLower());
        ...
        {
			if(Default_JustificationAbsence_Edit_Model.Id == 0)
            {
                string msg = string.Format(msgManager.You_try_to_edit_that_does_not_exist, msgHelper.UndefindedArticle(), msg_JustificationAbsence.SingularName.ToLower());
                Alert(msg, NotificationType.error);
                return RedirectToAction("Index");
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    JustificationAbsenceBLO.Save(JustificationAbsence);
					Alert(string.Format(msgManager.The_entity_has_been_changed,msgHelper.DefinitArticle().FirstLetterToUpperCase(), msg_JustificationAbsence.SingularName.ToLower(), JustificationAbsence), NotificationType.success);
					return RedirectToAction("Index");
                }
                catch (GAppException ex)
                {
		...
		public virtual ActionResult Details(long? id)
        {
            ...
            if (JustificationAbsence == null)
            {
                string msg = string.Format(msgManager.You_try_to_show_that_does_not_exist, msgHelper.UndefindedArticle(), msg_JustificationAbsence.SingularName.ToLower());
                Alert(msg, NotificationType.error);
                return RedirectToAction("Index");
            }
		 ...
		 public virtual ActionResult Delete(long? id)
        {
            ...
            if (JustificationAbsence == null)
            {
			    string msg = string.Format(msgManager.You_try_to_delete_that_does_not_exist, msgHelper.UndefindedArticle(), msg_JustificationAbsence.SingularName.ToLower());
                Alert(msg, NotificationType.error);
                return RedirectToAction("Index");
            }
        ...
        public virtual ActionResult DeleteConfirmed(long id)
        {
			...
			try
            {
                JustificationAbsenceBLO.Delete(JustificationAbsence);
            }
            catch (GAppDbUpdate_ForeignKeyViolation_Exception ex)
            {
                string msg = string.Format(msgManager.You_can_not_delete_this_entity_because_it_is_already_related_to_another_object, JustificationAbsence.ToString());
                Alert(msg, NotificationType.error);
                return RedirectToAction("Index");
            }
            catch (GAppException ex)
			...
			Alert(string.Format(msgManager.The_entity_has_been_removed,msgHelper.DefinitArticle().FirstLetterToUpperCase(), msg_JustificationAbsence.SingularName.ToLower(), JustificationAbsence), NotificationType.success);
            return RedirectToAction("Index");
        }
        ...
        { 
            ...
            try
            {
                ImportReport importReport = JustificationAbsenceBLO.Import(firstTable, FileName);
                ...
                using (XLWorkbook wb = new XLWorkbook())
                {
					...
					Session["repport_name"] = msg_JustificationAbsence.PluralName;
                    wb.SaveAs(path_repport);

                    // Add DownLoad Link to Repport
                    string a_download = "<a href=\"/JustificationAbsences/LastRepportFile\">Télécharger le rapport d'importation</a>";
        ...
        /// <summary>
        /// [Generalize] Export the filterted JustificationAbsences
        /// </summary>
        /// <returns></returns>
        public virtual FileResult Export()
        {
            var dataTable = this.JustificationAbsenceBLO.Export(this.GetType().Name);
            ...
            using (XLWorkbook wb = new XLWorkbook())
            {
                ...
                {
                    wb.SaveAs(stream);
                    string FileName = JustificationAbsenceBLO.Get_Export_File_Name();
        ...
        public virtual FileResult Import_File_Example()
        {
            using (XLWorkbook wb = new XLWorkbook())
            {
                DataTable dataTable = JustificationAbsenceBLO.Import_File_Example();
                wb.Worksheets.Add(dataTable);
                using (MemoryStream stream = new MemoryStream())
                {
                    wb.SaveAs(stream);
                    string FileName = this.JustificationAbsenceBLO.Get_Import_File_Name();
                    return File(stream.ToArray(), "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", FileName);
                }
            }
        }
        ...
        protected override void Dispose(bool disposing)
        {
            if (disposing)
            {
                JustificationAbsenceBLO.Dispose();
            }
            base.Dispose(disposing);
        }
    }

	public partial class JustificationAbsencesController : BaseJustificationAbsencesController{};
}
