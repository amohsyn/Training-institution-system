...
{  
    ...
    public class BaseSeancePlanningsController : BaseController<TrainingISModel>
    {
		...
		public ActionResult Index(FilterRequestParams filterRequestParams)
        {
            ...
            List<Default_Details_SeancePlanning_Model> _ListDefault_Details_SeancePlanning_Model = new Default_Details_SeancePlanning_ModelBLM(this._UnitOfWork, this.GAppContext)
