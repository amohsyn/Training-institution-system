...
{  
    ...
    public class BaseControllerAppsController : TrainingIS_BaseController
    {
		...
		public BaseControllerAppsController()
        {
			...
			this.ControllerAppBLO = new ControllerAppBLO(this._UnitOfWork, this.GAppContext) ;
        }
        ...
        protected virtual void InitFilter(Index_GAppPage index_page, string FilterBy,string SearchBy)
        {
			...
			model_property = typeof(Default_ControllerApp_Index_Model).GetProperty(nameof(Default_ControllerApp_Index_Model.Name));
		...
		public virtual ActionResult Index(FilterRequestParams filterRequestParams)
        {
            ...
            List<Default_ControllerApp_Index_Model> _ListDefault_ControllerApp_Index_Model = null;
            try
            {
                filterRequestParams = this.Save_OR_Load_filterRequestParams_State(filterRequestParams);
               _ListDefault_ControllerApp_Index_Model = new Default_ControllerApp_Index_ModelBLM(this._UnitOfWork, this.GAppContext)
            ...
            return View(_ListDefault_ControllerApp_Index_Model);
        }


		protected virtual void Fill_ViewBag_Create(Default_ControllerApp_Create_Model Default_ControllerApp_Create_Model)
        {
		...
		public virtual ActionResult Create()
        {
			...
			Default_ControllerApp_Create_Model default_controllerapp_create_model = new Default_ControllerApp_Create_ModelBLM(this._UnitOfWork, this.GAppContext) .CreateNew();
			this.Fill_ViewBag_Create(default_controllerapp_create_model);
			return View(default_controllerapp_create_model);
        } 

		[HttpPost] 
        [ValidateAntiForgeryToken]
		public virtual ActionResult Create(Default_ControllerApp_Create_Model Default_ControllerApp_Create_Model)
        {
			ControllerApp ControllerApp = null ;
			ControllerApp = new Default_ControllerApp_Create_ModelBLM(this._UnitOfWork, this.GAppContext) 
										.ConverTo_ControllerApp(Default_ControllerApp_Create_Model);
			...
			msgHelper.Create(msg);
			this.Fill_ViewBag_Create(Default_ControllerApp_Create_Model);
			Default_ControllerApp_Create_Model = new Default_ControllerApp_Create_ModelBLM(this._UnitOfWork, this.GAppContext).ConverTo_Default_ControllerApp_Create_Model(ControllerApp);
			return View(Default_ControllerApp_Create_Model);
        }

		protected virtual void Fill_Edit_ViewBag(Default_ControllerApp_Edit_Model Default_ControllerApp_Edit_Model)
        {
		...
		public virtual ActionResult Edit(long? id)
        {
			...
			Default_ControllerApp_Edit_Model Default_ControllerApp_Edit_Model = new Default_ControllerApp_Edit_ModelBLM(this._UnitOfWork, this.GAppContext) 
                                                                .ConverTo_Default_ControllerApp_Edit_Model(ControllerApp) ;

			this.Fill_Edit_ViewBag(Default_ControllerApp_Edit_Model);
			return View(Default_ControllerApp_Edit_Model);
        }
		...
		public virtual ActionResult Edit(Default_ControllerApp_Edit_Model Default_ControllerApp_Edit_Model)	
        {
			...
			msgHelper.Edit(msg);
			this.Fill_Edit_ViewBag(Default_ControllerApp_Edit_Model);
			Default_ControllerApp_Edit_Model = new Default_ControllerApp_Edit_ModelBLM(this._UnitOfWork, this.GAppContext).ConverTo_Default_ControllerApp_Edit_Model(ControllerApp);
			return View(Default_ControllerApp_Edit_Model);
        }
		...
		public virtual ActionResult Details(long? id)
        {
		    ...
		    Default_ControllerApp_Details_Model = new Default_ControllerApp_Details_ModelBLM(this._UnitOfWork, this.GAppContext) 
                .ConverTo_Default_ControllerApp_Details_Model(ControllerApp);


			return View(Default_ControllerApp_Details_Model);
        } 
		 ...
		 public virtual ActionResult Delete(long? id)
        {
			...
			Default_ControllerApp_Details_Model Default_ControllerApp_Details_Model = new Default_ControllerApp_Details_ModelBLM(this._UnitOfWork, this.GAppContext) 
							.ConverTo_Default_ControllerApp_Details_Model(ControllerApp);
        ...
        { 
            ...
            try
            {
                ...
                using (XLWorkbook wb = new XLWorkbook())
                {
					...
					Session["repport_name"] = msg_ControllerApp.PluralName;
        ...
        /// <summary>
        /// [Generalize] Export the filterted ControllerApps
        /// </summary>
        /// <returns></returns>
        public virtual FileResult Export()
        {
            var dataTable = this.ControllerAppBLO.Export(this.GetType().Name);
        ...
        public virtual FileResult Import_File_Example()
        {
            using (XLWorkbook wb = new XLWorkbook())
            {
                DataTable dataTable = ControllerAppBLO.Import_File_Example();
                wb.Worksheets.Add(dataTable);
                using (MemoryStream stream = new MemoryStream())
                {
                    wb.SaveAs(stream);
