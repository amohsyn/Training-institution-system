...
{  
    ...
    public class BaseSpecialtiesController : TrainingIS_BaseController
    {
        ...
        protected virtual void InitFilter(Index_GAppPage index_page, string FilterBy,string SearchBy)
        {
			...
			model_property = typeof(Default_Specialty_Index_Model).GetProperty(nameof(Default_Specialty_Index_Model.Sector));
			...
			model_property = typeof(Default_Specialty_Index_Model).GetProperty(nameof(Default_Specialty_Index_Model.TrainingLevel));
		...
		public virtual ActionResult Index(FilterRequestParams filterRequestParams)
        {
            ...
            List<string> SearchCreteria = this.SpecialtyBLO.GetSearchCreteria();

            List<Default_Specialty_Index_Model> _ListDefault_Specialty_Index_Model = null;
            try
            {
                filterRequestParams = this.Save_OR_Load_filterRequestParams_State(filterRequestParams);
               _ListDefault_Specialty_Index_Model = new Default_Specialty_Index_ModelBLM(this._UnitOfWork, this.GAppContext)
            ...
            return View(_ListDefault_Specialty_Index_Model);
        }
		...
		public virtual ActionResult Create()
        {
			...
			Default_Specialty_Create_Model default_specialty_create_model = new Default_Specialty_Create_ModelBLM(this._UnitOfWork, this.GAppContext) .CreateNew();
			this.Fill_ViewBag_Create(default_specialty_create_model);
			return View(default_specialty_create_model);
        } 

		[HttpPost] 
        [ValidateAntiForgeryToken]
		public virtual ActionResult Create(Default_Specialty_Create_Model Default_Specialty_Create_Model)
        {
			Specialty Specialty = null ;
			Specialty = new Default_Specialty_Create_ModelBLM(this._UnitOfWork, this.GAppContext) 
										.ConverTo_Specialty(Default_Specialty_Create_Model);
			...
			msgHelper.Create(msg);
			this.Fill_ViewBag_Create(Default_Specialty_Create_Model);
			Default_Specialty_Create_Model = new Default_Specialty_Create_ModelBLM(this._UnitOfWork, this.GAppContext).ConverTo_Default_Specialty_Create_Model(Specialty);
			return View(Default_Specialty_Create_Model);
        }

		protected virtual void Fill_Edit_ViewBag(Default_Specialty_Edit_Model Default_Specialty_Edit_Model)
        {
			ViewBag.SectorId = new SelectList(new SectorBLO(this._UnitOfWork, this.GAppContext) .FindAll(), "Id", nameof(TrainingIS_BaseEntity.ToStringValue), Default_Specialty_Edit_Model.SectorId);
			ViewBag.TrainingLevelId = new SelectList(new TrainingLevelBLO(this._UnitOfWork, this.GAppContext) .FindAll(), "Id", nameof(TrainingIS_BaseEntity.ToStringValue), Default_Specialty_Edit_Model.TrainingLevelId);
		...
		public virtual ActionResult Edit(long? id)
        {
			...
			Default_Specialty_Edit_Model Default_Specialty_Edit_Model = new Default_Specialty_Edit_ModelBLM(this._UnitOfWork, this.GAppContext) 
                                                                .ConverTo_Default_Specialty_Edit_Model(Specialty) ;

			this.Fill_Edit_ViewBag(Default_Specialty_Edit_Model);
			return View(Default_Specialty_Edit_Model);
        }

		[HttpPost]
        [ValidateAntiForgeryToken]
		public virtual ActionResult Edit(Default_Specialty_Edit_Model Default_Specialty_Edit_Model)	
        {
			if(Default_Specialty_Edit_Model.Id == 0)
            {
                string msg = string.Format(msgManager.You_try_to_edit_that_does_not_exist, msgHelper.UndefindedArticle(), msg_Specialty.SingularName.ToLower());
                Alert(msg, NotificationType.error);
                return RedirectToAction("Index");
			...
			Specialty Specialty = new Default_Specialty_Edit_ModelBLM(this._UnitOfWork, this.GAppContext) 
                .ConverTo_Specialty( Default_Specialty_Edit_Model);
			...
			msgHelper.Edit(msg);
			this.Fill_Edit_ViewBag(Default_Specialty_Edit_Model);
			Default_Specialty_Edit_Model = new Default_Specialty_Edit_ModelBLM(this._UnitOfWork, this.GAppContext).ConverTo_Default_Specialty_Edit_Model(Specialty);
			return View(Default_Specialty_Edit_Model);
        }
		...
		public virtual ActionResult Details(long? id)
        {
		    ...
		    Default_Specialty_Details_Model = new Default_Specialty_Details_ModelBLM(this._UnitOfWork, this.GAppContext) 
                .ConverTo_Default_Specialty_Details_Model(Specialty);


			return View(Default_Specialty_Details_Model);
        } 
		 ...
		 public virtual ActionResult Delete(long? id)
        {
			...
			Default_Specialty_Details_Model Default_Specialty_Details_Model = new Default_Specialty_Details_ModelBLM(this._UnitOfWork, this.GAppContext) 
							.ConverTo_Default_Specialty_Details_Model(Specialty);
        ...
        /// <summary>
        /// [Generalize] Export the filterted Specialtys
        /// </summary>
        /// <returns></returns>
        public virtual FileResult Export()
        {
            var dataTable = this.SpecialtyBLO.Export(this.GetType().Name);
            ...
            using (XLWorkbook wb = new XLWorkbook())
            {
                ...
                {
                    wb.SaveAs(stream);
                    string FileName = SpecialtyBLO.Get_Export_File_Name();
        ...
        public virtual FileResult Import_File_Example()
        {
            using (XLWorkbook wb = new XLWorkbook())
            {
                DataTable dataTable = SpecialtyBLO.Import_File_Example();
                wb.Worksheets.Add(dataTable);
                using (MemoryStream stream = new MemoryStream())
                {
                    wb.SaveAs(stream);
                    string FileName = this.SpecialtyBLO.Get_Import_File_Name();
                    return File(stream.ToArray(), "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", FileName);
                }
            }
        }
