...
{  
    ...
    public class BaseTrainingTypesController : BaseController<TrainingISModel>
    {
        ...
        {
		    msgHelper.Index(msg);
            List<Default_Details_TrainingType_Model> listDefault_Details_TrainingType_Model = new List<Default_Details_TrainingType_Model>();
			foreach (var item in TrainingTypeBLO.FindAll()){
                Default_Details_TrainingType_Model Default_Details_TrainingType_Model = new Default_Details_TrainingType_ModelBLM(this._UnitOfWork, this.GAppContext) 
                    .ConverTo_Default_Details_TrainingType_Model(item);
                listDefault_Details_TrainingType_Model.Add(Default_Details_TrainingType_Model);
            }
			return View(listDefault_Details_TrainingType_Model);
		}

		private void Fill_ViewBag_Create(Default_Form_TrainingType_Model Default_Form_TrainingType_Model)
        {
		...
		public virtual ActionResult Create([Bind(Include = "Code,Name,Description")] Default_Form_TrainingType_Model Default_Form_TrainingType_Model)
        {
		...
		private void Fill_Edit_ViewBag(Default_Form_TrainingType_Model Default_Form_TrainingType_Model)
        {
		...
		[HttpPost]
        [ValidateAntiForgeryToken]
		public virtual ActionResult Edit([Bind(Include = "Code,Name,Description,Id")] Default_Form_TrainingType_Model Default_Form_TrainingType_Model)	
        {
