...
{  
    ...
    public class BaseTrainingTypesController : TrainingIS_BaseController
    {
		...
		public BaseTrainingTypesController()
        {
			...
			this.TrainingTypeBLO = new TrainingTypeBLO(this._UnitOfWork, this.GAppContext) ;
        }
		...
		public virtual ActionResult Index(FilterRequestParams filterRequestParams)
        {
            ...
            List<string> SearchCreteria = this.TrainingTypeBLO.GetSearchCreteria();

            List<Default_TrainingType_Index_Model> _ListDefault_TrainingType_Index_Model = null;
            try
            {
                filterRequestParams = this.Save_OR_Load_filterRequestParams_State(filterRequestParams);
               _ListDefault_TrainingType_Index_Model = new Default_TrainingType_Index_ModelBLM(this._UnitOfWork, this.GAppContext)
            ...
            return View(_ListDefault_TrainingType_Index_Model);
        }


		protected virtual void Fill_ViewBag_Create(Default_TrainingType_Create_Model Default_TrainingType_Create_Model)
        {
		...
		public virtual ActionResult Create()
        {
			...
			Default_TrainingType_Create_Model default_trainingtype_create_model = new Default_TrainingType_Create_ModelBLM(this._UnitOfWork, this.GAppContext) .CreateNew();
			this.Fill_ViewBag_Create(default_trainingtype_create_model);
			return View(default_trainingtype_create_model);
        } 

		[HttpPost] 
        [ValidateAntiForgeryToken]
		public virtual ActionResult Create(Default_TrainingType_Create_Model Default_TrainingType_Create_Model)
        {
			TrainingType TrainingType = null ;
			TrainingType = new Default_TrainingType_Create_ModelBLM(this._UnitOfWork, this.GAppContext) 
										.ConverTo_TrainingType(Default_TrainingType_Create_Model);
			...
			msgHelper.Create(msg);
			this.Fill_ViewBag_Create(Default_TrainingType_Create_Model);
			Default_TrainingType_Create_Model = new Default_TrainingType_Create_ModelBLM(this._UnitOfWork, this.GAppContext).ConverTo_Default_TrainingType_Create_Model(TrainingType);
			return View(Default_TrainingType_Create_Model);
        }

		protected virtual void Fill_Edit_ViewBag(Default_TrainingType_Edit_Model Default_TrainingType_Edit_Model)
        {
		...
		public virtual ActionResult Edit(long? id)
        {
			...
			Default_TrainingType_Edit_Model Default_TrainingType_Edit_Model = new Default_TrainingType_Edit_ModelBLM(this._UnitOfWork, this.GAppContext) 
                                                                .ConverTo_Default_TrainingType_Edit_Model(TrainingType) ;

			this.Fill_Edit_ViewBag(Default_TrainingType_Edit_Model);
			return View(Default_TrainingType_Edit_Model);
        }

		[HttpPost]
        [ValidateAntiForgeryToken]
		public virtual ActionResult Edit(Default_TrainingType_Edit_Model Default_TrainingType_Edit_Model)	
        {
			if(Default_TrainingType_Edit_Model.Id == 0)
            {
                string msg = string.Format(msgManager.You_try_to_edit_that_does_not_exist, msgHelper.UndefindedArticle(), msg_TrainingType.SingularName.ToLower());
                Alert(msg, NotificationType.error);
                return RedirectToAction("Index");
			...
			TrainingType TrainingType = new Default_TrainingType_Edit_ModelBLM(this._UnitOfWork, this.GAppContext) 
                .ConverTo_TrainingType( Default_TrainingType_Edit_Model);
			...
			msgHelper.Edit(msg);
			this.Fill_Edit_ViewBag(Default_TrainingType_Edit_Model);
			Default_TrainingType_Edit_Model = new Default_TrainingType_Edit_ModelBLM(this._UnitOfWork, this.GAppContext).ConverTo_Default_TrainingType_Edit_Model(TrainingType);
			return View(Default_TrainingType_Edit_Model);
        }
		...
		public virtual ActionResult Details(long? id)
        {
		    ...
		    Default_TrainingType_Details_Model = new Default_TrainingType_Details_ModelBLM(this._UnitOfWork, this.GAppContext) 
                .ConverTo_Default_TrainingType_Details_Model(TrainingType);


			return View(Default_TrainingType_Details_Model);
        } 
		 ...
		 public virtual ActionResult Delete(long? id)
        {
			...
			Default_TrainingType_Details_Model Default_TrainingType_Details_Model = new Default_TrainingType_Details_ModelBLM(this._UnitOfWork, this.GAppContext) 
							.ConverTo_Default_TrainingType_Details_Model(TrainingType);
        ...
        { 
            ...
            try
            {
                ...
                using (XLWorkbook wb = new XLWorkbook())
                {
					...
					Session["repport_name"] = msg_TrainingType.PluralName;
        ...
        /// <summary>
        /// [Generalize] Export the filterted TrainingTypes
        /// </summary>
        /// <returns></returns>
        public virtual FileResult Export()
        {
            var dataTable = this.TrainingTypeBLO.Export(this.GetType().Name);
            ...
            using (XLWorkbook wb = new XLWorkbook())
            {
                ...
                {
                    wb.SaveAs(stream);
                    string FileName = TrainingTypeBLO.Get_Export_File_Name();
        ...
        public virtual FileResult Import_File_Example()
        {
            using (XLWorkbook wb = new XLWorkbook())
            {
                DataTable dataTable = TrainingTypeBLO.Import_File_Example();
                wb.Worksheets.Add(dataTable);
                using (MemoryStream stream = new MemoryStream())
                {
                    wb.SaveAs(stream);
                    string FileName = this.TrainingTypeBLO.Get_Import_File_Name();
                    return File(stream.ToArray(), "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", FileName);
                }
            }
        }
