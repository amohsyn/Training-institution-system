...
{  
    ...
    public class BaseClassroomsController : BaseController<TrainingISModel>
    {
		...
		public ActionResult Index(FilterRequestParams filterRequestParams)
        {
            ...
            List<Default_Details_Classroom_Model> _ListDefault_Details_Classroom_Model = new Default_Details_Classroom_ModelBLM(this._UnitOfWork, this.GAppContext)
            ...
            return View(_ListDefault_Details_Classroom_Model);
        }
