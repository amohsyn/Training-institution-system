...
namespace TrainingIS.WebApp.Controllers
{
    ...
    {
        protected SeancePlanningBLO seancePlanningBLO = new SeancePlanningBLO();
        ...
        public virtual ActionResult Create()
        {
		   msgHelper.Create(msg);
            ...
            ViewBag.SeanceDayId = new SelectList(new SeanceDayBLO().FindAll(), "Id", "Name");
			
            ViewBag.SeanceNumberId = new SelectList(new SeanceNumberBLO().FindAll(), "Id", "Code");
			
            ViewBag.TrainingId = new SelectList(new TrainingBLO().FindAll(), "Id", "Code");
            return View();
        }
        ...
        public virtual ActionResult Create([Bind(Include = "Id,TrainingId,SeanceDayId,SeanceNumberId,Description,CreateDate,UpdateDate")] SeancePlanning seancePlanning)
        {
			...
			msgHelper.Create(msg);
            ViewBag.SeanceDayId = new SelectList(new SeanceDayBLO().FindAll(), "Id", "Name", seancePlanning.SeanceDayId);
            ViewBag.SeanceNumberId = new SelectList(new SeanceNumberBLO().FindAll(), "Id", "Code", seancePlanning.SeanceNumberId);
            ViewBag.TrainingId = new SelectList(new TrainingBLO().FindAll(), "Id", "Code", seancePlanning.TrainingId);
