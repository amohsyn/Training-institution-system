...
namespace TrainingIS.WebApp.Controllers
{
    ...
    {
        protected TrainingBLO trainingBLO = new TrainingBLO();
        ...
        public virtual ActionResult Create([Bind(Include = "Id,TrainingYearId,ModuleTrainingId,FormerId,GroupId,Code,Description")] Training training)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public virtual ActionResult Edit([Bind(Include = "Id,TrainingYearId,ModuleTrainingId,FormerId,GroupId,Code,Description")] Training training)
        {
            if (ModelState.IsValid)
            {
