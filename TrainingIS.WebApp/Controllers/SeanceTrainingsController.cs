...
namespace TrainingIS.WebApp.Controllers
{
    ...
    {
        protected SeanceTrainingBLO seanceTrainingBLO = new SeanceTrainingBLO();
        ...
        public virtual ActionResult Create()
        {
		   msgHelper.Create(msg);
            ...
            ViewBag.SeancePlanningId = new SelectList(new SeancePlanningBLO().FindAll(), "Id", "Description");
            return View();
        }
        ...
        public virtual ActionResult Create([Bind(Include = "Id,SeanceDate,SeancePlanningId,CreateDate,UpdateDate")] SeanceTraining seanceTraining)
        {
			...
			msgHelper.Create(msg);
            ViewBag.SeancePlanningId = new SelectList(new SeancePlanningBLO().FindAll(), "Id", "Description", seanceTraining.SeancePlanningId);
