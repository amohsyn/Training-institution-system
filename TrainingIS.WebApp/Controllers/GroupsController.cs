...
namespace TrainingIS.WebApp.Controllers
{
    ...
    {
        protected GroupBLO groupBLO = new GroupBLO();

		public BaseGroupsController()
        {
            this.msgHelper = new MsgHelper(typeof(Group));
        }
        ...
        public virtual ActionResult Create([Bind(Include = "Id,TrainingTypeId,TrainingYearId,SpecialtyId,Year,Code,Description,CreateDate,UpdateDate")] Group group)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public virtual ActionResult Edit([Bind(Include = "Id,TrainingTypeId,TrainingYearId,SpecialtyId,Year,Code,Description,CreateDate,UpdateDate")] Group group)
        {
            if (ModelState.IsValid)
            {
