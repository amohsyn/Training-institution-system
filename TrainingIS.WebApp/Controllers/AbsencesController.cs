...
namespace TrainingIS.WebApp.Controllers
{
    ...
    {
        protected AbsenceBLO absenceBLO = new AbsenceBLO();
        ...
        public virtual ActionResult Create()
        {
		   msgHelper.Create(msg);
            ...
            ViewBag.SeanceTrainingId = new SelectList(new SeanceTrainingBLO().FindAll(), "Id", "Reference");
			
            ViewBag.TraineeId = new SelectList(new TraineeBLO().FindAll(), "Id", "FirstName");
            return View();
        }
        ...
        public virtual ActionResult Create([Bind(Include = "Id,TraineeId,isHaveAuthorization,SeanceTrainingId,FormerComment,TraineeComment,SupervisorComment,CreateDate,UpdateDate")] Absence absence)
        {
			...
			msgHelper.Create(msg);
            ViewBag.SeanceTrainingId = new SelectList(new SeanceTrainingBLO().FindAll(), "Id", "Reference", absence.SeanceTrainingId);
            ViewBag.TraineeId = new SelectList(new TraineeBLO().FindAll(), "Id", "FirstName", absence.TraineeId);
