    ...
    public class BaseApplicationParamsController : BaseController
    {
		...
		public virtual ActionResult Create([Bind(Include = "Code,Name,Value,Description")] Default_ApplicationParamFormView Default_ApplicationParamFormView)
        {
            ...
            if (ModelState.IsValid)
            {
				...
				try
                {
					...
					Alert(string.Format(msgManager.The_Entity_was_well_created, msgHelper.DefinitArticle(), msg_ApplicationParam.SingularName, ApplicationParam), NotificationType.success);
		...
		public virtual ActionResult Edit([Bind(Include = "Code,Name,Value,Description,Id")] Default_ApplicationParamFormView Default_ApplicationParamFormView)	
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    ApplicationParamBLO.Save(ApplicationParam);
					Alert(string.Format(msgManager.The_entity_has_been_changed,msgHelper.DefinitArticle(), msg_ApplicationParam.SingularName, ApplicationParam), NotificationType.success);
					return RedirectToAction("Index");
                }
                catch (GAppDbException ex)
                {
        ...
        public virtual ActionResult DeleteConfirmed(long id)
        {
			...
			Alert(string.Format(msgManager.The_entity_has_been_removed,msgHelper.DefinitArticle(), msg_ApplicationParam.SingularName, ApplicationParam), NotificationType.success);
            return RedirectToAction("Index");
        }
