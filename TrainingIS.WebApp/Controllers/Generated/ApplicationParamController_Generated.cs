...
namespace TrainingIS.WebApp.Controllers
{
    ...
    public class BaseApplicationParamsController : BaseController
    {
        ...
        {
			msgHelper.Index(msg);
            Default_IndexApplicationParamView Default_IndexApplicationParamView = new Default_IndexApplicationParamView();
            foreach (var item in ApplicationParamBLO.FindAll()) { Default_IndexApplicationParamView.Data.Add(item); }
            return View(Default_IndexApplicationParamView);
		}
		...
		public virtual ActionResult Edit(long? id)
        {
			...
			return View(ApplicationParam);
		        ...
		        [HttpPost]
        [ValidateAntiForgeryToken]
		public virtual ActionResult Edit([Bind(Include = "Code,Name,Value,Description,Id")] ApplicationParam ApplicationParam)	
        {
			this.ModelState.AddModelError(ApplicationParamBLO.Validate(ApplicationParam));
			bool dataBaseException = false;
            if (ModelState.IsValid)
            {
				...
				old_ApplicationParam.UpdateEntity(ApplicationParam, this.GetBindAttribute(nameof(this.Edit)));
