...
namespace TrainingIS.WebApp.Controllers
{
    ...
    public class BaseGroupsController : BaseController
    {
        ...
        public virtual ActionResult Create([Bind(Include = "TrainingType,TrainingTypeId,TrainingYear,TrainingYearId,Specialty,SpecialtyId,YearStudy,YearStudyId,Description,Code,Id")] Group Group)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public virtual ActionResult Edit([Bind(Include = "TrainingType,TrainingTypeId,TrainingYear,TrainingYearId,Specialty,SpecialtyId,YearStudy,YearStudyId,Description,Code,Id")] Group Group)
        {
			bool dataBaseException = false;
            if (ModelState.IsValid)
            {
