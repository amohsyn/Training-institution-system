...
{  
    ...
    public class BaseSeanceNumbersController : BaseController
    {
		...
		public virtual ActionResult Create([Bind(Include = "Code,StartTime,EndTime,Description")] SeanceNumber SeanceNumber)
        {
			this.ModelState.AddModelError(SeanceNumberBLO.Validate(SeanceNumber));
		...
		public virtual ActionResult Edit([Bind(Include = "Code,StartTime,EndTime,Description,Id")] SeanceNumber SeanceNumber)	
        {
            ...
            if (ModelState.IsValid)
            {
				...
				old_SeanceNumber.UpdateEntity(SeanceNumber, this.GetBindAttribute(nameof(this.Edit)));
