...
namespace TrainingIS.WebApp.Controllers
{
    ...
    public class BaseYearStudiesController : BaseController
    {
        ...
        {
			msgHelper.Index(msg);
            Default_IndexYearStudyView Default_IndexYearStudyView = new Default_IndexYearStudyView();
            foreach (var item in YearStudyBLO.FindAll()) { Default_IndexYearStudyView.Data.Add(item); }
            return View(Default_IndexYearStudyView);
		}
		...
		public virtual ActionResult Create([Bind(Include = "Code,Name,Description,Id")] YearStudy YearStudy)
        {
			this.ModelState.AddModelError(YearStudyBLO.Validate(YearStudy));
		...
		public virtual ActionResult Edit(long? id)
        {
			...
			return View(YearStudy);
		        ...
		        [HttpPost]
        [ValidateAntiForgeryToken]
		public virtual ActionResult Edit([Bind(Include = "Code,Name,Description,Id")] YearStudy YearStudy)	
        {
			this.ModelState.AddModelError(YearStudyBLO.Validate(YearStudy));
			bool dataBaseException = false;
            if (ModelState.IsValid)
            {
				...
				old_YearStudy.UpdateEntity(YearStudy, this.GetBindAttribute(nameof(this.Edit)));
