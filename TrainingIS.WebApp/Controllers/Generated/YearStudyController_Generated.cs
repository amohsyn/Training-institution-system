...
{  
    ...
    public class BaseYearStudiesController : BaseController
    {
		...
		private void Fill_ViewBag_Create(Default_YearStudyFormView Default_YearStudyFormView)
        {
			this.Fill_ViewBag();		
        }
		...
		public virtual ActionResult Create()
        {
			...
			this.Fill_ViewBag_Create(default_yearstudyformview);
		...
		private void Fill_Edit_ViewBag(Default_YearStudyFormView Default_YearStudyFormView)
        {
		...
		public virtual ActionResult Edit(long? id)
        {
			...
			this.Fill_Edit_ViewBag(Default_YearStudyFormView);
			return View(Default_YearStudyFormView);
        }
