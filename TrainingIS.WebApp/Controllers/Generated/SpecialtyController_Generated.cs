...
namespace TrainingIS.WebApp.Controllers
{
    ...
    public class BaseSpecialtiesController : BaseController
    {
        ...
        {
			msgHelper.Index(msg);
            Default_IndexSpecialtyView Default_IndexSpecialtyView = new Default_IndexSpecialtyView();
            foreach (var item in SpecialtyBLO.FindAll()) { Default_IndexSpecialtyView.Data.Add(item); }
            return View(Default_IndexSpecialtyView);
		}
        ...
        {
			this.ModelState.AddModelError(SpecialtyBLO.Validate(Specialty));
		...
		public virtual ActionResult Edit([Bind(Include = "Code,Name,Description,Id")] Specialty Specialty)	
        {
            ...
            if (ModelState.IsValid)
            {
				...
				old_Specialty.UpdateEntity(Specialty, this.GetBindAttribute(nameof(this.Edit)));
