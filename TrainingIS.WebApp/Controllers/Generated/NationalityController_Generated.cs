...
namespace TrainingIS.WebApp.Controllers
{
    ...
    public class BaseNationalitiesController : BaseController
    {
        ...
        {
			msgHelper.Index(msg);
            Default_IndexNationalityView Default_IndexNationalityView = new Default_IndexNationalityView();
            foreach (var item in NationalityBLO.FindAll()) { Default_IndexNationalityView.Data.Add(item); }
            return View(Default_IndexNationalityView);
		}
		...
		public virtual ActionResult Create([Bind(Include = "Code,Name,Description,Id")] Nationality Nationality)
        {
			this.ModelState.AddModelError(NationalityBLO.Validate(Nationality));
		...
		public virtual ActionResult Edit(long? id)
        {
			...
			return View(Nationality);
		        ...
		        [HttpPost]
        [ValidateAntiForgeryToken]
		public virtual ActionResult Edit([Bind(Include = "Code,Name,Description,Id")] Nationality Nationality)	
        {
			this.ModelState.AddModelError(NationalityBLO.Validate(Nationality));
			bool dataBaseException = false;
            if (ModelState.IsValid)
            {
				...
				old_Nationality.UpdateEntity(Nationality, this.GetBindAttribute(nameof(this.Edit)));
