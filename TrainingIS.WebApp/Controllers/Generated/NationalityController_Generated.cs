...
{  
    ...
    public class BaseNationalitiesController : BaseController
    {
        ...
        {
		    msgHelper.Index(msg);
            List<Default_NationalityDetailsView> listDefault_NationalityDetailsView = new List<Default_NationalityDetailsView>();
			foreach (var item in NationalityBLO.FindAll()){
                Default_NationalityDetailsView Default_NationalityDetailsView = new Default_NationalityDetailsViewBLM(this._UnitOfWork)
                    .ConverTo_Default_NationalityDetailsView(item);
                listDefault_NationalityDetailsView.Add(Default_NationalityDetailsView);
            }
		...
		public virtual ActionResult Create([Bind(Include = "Code,Name,Description")] Default_NationalityFormView Default_NationalityFormView)
        {
            ...
            if (ModelState.IsValid)
            {
				...
				try
                {
					...
					Alert(string.Format(msgManager.The_Entity_was_well_created, msgHelper.DefinitArticle(), msg_Nationality.SingularName, Nationality), NotificationType.success);
		...
		[HttpPost]
        [ValidateAntiForgeryToken]
		public virtual ActionResult Edit([Bind(Include = "Code,Name,Description,Id")] Default_NationalityFormView Default_NationalityFormView)	
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    NationalityBLO.Save(Nationality);
					Alert(string.Format(msgManager.The_entity_has_been_changed,msgHelper.DefinitArticle(), msg_Nationality.SingularName, Nationality), NotificationType.success);
					return RedirectToAction("Index");
                }
                catch (GAppDbException ex)
                {
        ...
        public virtual ActionResult DeleteConfirmed(long id)
        {
			...
			Alert(string.Format(msgManager.The_entity_has_been_removed,msgHelper.DefinitArticle(), msg_Nationality.SingularName, Nationality), NotificationType.success);
            return RedirectToAction("Index");
        }
