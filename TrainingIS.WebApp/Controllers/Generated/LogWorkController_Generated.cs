...
{  
    ...
    public class BaseLogWorksController : BaseController
    {
		...
		public BaseLogWorksController()
        {
			...
			this.LogWorkBLO = new LogWorkBLO(this._UnitOfWork);
        }

	    public virtual ActionResult Index()
        {
		    msgHelper.Index(msg);
            List<Default_LogWorkDetailsView> listDefault_LogWorkDetailsView = new List<Default_LogWorkDetailsView>();
			foreach (var item in LogWorkBLO.FindAll()){
                Default_LogWorkDetailsView Default_LogWorkDetailsView = new Default_LogWorkDetailsViewBLM(this._UnitOfWork)
                    .ConverTo_Default_LogWorkDetailsView(item);
                listDefault_LogWorkDetailsView.Add(Default_LogWorkDetailsView);
            }
		...
		public virtual ActionResult Create([Bind(Include = "UserId,OperationWorkType,OperationReference,EntityType,Description")] Default_LogWorkFormView Default_LogWorkFormView)
        {
            ...
            if (ModelState.IsValid)
            {
				...
				try
                {
					...
					Alert(string.Format(msgManager.The_Entity_was_well_created, msgHelper.DefinitArticle(), msg_LogWork.SingularName, LogWork), NotificationType.success);
		...
		[HttpPost]
        [ValidateAntiForgeryToken]
		public virtual ActionResult Edit([Bind(Include = "UserId,OperationWorkType,OperationReference,EntityType,Description,Id")] Default_LogWorkFormView Default_LogWorkFormView)	
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    LogWorkBLO.Save(LogWork);
					Alert(string.Format(msgManager.The_entity_has_been_changed,msgHelper.DefinitArticle(), msg_LogWork.SingularName, LogWork), NotificationType.success);
					return RedirectToAction("Index");
                }
                catch (GAppDbException ex)
                {
        ...
        public virtual ActionResult DeleteConfirmed(long id)
        {
			...
			Alert(string.Format(msgManager.The_entity_has_been_removed,msgHelper.DefinitArticle(), msg_LogWork.SingularName, LogWork), NotificationType.success);
            return RedirectToAction("Index");
        }
