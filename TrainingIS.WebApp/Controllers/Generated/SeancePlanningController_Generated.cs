...
namespace TrainingIS.WebApp.Controllers
{
    ...
    public class BaseSeancePlanningsController : BaseController
    {
        ...
        {
			msgHelper.Index(msg);
            Default_IndexSeancePlanningView Default_IndexSeancePlanningView = new Default_IndexSeancePlanningView();
            foreach (var item in SeancePlanningBLO.FindAll()) { Default_IndexSeancePlanningView.Data.Add(item); }
            return View(Default_IndexSeancePlanningView);
		}
		...
		public virtual ActionResult Create([Bind(Include = "TrainingId,SeanceDayId,SeanceNumberId,Description")] SeancePlanning SeancePlanning)
        {
			this.ModelState.AddModelError(SeancePlanningBLO.Validate(SeancePlanning));
		...
		public virtual ActionResult Edit(long? id)
        {
			...
			return View(SeancePlanning);
		        ...
		        [HttpPost]
        [ValidateAntiForgeryToken]
		public virtual ActionResult Edit([Bind(Include = "TrainingId,SeanceDayId,SeanceNumberId,Description,Id")] SeancePlanning SeancePlanning)	
        {
			this.ModelState.AddModelError(SeancePlanningBLO.Validate(SeancePlanning));
			bool dataBaseException = false;
            if (ModelState.IsValid)
            {
				...
				old_SeancePlanning.UpdateEntity(SeancePlanning, this.GetBindAttribute(nameof(this.Edit)));
