...
namespace TrainingIS.WebApp.Controllers
{
    ...
    public class BaseModuleTrainingsController : BaseController
    {
        ...
        {
			msgHelper.Index(msg);
            Default_IndexModuleTrainingView Default_IndexModuleTrainingView = new Default_IndexModuleTrainingView();
            foreach (var item in ModuleTrainingBLO.FindAll()) { Default_IndexModuleTrainingView.Data.Add(item); }
            return View(Default_IndexModuleTrainingView);
		}
		...
		public virtual ActionResult Edit([Bind(Include = "Specialty,SpecialtyId,Name,Code,Description,Id")] ModuleTraining ModuleTraining)	
        {
            ...
            if (ModelState.IsValid)
            {
				...
				old_ModuleTraining.UpdateEntity(ModuleTraining, this.GetBindAttribute(nameof(this.Edit)));
