...
namespace TrainingIS.WebApp.Controllers
{
    ...
    public class BaseSeanceTrainingsController : BaseController
    {
        ...
        {
			msgHelper.Index(msg);
            Default_IndexSeanceTrainingView Default_IndexSeanceTrainingView = new Default_IndexSeanceTrainingView();
            foreach (var item in SeanceTrainingBLO.FindAll()) { Default_IndexSeanceTrainingView.Data.Add(item); }
            return View(Default_IndexSeanceTrainingView);
		}
		...
		public virtual ActionResult Create([Bind(Include = "SeanceDate,SeancePlanningId")] SeanceTraining SeanceTraining)
        {
			this.ModelState.AddModelError(SeanceTrainingBLO.Validate(SeanceTraining));
		...
		public virtual ActionResult Edit(long? id)
        {
			...
			return View(SeanceTraining);
		        ...
		        [HttpPost]
        [ValidateAntiForgeryToken]
		public virtual ActionResult Edit([Bind(Include = "SeanceDate,SeancePlanningId,Id")] SeanceTraining SeanceTraining)	
        {
			this.ModelState.AddModelError(SeanceTrainingBLO.Validate(SeanceTraining));
			bool dataBaseException = false;
            if (ModelState.IsValid)
            {
				...
				old_SeanceTraining.UpdateEntity(SeanceTraining, this.GetBindAttribute(nameof(this.Edit)));
