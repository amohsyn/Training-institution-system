...
namespace TrainingIS.WebApp.Controllers
{
    ...
    public class BaseTrainingsController : BaseController
    {
        ...
        {
			msgHelper.Index(msg);
            Default_IndexTrainingView Default_IndexTrainingView = new Default_IndexTrainingView();
            foreach (var item in TrainingBLO.FindAll()) { Default_IndexTrainingView.Data.Add(item); }
            return View(Default_IndexTrainingView);
		}
		...
		public virtual ActionResult Create([Bind(Include = "TrainingYearId,ModuleTrainingId,FormerId,GroupId,Code,Description")] Training Training)
        {
			this.ModelState.AddModelError(TrainingBLO.Validate(Training));
		...
		public virtual ActionResult Edit(long? id)
        {
			...
			return View(Training);
		        ...
		        [HttpPost]
        [ValidateAntiForgeryToken]
		public virtual ActionResult Edit([Bind(Include = "TrainingYearId,ModuleTrainingId,FormerId,GroupId,Code,Description,Id")] Training Training)	
        {
			this.ModelState.AddModelError(TrainingBLO.Validate(Training));
			bool dataBaseException = false;
            if (ModelState.IsValid)
            {
				...
				old_Training.UpdateEntity(Training, this.GetBindAttribute(nameof(this.Edit)));
