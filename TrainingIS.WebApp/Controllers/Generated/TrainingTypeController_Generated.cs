...
namespace TrainingIS.WebApp.Controllers
{
    ...
    public class BaseTrainingTypesController : BaseController
    {
        ...
        {
			msgHelper.Index(msg);
            Default_IndexTrainingTypeView Default_IndexTrainingTypeView = new Default_IndexTrainingTypeView();
            foreach (var item in TrainingTypeBLO.FindAll()) { Default_IndexTrainingTypeView.Data.Add(item); }
            return View(Default_IndexTrainingTypeView);
		}
		...
		public virtual ActionResult Create([Bind(Include = "Code,Name,Description")] TrainingType TrainingType)
        {
			this.ModelState.AddModelError(TrainingTypeBLO.Validate(TrainingType));
		...
		public virtual ActionResult Details(long? id)
        {
            ...
            {
			    string msg = string.Format(msgManager.You_try_to_show_that_does_not_exist, msgHelper.UndefindedArticle(), msg_TrainingType.SingularName);
		...
		public virtual ActionResult Edit(long? id)
        {
            ...
            if (TrainingType == null)
            {
			    string msg = string.Format(msgManager.You_try_to_edit_that_does_not_exist, msgHelper.UndefindedArticle(), msg_TrainingType.SingularName );
                Alert(msg, NotificationType.error);
                return RedirectToAction("Index");
            }			 
			return View(TrainingType);
		...
		public virtual ActionResult Edit([Bind(Include = "Code,Name,Description,Id")] TrainingType TrainingType)	
        {
            ...
            if (ModelState.IsValid)
            {
				...
				old_TrainingType.UpdateEntity(TrainingType, this.GetBindAttribute(nameof(this.Edit)));
        ...
        public virtual ActionResult Delete(long? id)
        {
            ...
            if (TrainingType == null)
            {
			    string msg = string.Format(msgManager.You_try_to_delete_that_does_not_exist, msgHelper.UndefindedArticle(), msg_TrainingType.SingularName);
                Alert(msg, NotificationType.error);
                return RedirectToAction("Index");
            }
