...
namespace TrainingIS.WebApp.Controllers
{
    ...
    public class BaseClassroomsController : BaseController
    {
        ...
        {
			msgHelper.Index(msg);
            Default_IndexClassroomView Default_IndexClassroomView = new Default_IndexClassroomView();
            foreach (var item in ClassroomBLO.FindAll()) { Default_IndexClassroomView.Data.Add(item); }
            return View(Default_IndexClassroomView);
		}
		...
		public virtual ActionResult Create([Bind(Include = "Code,Name,ClassroomCategoryId,Description")] Classroom Classroom)
        {
			this.ModelState.AddModelError(ClassroomBLO.Validate(Classroom));
		...
		public virtual ActionResult Details(long? id)
        {
            ...
            if (Classroom == null)
            {
			    string msg = string.Format(msgManager.You_try_to_show_that_does_not_exist, msgHelper.UndefindedArticle(), msg_Classroom.SingularName);
		...
		public virtual ActionResult Edit(long? id)
        {
            ...
            if (Classroom == null)
            {
			    string msg = string.Format(msgManager.You_try_to_edit_that_does_not_exist, msgHelper.UndefindedArticle(), msg_Classroom.SingularName );
                Alert(msg, NotificationType.error);
                return RedirectToAction("Index");
            }			 
            ViewBag.ClassroomCategoryId = new SelectList(new ClassroomCategoryBLO(this._UnitOfWork).FindAll(), "Id", "Code", Classroom.ClassroomCategoryId);
			return View(Classroom);
		        ...
		        [HttpPost]
        [ValidateAntiForgeryToken]
		public virtual ActionResult Edit([Bind(Include = "Code,Name,ClassroomCategoryId,Description,Id")] Classroom Classroom)	
        {
			this.ModelState.AddModelError(ClassroomBLO.Validate(Classroom));
			bool dataBaseException = false;
            if (ModelState.IsValid)
            {
				...
				old_Classroom.UpdateEntity(Classroom, this.GetBindAttribute(nameof(this.Edit)));
