...
namespace TrainingIS.WebApp.Controllers
{
    ...
    public class BaseAbsencesController : BaseController
    {
        ...
        {
			msgHelper.Index(msg);
            Default_IndexAbsenceView Default_IndexAbsenceView = new Default_IndexAbsenceView();
            foreach (var item in AbsenceBLO.FindAll()) { Default_IndexAbsenceView.Data.Add(item); }
            return View(Default_IndexAbsenceView);
		}
