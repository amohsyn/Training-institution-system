...
namespace TrainingIS.WebApp.Controllers
{
    ...
    public class BaseAppControllerActionsController : BaseController
    {
        ...
        {
			msgHelper.Index(msg);
            Default_IndexAppControllerActionView Default_IndexAppControllerActionView = new Default_IndexAppControllerActionView();
            foreach (var item in AppControllerActionBLO.FindAll()) { Default_IndexAppControllerActionView.Data.Add(item); }
            return View(Default_IndexAppControllerActionView);
		}
		...
		public virtual ActionResult Create([Bind(Include = "Code,Description,AppController,AppControllerId,AppRoles,Id")] AppControllerAction AppControllerAction)
        {
		...
		public virtual ActionResult Edit(long? id)
        {
			...
			return View(AppControllerAction);
		        ...
		        [HttpPost]
        [ValidateAntiForgeryToken]
		public virtual ActionResult Edit([Bind(Include = "Code,Description,AppController,AppControllerId,AppRoles,Id")] AppControllerAction AppControllerAction)	
        {
			this.ModelState.AddModelError(AppControllerActionBLO.Validate(AppControllerAction));
			bool dataBaseException = false;
            if (ModelState.IsValid)
