...
namespace TrainingIS.WebApp.Controllers
{
    ...
    public class BaseAppRolesController : BaseController
    {
        ...
        {
			msgHelper.Index(msg);
            Default_IndexAppRoleView Default_IndexAppRoleView = new Default_IndexAppRoleView();
            foreach (var item in AppRoleBLO.FindAll()) { Default_IndexAppRoleView.Data.Add(item); }
            return View(Default_IndexAppRoleView);
		}
