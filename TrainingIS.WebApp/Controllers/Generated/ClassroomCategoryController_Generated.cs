...
namespace TrainingIS.WebApp.Controllers
{
    ...
    public class BaseClassroomCategoriesController : BaseController
    {
        ...
        {
			msgHelper.Index(msg);
            Default_IndexClassroomCategoryView Default_IndexClassroomCategoryView = new Default_IndexClassroomCategoryView();
            foreach (var item in ClassroomCategoryBLO.FindAll()) { Default_IndexClassroomCategoryView.Data.Add(item); }
            return View(Default_IndexClassroomCategoryView);
		}
