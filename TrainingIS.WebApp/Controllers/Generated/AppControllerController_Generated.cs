...
namespace TrainingIS.WebApp.Controllers
{
    ...
    public class BaseAppControllersController : BaseController
    {
        ...
        {
			msgHelper.Index(msg);
            Default_IndexAppControllerView Default_IndexAppControllerView = new Default_IndexAppControllerView();
            foreach (var item in AppControllerBLO.FindAll()) { Default_IndexAppControllerView.Data.Add(item); }
            return View(Default_IndexAppControllerView);
		}
		...
		public virtual ActionResult Create([Bind(Include = "Code,Description,AppRoles,Id")] AppController AppController)
        {
			this.ModelState.AddModelError(AppControllerBLO.Validate(AppController));
		...
		public virtual ActionResult Details(long? id)
        {
            ...
            {
			    string msg = string.Format(msgManager.You_try_to_show_that_does_not_exist, msgHelper.UndefindedArticle(), msg_AppController.SingularName);
		...
		public virtual ActionResult Edit(long? id)
        {
            ...
            if (AppController == null)
            {
			    string msg = string.Format(msgManager.You_try_to_edit_that_does_not_exist, msgHelper.UndefindedArticle(), msg_AppController.SingularName );
                Alert(msg, NotificationType.error);
                return RedirectToAction("Index");
            }			 
			return View(AppController);
		        ...
		        [HttpPost]
        [ValidateAntiForgeryToken]
		public virtual ActionResult Edit([Bind(Include = "Code,Description,AppRoles,Id")] AppController AppController)	
        {
			this.ModelState.AddModelError(AppControllerBLO.Validate(AppController));
			bool dataBaseException = false;
            if (ModelState.IsValid)
            {
				...
				old_AppController.UpdateEntity(AppController, this.GetBindAttribute(nameof(this.Edit)));
