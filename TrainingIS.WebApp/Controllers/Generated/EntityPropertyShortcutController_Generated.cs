...
namespace TrainingIS.WebApp.Controllers
{
    ...
    public class BaseEntityPropertyShortcutsController : BaseController
    {
        ...
        {
			msgHelper.Index(msg);
            Default_IndexEntityPropertyShortcutView Default_IndexEntityPropertyShortcutView = new Default_IndexEntityPropertyShortcutView();
            foreach (var item in EntityPropertyShortcutBLO.FindAll()) { Default_IndexEntityPropertyShortcutView.Data.Add(item); }
            return View(Default_IndexEntityPropertyShortcutView);
		}
