...
{  
    ...
    public class BaseFormersController : BaseController
    {
        ...
        {
		    msgHelper.Index(msg);
            List<Default_FormerDetailsView> listDefault_FormerDetailsView = new List<Default_FormerDetailsView>();
			foreach (var item in FormerBLO.FindAll()){
                Default_FormerDetailsView Default_FormerDetailsView = new Default_FormerDetailsViewBLM(this._UnitOfWork)
                    .ConverTo_Default_FormerDetailsView(item);
                listDefault_FormerDetailsView.Add(Default_FormerDetailsView);
            }
			return View(listDefault_FormerDetailsView);
		}
		...
		[HttpPost]
        [ValidateAntiForgeryToken]
		public virtual ActionResult Edit([Bind(Include = "FirstName,LastName,Sex,CIN,Cellphone,Email,Address,FaceBook,WebSite,RegistrationNumber,Id")] Default_FormerFormView Default_FormerFormView)	
        {
