...
namespace TrainingIS.WebApp.Controllers
{
    ...
    public class BaseFormersController : BaseController
    {
		...
		public virtual ActionResult Create([Bind(Include = "FirstName,LastName,Sex,CIN,Cellphone,Email,Address,FaceBook,WebSite,RegistrationNumber")] Former Former)
        {
			this.ModelState.AddModelError(FormerBLO.Validate(Former));
		...
		public virtual ActionResult Edit([Bind(Include = "FirstName,LastName,Sex,CIN,Cellphone,Email,Address,FaceBook,WebSite,RegistrationNumber,Id")] Former Former)	
        {
            ...
            if (ModelState.IsValid)
            {
				...
				old_Former.UpdateEntity(Former, this.GetBindAttribute(nameof(this.Edit)));
