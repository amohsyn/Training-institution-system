...
namespace TrainingIS.WebApp.Controllers
{
    ...
    {
        protected TraineeBLO traineeBLO = new TraineeBLO();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public virtual ActionResult Edit([Bind(Include = "Id,FirstName,LastName,Sex,CIN,Cellphone,Email,Address,FaceBook,WebSite,CNE,GroupId,EtudiantActif,Principale,EtudiantPayant,LibelleLong,CodeDiplome,DateInscription,DateDossierComplet,LieuNaissance,MotifAdmission,NTel_du_Tuteur,Nationalite,Nom_Arabe,Prenom_arabe,NiveauScolaire,AnneeEtude,CreateDate,UpdateDate")] Trainee trainee)
        {
            if (ModelState.IsValid)
            {
