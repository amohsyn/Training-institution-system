...
namespace TrainingIS.WebApp.Controllers
{
    ...
    public class BaseYearStudiesController : BaseController
    {
        ...
        {
            this.msgHelper = new MsgHelper(typeof(YearStudy));
        ...
        public virtual ActionResult Create([Bind(Include = "Id,Code,Name,Description,CreateDate,UpdateDate")] YearStudy yearStudy)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public virtual ActionResult Edit([Bind(Include = "Id,Code,Name,Description,CreateDate,UpdateDate")] YearStudy yearStudy)
        {
            if (ModelState.IsValid)
            {
		...
		public virtual ActionResult Import()
        {
			...
			try
            {
                string msg =   yearStudyBLO.Import(firstTable);
