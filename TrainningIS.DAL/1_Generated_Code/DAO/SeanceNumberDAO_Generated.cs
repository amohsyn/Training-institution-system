...
{  
    public partial class SeanceNumberDAO : BaseDAO<SeanceNumber>{
		...
		public SeanceNumberDAO(DbContext context) : base(context)
		{
			...
			public override int Insert(SeanceNumber item)
			{

				Check_if_reference_is_not_null(item);
				return base.Insert(item);
			}
			public override int Update(SeanceNumber item)
			{
				Check_if_reference_is_not_null(item);
				return base.Update(item);
			}

			protected void Check_if_reference_is_not_null(SeanceNumber item)
			{
