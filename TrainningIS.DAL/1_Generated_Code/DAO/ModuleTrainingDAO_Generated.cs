...
{  
    public partial class ModuleTrainingDAO : BaseDAO<ModuleTraining>{
		...
		public ModuleTrainingDAO(DbContext context) : base(context)
		{
			...
			public override int Insert(ModuleTraining item)
			{

				Check_if_reference_is_not_null(item);
				return base.Insert(item);
			}
			public override int Update(ModuleTraining item)
			{
				Check_if_reference_is_not_null(item);
				return base.Update(item);
			}

			protected void Check_if_reference_is_not_null(ModuleTraining item)
			{
