...
{  
    public partial class StateOfAbseceDAO : BaseDAO<StateOfAbsece>{
		...
		public StateOfAbseceDAO(DbContext context) : base(context)
		{
			...
			public override int Insert(StateOfAbsece item)
			{

				Check_if_reference_is_not_null(item);
				return base.Insert(item);
			}
			public override int Update(StateOfAbsece item)
			{
				Check_if_reference_is_not_null(item);
				return base.Update(item);
			}

			protected void Check_if_reference_is_not_null(StateOfAbsece item)
			{
