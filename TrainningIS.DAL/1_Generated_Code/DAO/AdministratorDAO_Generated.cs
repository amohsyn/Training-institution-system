...
{  
    public partial class AdministratorDAO : BaseDAO<Administrator>{
		...
		public AdministratorDAO(DbContext context) : base(context)
		{
			...
			public override int Insert(Administrator item)
			{

				Check_if_reference_is_not_null(item);
				return base.Insert(item);
			}
			public override int Update(Administrator item)
			{
				Check_if_reference_is_not_null(item);
				return base.Update(item);
			}

			protected void Check_if_reference_is_not_null(Administrator item)
			{
