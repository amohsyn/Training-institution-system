...
{  
    public partial class TrainingYearDAO : BaseDAO<TrainingYear>{
		...
		public TrainingYearDAO(DbContext context) : base(context)
		{
			...
			public override int Insert(TrainingYear item)
			{

				Check_if_reference_is_not_null(item);
				return base.Insert(item);
			}
			public override int Update(TrainingYear item)
			{
				Check_if_reference_is_not_null(item);
				return base.Update(item);
			}

			protected void Check_if_reference_is_not_null(TrainingYear item)
			{
