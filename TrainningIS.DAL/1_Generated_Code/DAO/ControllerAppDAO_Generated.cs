...
{  
    public partial class ControllerAppDAO : BaseDAO<ControllerApp>{
		...
		public ControllerAppDAO(DbContext context) : base(context)
		{
			...
			public override int Insert(ControllerApp item)
			{

				Check_if_reference_is_not_null(item);
				return base.Insert(item);
			}
			public override int Update(ControllerApp item)
			{
				Check_if_reference_is_not_null(item);
				return base.Update(item);
			}

			protected void Check_if_reference_is_not_null(ControllerApp item)
			{
