...
{  
    public partial class AttendanceStateDAO : BaseDAO<AttendanceState>{
		...
		public AttendanceStateDAO(DbContext context) : base(context)
		{
			...
			public override int Insert(AttendanceState item)
			{

				Check_if_reference_is_not_null(item);
				return base.Insert(item);
			}
			public override int Update(AttendanceState item)
			{
				Check_if_reference_is_not_null(item);
				return base.Update(item);
			}

			protected void Check_if_reference_is_not_null(AttendanceState item)
			{
