...
{  
    public partial class AuthrorizationAppDAO : BaseDAO<AuthrorizationApp>{
		...
		public AuthrorizationAppDAO(DbContext context) : base(context)
		{
			...
			public override int Insert(AuthrorizationApp item)
			{

				Check_if_reference_is_not_null(item);
				return base.Insert(item);
			}
			public override int Update(AuthrorizationApp item)
			{
				Check_if_reference_is_not_null(item);
				return base.Update(item);
			}

			protected void Check_if_reference_is_not_null(AuthrorizationApp item)
			{
