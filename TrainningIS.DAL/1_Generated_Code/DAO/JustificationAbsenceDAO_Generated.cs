...
{  
    public partial class JustificationAbsenceDAO : BaseDAO<JustificationAbsence>{
		...
		public JustificationAbsenceDAO(DbContext context) : base(context)
		{
			...
			public override int Insert(JustificationAbsence item)
			{

				Check_if_reference_is_not_null(item);
				return base.Insert(item);
			}
			public override int Update(JustificationAbsence item)
			{
				Check_if_reference_is_not_null(item);
				return base.Update(item);
			}

			protected void Check_if_reference_is_not_null(JustificationAbsence item)
			{
