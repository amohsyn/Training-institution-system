...
{  
    public partial class EntityPropertyShortcutDAO : BaseDAO<EntityPropertyShortcut>{
		...
		public EntityPropertyShortcutDAO(DbContext context) : base(context)
		{
			...
			public override int Insert(EntityPropertyShortcut item)
			{

				Check_if_reference_is_not_null(item);
				return base.Insert(item);
			}
			public override int Update(EntityPropertyShortcut item)
			{
				Check_if_reference_is_not_null(item);
				return base.Update(item);
			}

			protected void Check_if_reference_is_not_null(EntityPropertyShortcut item)
			{
