...
namespace TrainingIS.WebApp.Controllers.Tests
{
    public class EntityPropertyShortcutsControllerTests_Service : ManagerControllerTests
    {
        ...
        public EntityPropertyShortcut CreateValideEntityPropertyShortcutInstance(UnitOfWork unitOfWork = null)
        {
        ...
        public EntityPropertyShortcut CreateInValideEntityPropertyShortcutInstance(UnitOfWork unitOfWork = null)
        {
		  ...
		  public EntityPropertyShortcut CreateInValideEntityPropertyShortcutInstance_ForEdit(UnitOfWork unitOfWork = null)
        {
