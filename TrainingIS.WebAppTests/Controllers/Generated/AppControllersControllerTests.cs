...
namespace TrainingIS.WebApp.Controllers.Tests
{
    ...
    public class AppControllersControllerTests : ManagerControllerTests
    {
        ...
        public void Create_Valide_AppController_Post_Test()
        {
			...
			AppControllerFormView AppControllerFormView = new AppControllerFormViewBLM(controller._UnitOfWork).ConverTo_AppControllerFormView(appcontroller);
            var result = controller.Create(AppControllerFormView);
  ...
  [TestMethod()]
        ...
        public void Edit_Valide_AppController_Post_Test()
        {
			...
			AppControllerFormView AppControllerFormView = new AppControllerFormViewBLM(controller._UnitOfWork).ConverTo_AppControllerFormView(appcontroller);
            var result = controller.Edit(AppControllerFormView);
