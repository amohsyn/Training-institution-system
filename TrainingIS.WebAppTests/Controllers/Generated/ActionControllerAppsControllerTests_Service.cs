...
namespace TrainingIS.WebApp.Controllers.Tests
{
    public class ActionControllerAppsControllerTests_Service : ManagerControllerTests
    {
        ...
        public ActionControllerApp CreateValideActionControllerAppInstance(UnitOfWork unitOfWork = null)
        {
        ...
        public ActionControllerApp CreateInValideActionControllerAppInstance(UnitOfWork unitOfWork = null)
        {
		  ...
		  public ActionControllerApp CreateInValideActionControllerAppInstance_ForEdit(UnitOfWork unitOfWork = null)
        {
