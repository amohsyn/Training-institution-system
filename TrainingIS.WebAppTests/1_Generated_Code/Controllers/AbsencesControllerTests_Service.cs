...
namespace TrainingIS.WebApp.Controllers.Tests
{
    public class AbsencesControllerTests_Service : ManagerControllerTests
    {
        ...
        public Absence CreateValideAbsenceInstance(UnitOfWork unitOfWork = null)
        {
        ...
        public Absence CreateInValideAbsenceInstance(UnitOfWork unitOfWork = null)
        {
		  ...
		  public Absence CreateInValideAbsenceInstance_ForEdit(UnitOfWork unitOfWork = null)
        {
