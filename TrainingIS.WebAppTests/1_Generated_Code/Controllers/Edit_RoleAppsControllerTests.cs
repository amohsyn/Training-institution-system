...
{
    [TestClass()]
    public class Edit_RoleAppsControllerTests : ManagerControllerTests
    {
        ...
        public void Edit_Valide_RoleApp_Post_Test()
        {
            ...
            RoleApp roleapp = TestService.CreateOrLouadFirstRoleApp(new UnitOfWork());
        ...
        public void Edit_InValide_RoleApp_Post_Test()
        {
            // Arrange
            RoleAppsController controller = new RoleAppsController();
            RoleApp roleapp = TestService.CreateInValideRoleAppInstance_ForEdit(new UnitOfWork());
