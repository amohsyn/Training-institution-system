...
namespace TrainingIS.WebApp.Controllers.Tests
{
    [TestClass()]
	[CleanTestDB]
    public class Create_SanctionCategoriesControllerTests : ManagerControllerTests
    {
        ...
        {
            //Arrange
            SanctionCategoriesController SanctionCategoriesController = new SanctionCategoriesController();

            ViewResult viewResult = SanctionCategoriesController.Create() as ViewResult;
        ...
        [TestMethod()]
        public void Create_Valide_SanctionCategory_Post_Test()
        {
            //--Arrange--
            SanctionCategoriesController controller = new SanctionCategoriesController();
            SanctionCategory sanctioncategory = TestService.CreateValideSanctionCategoryInstance(controller._UnitOfWork,controller.GAppContext);

            //--Acte--
            //
            SanctionCategoriesControllerTests_Service.PreBindModel(controller, sanctioncategory, nameof(SanctionCategoriesController.Create));
            ...
            var result = controller.Create(Default_Form_SanctionCategory_Model);
        ...
        [TestMethod()]
        public void Create_InValide_SanctionCategory_Post_Test()
        {
            // Arrange
            SanctionCategoriesController controller = new SanctionCategoriesController();
            SanctionCategory sanctioncategory = TestService.CreateInValideSanctionCategoryInstance(controller._UnitOfWork,controller.GAppContext);
