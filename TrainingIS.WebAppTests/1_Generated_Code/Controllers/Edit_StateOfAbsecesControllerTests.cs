...
{
    [TestClass()]
    public class Edit_StateOfAbsecesControllerTests : ManagerControllerTests
    {
        ...
        public void Edit_Valide_StateOfAbsece_Post_Test()
        {
            ...
            StateOfAbsece stateofabsece = TestService.CreateOrLouadFirstStateOfAbsece(new UnitOfWork());
        ...
        public void Edit_InValide_StateOfAbsece_Post_Test()
        {
            // Arrange
            StateOfAbsecesController controller = new StateOfAbsecesController();
            StateOfAbsece stateofabsece = TestService.CreateInValideStateOfAbseceInstance_ForEdit(new UnitOfWork());
