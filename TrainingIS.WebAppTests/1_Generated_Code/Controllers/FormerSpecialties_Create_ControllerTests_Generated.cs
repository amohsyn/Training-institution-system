...
namespace TrainingIS.WebApp.Controllers.Tests
{
    [TestClass()]
	[CleanTestDB]
    public class Create_FormerSpecialtiesControllerTests : ManagerControllerTests
    {
        ...
        {
            //Arrange
            FormerSpecialtiesController FormerSpecialtiesController = new FormerSpecialtiesController();

            ViewResult viewResult = FormerSpecialtiesController.Create() as ViewResult;
        ...
        [TestMethod()]
        public void Create_Valide_FormerSpecialty_Post_Test()
        {
            //--Arrange--
            FormerSpecialtiesController controller = new FormerSpecialtiesController();
            FormerSpecialty formerspecialty = TestService.CreateValideFormerSpecialtyInstance(controller._UnitOfWork,controller.GAppContext);

            //--Acte--
            //
            FormerSpecialtiesControllerTests_Service.PreBindModel(controller, formerspecialty, nameof(FormerSpecialtiesController.Create));
            ...
            var result = controller.Create(Default_Form_FormerSpecialty_Model);
        ...
        [TestMethod()]
        public void Create_InValide_FormerSpecialty_Post_Test()
        {
            // Arrange
            FormerSpecialtiesController controller = new FormerSpecialtiesController();
            FormerSpecialty formerspecialty = TestService.CreateInValideFormerSpecialtyInstance(controller._UnitOfWork,controller.GAppContext);
