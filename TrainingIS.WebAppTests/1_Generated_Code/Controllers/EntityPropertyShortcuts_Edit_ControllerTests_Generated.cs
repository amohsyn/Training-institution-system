...
namespace TrainingIS.WebApp.Controllers.Tests
{
    ...
    public class EntityPropertyShortcuts_Edit_ControllerTests : ManagerControllerTests
    {
        ...
        public void Edit_Valide_EntityPropertyShortcut_Post_Test()
        {
            ...
            EntityPropertyShortcut entitypropertyshortcut = TestService.CreateOrLouadFirstEntityPropertyShortcut(new UnitOfWork<TrainingISModel>());
        ...
        public void Edit_InValide_EntityPropertyShortcut_Post_Test()
        {
            // Arrange
            EntityPropertyShortcutsController controller = new EntityPropertyShortcutsController();
            EntityPropertyShortcut entitypropertyshortcut = TestService.CreateInValideEntityPropertyShortcutInstance_ForEdit(new UnitOfWork<TrainingISModel>());
