...
namespace TrainingIS.Entities.ModelsViews.Generated
{
    public class DefaultModelView_MetaData
    {
        ...
        public  DefaultModelView_MetaData()
        {
			...
			ModelsViewsTypes[typeof(RoleApp)] = new List<Type>();
			ModelsViewsTypes[typeof(RoleApp)].Add(typeof(Default_RoleAppDetailsView));
			ModelsViewsTypes[typeof(RoleApp)].Add(typeof(Default_RoleAppFormView));
  
			ModelsViewsTypes[typeof(ControllerApp)] = new List<Type>();
			ModelsViewsTypes[typeof(ControllerApp)].Add(typeof(Default_ControllerAppDetailsView));
			ModelsViewsTypes[typeof(ControllerApp)].Add(typeof(Default_ControllerAppFormView));
  
			ModelsViewsTypes[typeof(ActionControllerApp)] = new List<Type>();
