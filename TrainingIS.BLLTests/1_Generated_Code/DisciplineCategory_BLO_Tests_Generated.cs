...
{
    public class Base_DisciplineCategory_BLO_Tests : Base_BLO_Tests
    {
        public DisciplineCategoryTestDataFactory DisciplineCategory_TestData { set; get; }
        public Base_DisciplineCategory_BLO_Tests()
        {
    ...
    [TestClass]
    public partial class DisciplineCategory_BLO_Tests : Base_DisciplineCategory_BLO_Tests
    {
