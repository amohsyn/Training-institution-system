...
{
    public class Base_Nationality_BLO_Tests : Base_BLO_Tests
    {
        public NationalityTestDataFactory Nationality_TestData { set; get; }
        public Base_Nationality_BLO_Tests()
        {
    ...
    [TestClass]
    public partial class Nationality_BLO_Tests : Base_Nationality_BLO_Tests
    {
