...
namespace TrainingIS.Entities.ModelsViews
{
    ...
    public class Default_Details_WorkGroup_Model : BaseModel
    {
		...
		[Display(Name = "President", GroupName = "SingularName", Order = 0, ResourceType = typeof(msg_WorkGroup))]
		...
		[Display(Name = "VicePresident", GroupName = "SingularName", Order = 0, ResourceType = typeof(msg_WorkGroup))]
		...
		[Display(Name = "Protractor", GroupName = "SingularName", Order = 0, ResourceType = typeof(msg_WorkGroup))]
