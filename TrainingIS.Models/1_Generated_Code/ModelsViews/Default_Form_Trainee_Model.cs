...
namespace TrainingIS.Entities.ModelsViews
{
    ...
    public class Default_Form_Trainee_Model : BaseModel
    {
		...
		[Display(Name = "SingularName", GroupName = "SingularName", Order = 19, ResourceType = typeof(msg_Schoollevel))]
		...
		[Required]
		[Display(Name = "SingularName", GroupName = "SingularName", Order = 20, ResourceType = typeof(msg_Group))]
		...
		[Display(Name = "SingularName", GroupName = "SingularName", Order = 8, ResourceType = typeof(msg_Nationality))]
