...
namespace TrainingIS.Entities.ModelsViews
{
    ...
    public class Default_SeanceNumber_Index_Model : BaseModel
    {
		...
		[GAppDataTable(PropertyPath = "StartTime", FilterBy = "StartTime", SearchBy = "StartTime", OrderBy = "StartTime",  AutoGenerateFilter = false,isColumn = true , isOrderBy = true, isSeachBy =true)]
		...
		[DisplayFormat(ApplyFormatInEditMode = true, DataFormatString = "{0:HH:mm}")]
		[GAppDataTable(PropertyPath = "EndTime", FilterBy = "EndTime", SearchBy = "EndTime", OrderBy = "EndTime",  AutoGenerateFilter = false,isColumn = true , isOrderBy = true, isSeachBy =true)]
		[DataType(DataType.Time)]
