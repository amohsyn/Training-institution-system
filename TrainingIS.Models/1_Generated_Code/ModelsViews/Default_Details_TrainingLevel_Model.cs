...
{
	[DetailsView(typeof(TrainingLevel))]
	[IndexView(typeof(TrainingLevel))]
	[ExportView(typeof(TrainingLevel))]
    public class Default_Details_TrainingLevel_Model : BaseModel
    {
		[Required]
