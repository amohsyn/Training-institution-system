...
namespace TrainingIS.Entities.ModelsViews
{
	...
	[SearchBy("Reference")]
    public class Default_SeanceDay_Index_Model : BaseModel
    {
		[Required]
		...
		[GAppDataTable(PropertyPath = "Day", FilterBy = "Day", SearchBy = "Day", OrderBy = "Day",  AutoGenerateFilter = false,isColumn = true , isOrderBy = true, isSeachBy =true)]
