...
namespace TrainingIS.Entities.ModelsViews
{
    ...
    public class Default_SanctionCategory_Index_Model : BaseModel
    {
		...
		[GAppDataTable(PropertyPath = "DisciplineCategory", FilterBy = "DisciplineCategory.Id", SearchBy = "DisciplineCategory.Reference", OrderBy = "DisciplineCategory.Reference",  AutoGenerateFilter = true,isColumn = true , isOrderBy = true, isSeachBy =true)]
		...
		[GAppDataTable(PropertyPath = "DecisionAuthority", FilterBy = "DecisionAuthority", SearchBy = "DecisionAuthority", OrderBy = "DecisionAuthority",  AutoGenerateFilter = false,isColumn = true , isOrderBy = true, isSeachBy =true)]
		...
		[GAppDataTable(PropertyPath = "WorkflowOrder", FilterBy = "WorkflowOrder", SearchBy = "WorkflowOrder", OrderBy = "WorkflowOrder",  AutoGenerateFilter = false,isColumn = true , isOrderBy = true, isSeachBy =true)]
		...
		[GAppDataTable(PropertyPath = "Number_Of_Days_Of_Exclusion", FilterBy = "Number_Of_Days_Of_Exclusion", SearchBy = "Number_Of_Days_Of_Exclusion", OrderBy = "Number_Of_Days_Of_Exclusion",  AutoGenerateFilter = false,isColumn = true , isOrderBy = true, isSeachBy =true)]
		...
		[GAppDataTable(PropertyPath = "Plurality_Of_Absences", FilterBy = "Plurality_Of_Absences", SearchBy = "Plurality_Of_Absences", OrderBy = "Plurality_Of_Absences",  AutoGenerateFilter = false,isColumn = true , isOrderBy = true, isSeachBy =true)]
		public Int32 Plurality_Of_Absences  {set; get;}  
   
		[Display(Name = "Deducted_Points", Order = 0, ResourceType = typeof(msg_SanctionCategory))]
		[GAppDataTable(PropertyPath = "Deducted_Points", FilterBy = "Deducted_Points", SearchBy = "Deducted_Points", OrderBy = "Deducted_Points",  AutoGenerateFilter = false,isColumn = true , isOrderBy = true, isSeachBy =true)]
