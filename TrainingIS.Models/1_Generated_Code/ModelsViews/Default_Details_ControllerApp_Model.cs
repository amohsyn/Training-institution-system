...
{
	[DetailsView(typeof(ControllerApp))]
	[IndexView(typeof(ControllerApp))]
	[ExportView(typeof(ControllerApp))]
    public class Default_Details_ControllerApp_Model : BaseModel
    {
		[Required]
