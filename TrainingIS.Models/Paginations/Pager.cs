...
namespace TrainingIS.Models.Paginations
{
    public class Pager
    {
        ...
        public static StringBuilder CreateHtmlTableBodyFromList(StringBuilder htmlBuilder, List<object> listOfObjects, Dictionary<string, string> headerTextAndIDs, bool isEditDeleteSuppported = true)
        {
            ...
            foreach (Absence item in listOfObjects)
            {
                ...
                htmlBuilder.Append("<td>" + currentItem["AbsenceDate"] + "</td>");
                htmlBuilder.Append("<td>" + currentItem["Trainee"] + "</td>");
                htmlBuilder.Append("<td>" + item.SeanceTraining.SeancePlanning.Training.Group + "</td>");
                htmlBuilder.Append("<td>" + item.isHaveAuthorization + "</td>");
