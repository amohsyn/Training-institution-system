...
{ 
	public partial class BaseSeanceNumberBLO : TrainingIS_BaseBLO<SeanceNumber>{
		...
		public virtual List<string> GetSearchCreteria()
        {
            ...
            foreach (PropertyInfo model_property in typeof(Default_Details_SeanceNumber_Model).GetProperties(typeof(GAppDataTableAttribute)))
            {
            ...
            foreach (PropertyInfo model_property in typeof(Default_Details_SeanceNumber_Model).GetProperties(typeof(SearchByAttribute)))
            {
