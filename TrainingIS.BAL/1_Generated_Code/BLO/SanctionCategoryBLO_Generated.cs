...
{ 
	public partial class BaseSanctionCategoryBLO : TrainingIS_BaseBLO<SanctionCategory>{
		...
		public virtual List<string> GetSearchCreteria()
        {
            ...
            foreach (PropertyInfo model_property in typeof(Default_Details_SanctionCategory_Model).GetProperties(typeof(GAppDataTableAttribute)))
            {
            ...
            foreach (PropertyInfo model_property in typeof(Default_Details_SanctionCategory_Model).GetProperties(typeof(SearchByAttribute)))
            {
