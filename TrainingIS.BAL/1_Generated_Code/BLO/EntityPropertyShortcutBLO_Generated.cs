...
{ 
	public partial class BaseEntityPropertyShortcutBLO : TrainingIS_BaseBLO<EntityPropertyShortcut>{
		...
		public virtual List<string> GetSearchCreteria()
        {
            ...
            foreach (PropertyInfo model_property in typeof(Default_Details_EntityPropertyShortcut_Model).GetProperties(typeof(GAppDataTableAttribute)))
            {
            ...
            foreach (PropertyInfo model_property in typeof(Default_Details_EntityPropertyShortcut_Model).GetProperties(typeof(SearchByAttribute)))
            {
