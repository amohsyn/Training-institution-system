...
{ 
	public partial class BaseProjectBLO : TrainingIS_BaseBLO<Project>{
		...
		public virtual List<string> GetSearchCreteria()
        {
            ...
            foreach (PropertyInfo model_property in typeof(Default_Details_Project_Model).GetProperties(typeof(GAppDataTableAttribute)))
            {
            ...
            foreach (PropertyInfo model_property in typeof(Default_Details_Project_Model).GetProperties(typeof(SearchByAttribute)))
            {
