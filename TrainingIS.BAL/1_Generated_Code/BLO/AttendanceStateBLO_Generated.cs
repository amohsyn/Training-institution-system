...
{ 
	public partial class BaseAttendanceStateBLO : TrainingIS_BaseBLO<AttendanceState>{
		...
		public virtual List<string> GetSearchCreteria()
        {
			...
			// SearchBy of Entity
            var entity_attributes = typeof(Default_AttendanceState_Index_Model).GetCustomAttributes(typeof(SearchByAttribute));
        ...
        public DataTable Export(string Controller_Reference)
        {
            ...
            List<Default_AttendanceState_Export_Model> _Exported_Data = null;
            ...
            try
            {
                ...
                _Exported_Data = new Default_AttendanceState_Export_ModelBLM(this._UnitOfWork, this.GAppContext)
            ...
            DataTable dataTable = exportService.CreateDataTable(msg_AttendanceState.PluralName);
