...
{ 
	public partial class BaseCalendarDayBLO : TrainingIS_BaseBLO<CalendarDay>{
		...
		public virtual List<string> GetSearchCreteria()
        {
            ...
            foreach (PropertyInfo model_property in typeof(Default_Details_CalendarDay_Model).GetProperties(typeof(GAppDataTableAttribute)))
            {
            ...
            foreach (PropertyInfo model_property in typeof(Default_Details_CalendarDay_Model).GetProperties(typeof(SearchByAttribute)))
            {
