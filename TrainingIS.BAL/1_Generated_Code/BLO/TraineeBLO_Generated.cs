...
{ 
	public partial class BaseTraineeBLO : BaseBLO<Trainee>{
		...
		public BaseTraineeBLO(UnitOfWork<TrainingISModel> UnitOfWork) : base(new TraineeDAO(UnitOfWork.context))
        {
		...
		public override List<Trainee> FindAll()
        {
	...
	public  partial class TraineeBLO : BaseTraineeBLO{
		public TraineeBLO(UnitOfWork<TrainingISModel> UnitOfWork) : base(UnitOfWork) {}
