...
{ 
	public partial class BaseTraineeBLO : TrainingIS_BaseBLO<Trainee>{
		...
		public BaseTraineeBLO(UnitOfWork<TrainingISModel> UnitOfWork,GAppContext GAppContext) : base(new TraineeDAO(UnitOfWork.context),GAppContext)
        {
			...
			this.PluralName = msg_Trainee.PluralName;
        }
		...
		public virtual List<string> GetSearchCreteria()
        {
            ...
            foreach (PropertyInfo model_property in typeof(Index_Trainee_Model).GetProperties(typeof(SearchByAttribute)))
            {
			...
			// SearchBy of Entity
            var entity_attributes = typeof(Index_Trainee_Model).GetCustomAttributes(typeof(SearchByAttribute));
        ...
        public DataTable Export(string Controller_Reference)
        {
            ...
            List<Default_Trainee_Export_Model> _Exported_Data = null;
            ...
            try
            {
                ...
                _Exported_Data = new Default_Trainee_Export_ModelBLM(this._UnitOfWork, this.GAppContext)
            ...
            DataTable dataTable = exportService.CreateDataTable(msg_Trainee.PluralName);
