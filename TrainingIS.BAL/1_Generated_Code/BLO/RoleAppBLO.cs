...
{ 
	public partial class BaseRoleAppBLO : BaseBLO<RoleApp>{
		...
		public BaseRoleAppBLO(UnitOfWork<TrainingISModel> UnitOfWork) : base(new RoleAppDAO(UnitOfWork.context))
        {
	...
	public  partial class RoleAppBLO : BaseRoleAppBLO{
		public RoleAppBLO(UnitOfWork<TrainingISModel> UnitOfWork) : base(UnitOfWork) {}
