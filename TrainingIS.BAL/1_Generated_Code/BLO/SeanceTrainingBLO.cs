...
{ 
	public partial class BaseSeanceTrainingBLO : BaseBLO<SeanceTraining>{
		...
		public BaseSeanceTrainingBLO(UnitOfWork<TrainingISModel> UnitOfWork) : base(new SeanceTrainingDAO(UnitOfWork.context))
        {
	...
	public  partial class SeanceTrainingBLO : BaseSeanceTrainingBLO{
		public SeanceTrainingBLO(UnitOfWork<TrainingISModel> UnitOfWork) : base(UnitOfWork) {}
