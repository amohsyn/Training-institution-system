...
{ 
	public partial class BaseTrainingLevelBLO : TrainingIS_BaseBLO<TrainingLevel>{
		...
		public virtual List<string> GetSearchCreteria()
        {
            ...
            foreach (PropertyInfo model_property in typeof(Default_Details_TrainingLevel_Model).GetProperties(typeof(GAppDataTableAttribute)))
            {
            ...
            foreach (PropertyInfo model_property in typeof(Default_Details_TrainingLevel_Model).GetProperties(typeof(SearchByAttribute)))
            {
