...
{ 
	public partial class BaseSpecialtyBLO : BaseBLO<Specialty>{
		...
		public BaseSpecialtyBLO(UnitOfWork<TrainingISModel> UnitOfWork) : base(new SpecialtyDAO(UnitOfWork.context))
        {
	...
	public  partial class SpecialtyBLO : BaseSpecialtyBLO{
		public SpecialtyBLO(UnitOfWork<TrainingISModel> UnitOfWork) : base(UnitOfWork) {}
