...
{ 
	public partial class BaseSchoollevelBLO : BaseBLO<Schoollevel>{
		...
		public BaseSchoollevelBLO(UnitOfWork UnitOfWork) : base(UnitOfWork.SchoollevelDAO)
        {
		...
		public virtual ImportReport Import(DataTable dataTable, string FileName = "")
		{
			...
			private void InitUnitOfWork()
			{
				...
				this.entityDAO = new SchoollevelDAO(unitOfWorkImport.context);
			}
	...
	public  partial class SchoollevelBLO : BaseSchoollevelBLO{
		public SchoollevelBLO(UnitOfWork UnitOfWork) : base(UnitOfWork) {}
