...
{ 
	public partial class BaseSchoollevelBLO : TrainingIS_BaseBLO<Schoollevel>{
		...
		public virtual List<string> GetSearchCreteria()
        {
            ...
            foreach (PropertyInfo model_property in typeof(Default_Details_Schoollevel_Model).GetProperties(typeof(GAppDataTableAttribute)))
            {
            ...
            foreach (PropertyInfo model_property in typeof(Default_Details_Schoollevel_Model).GetProperties(typeof(SearchByAttribute)))
            {
