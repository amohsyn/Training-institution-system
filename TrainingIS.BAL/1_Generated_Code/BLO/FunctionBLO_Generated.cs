...
{ 
	public partial class BaseFunctionBLO : TrainingIS_BaseBLO<Function>{
		...
		public virtual List<string> GetSearchCreteria()
        {
            ...
            foreach (PropertyInfo model_property in typeof(Default_Details_Function_Model).GetProperties(typeof(GAppDataTableAttribute)))
            {
            ...
            foreach (PropertyInfo model_property in typeof(Default_Details_Function_Model).GetProperties(typeof(SearchByAttribute)))
            {
