...
{ 
	public partial class BaseClassroomCategoryBLO : BaseBLO<ClassroomCategory>{
		...
		public BaseClassroomCategoryBLO(UnitOfWork<TrainingISModel> UnitOfWork) : base(new ClassroomCategoryDAO(UnitOfWork.context))
        {
	...
	public  partial class ClassroomCategoryBLO : BaseClassroomCategoryBLO{
		public ClassroomCategoryBLO(UnitOfWork<TrainingISModel> UnitOfWork) : base(UnitOfWork) {}
