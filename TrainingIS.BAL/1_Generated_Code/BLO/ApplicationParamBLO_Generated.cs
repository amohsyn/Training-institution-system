...
{ 
	public partial class BaseApplicationParamBLO : TrainingIS_BaseBLO<ApplicationParam>{
		...
		public virtual List<string> GetSearchCreteria()
        {
			...
			// SearchBy of Entity
            var entity_attributes = typeof(Default_ApplicationParam_Index_Model).GetCustomAttributes(typeof(SearchByAttribute));
		...
		public override int Save(ApplicationParam item)
        {
		...
		public virtual IQueryable<ApplicationParam> Find_as_Queryable(
			...
			Func<ApplicationParam, bool> Condition = null)
        {
        ...
        public DataTable Export(string Controller_Reference)
        {
            ...
            List<Default_ApplicationParam_Export_Model> _Exported_Data = null;
            ...
            try
            {
                ...
                _Exported_Data = new Default_ApplicationParam_Export_ModelBLM(this._UnitOfWork, this.GAppContext)
            ...
            DataTable dataTable = exportService.CreateDataTable(msg_ApplicationParam.PluralName);
		...
		public virtual ImportReport Import(DataTable dataTable, string FileName = "")
		{
			...
			/// <returns></returns>
			protected virtual ApplicationParam Load_if_not_attached_in_current_context(ApplicationParam item)
			{

				ApplicationParam entity = null;

				// if the item is in current context
				var item_in_context = this._UnitOfWork.context.ApplicationParams.Local.Where(a => a.Id == item.Id);
