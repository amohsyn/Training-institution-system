...
{ 
	public partial class BaseApplicationParamBLO : BaseBLO<ApplicationParam>{
		...
		public BaseApplicationParamBLO(UnitOfWork<TrainingISModel> UnitOfWork) : base(new ApplicationParamDAO(UnitOfWork.context))
        {
	...
	public  partial class ApplicationParamBLO : BaseApplicationParamBLO{
		public ApplicationParamBLO(UnitOfWork<TrainingISModel> UnitOfWork) : base(UnitOfWork) {}
