...
{ 
	public partial class BaseMission_Working_GroupBLO : TrainingIS_BaseBLO<Mission_Working_Group>{
		...
		public virtual List<string> GetSearchCreteria()
        {
            ...
            foreach (PropertyInfo model_property in typeof(Default_Details_Mission_Working_Group_Model).GetProperties(typeof(GAppDataTableAttribute)))
            {
            ...
            foreach (PropertyInfo model_property in typeof(Default_Details_Mission_Working_Group_Model).GetProperties(typeof(SearchByAttribute)))
            {
