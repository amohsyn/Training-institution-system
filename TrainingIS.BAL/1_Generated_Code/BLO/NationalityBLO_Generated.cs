...
{ 
	public partial class BaseNationalityBLO : BaseBLO<Nationality>{
		...
		public BaseNationalityBLO(UnitOfWork<TrainingISModel> UnitOfWork) : base(new NationalityDAO(UnitOfWork.context))
        {
	...
	public  partial class NationalityBLO : BaseNationalityBLO{
		public NationalityBLO(UnitOfWork<TrainingISModel> UnitOfWork) : base(UnitOfWork) {}
