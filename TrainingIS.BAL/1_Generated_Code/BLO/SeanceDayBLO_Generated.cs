...
{ 
	public partial class BaseSeanceDayBLO : BaseBLO<SeanceDay>{
		...
		public BaseSeanceDayBLO(UnitOfWork<TrainingISModel> UnitOfWork) : base(new SeanceDayDAO(UnitOfWork.context))
        {
	...
	public  partial class SeanceDayBLO : BaseSeanceDayBLO{
		public SeanceDayBLO(UnitOfWork<TrainingISModel> UnitOfWork) : base(UnitOfWork) {}
