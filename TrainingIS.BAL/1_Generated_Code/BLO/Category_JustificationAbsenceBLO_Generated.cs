...
{ 
	public partial class BaseCategory_JustificationAbsenceBLO : TrainingIS_BaseBLO<Category_JustificationAbsence>{
		...
		public virtual List<string> GetSearchCreteria()
        {
            ...
            foreach (PropertyInfo model_property in typeof(Default_Details_Category_JustificationAbsence_Model).GetProperties(typeof(GAppDataTableAttribute)))
            {
            ...
            foreach (PropertyInfo model_property in typeof(Default_Details_Category_JustificationAbsence_Model).GetProperties(typeof(SearchByAttribute)))
            {
