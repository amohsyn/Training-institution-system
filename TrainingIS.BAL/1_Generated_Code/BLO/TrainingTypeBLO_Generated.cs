...
{ 
	public partial class BaseTrainingTypeBLO : BaseBLO<TrainingType>{
		...
		public BaseTrainingTypeBLO(UnitOfWork<TrainingISModel> UnitOfWork) : base(new TrainingTypeDAO(UnitOfWork.context))
        {
	...
	public  partial class TrainingTypeBLO : BaseTrainingTypeBLO{
		public TrainingTypeBLO(UnitOfWork<TrainingISModel> UnitOfWork) : base(UnitOfWork) {}
