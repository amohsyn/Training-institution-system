...
{ 
	public partial class BaseTrainingTypeBLO : TrainingIS_BaseBLO<TrainingType>{
		...
		public virtual List<string> GetSearchCreteria()
        {
            ...
            foreach (PropertyInfo model_property in typeof(Default_Details_TrainingType_Model).GetProperties(typeof(GAppDataTableAttribute)))
            {
            ...
            foreach (PropertyInfo model_property in typeof(Default_Details_TrainingType_Model).GetProperties(typeof(SearchByAttribute)))
            {
