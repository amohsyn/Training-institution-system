...
{ 
	public partial class BaseSeancePlanningBLO : BaseBLO<SeancePlanning>{
		...
		public BaseSeancePlanningBLO(UnitOfWork<TrainingISModel> UnitOfWork) : base(new SeancePlanningDAO(UnitOfWork.context))
        {
	...
	public  partial class SeancePlanningBLO : BaseSeancePlanningBLO{
		public SeancePlanningBLO(UnitOfWork<TrainingISModel> UnitOfWork) : base(UnitOfWork) {}
