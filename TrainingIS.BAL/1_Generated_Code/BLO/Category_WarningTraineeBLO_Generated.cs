...
{ 
	public partial class BaseCategory_WarningTraineeBLO : TrainingIS_BaseBLO<Category_WarningTrainee>{
		...
		public virtual List<string> GetSearchCreteria()
        {
            ...
            foreach (PropertyInfo model_property in typeof(Default_Details_Category_WarningTrainee_Model).GetProperties(typeof(GAppDataTableAttribute)))
            {
            ...
            foreach (PropertyInfo model_property in typeof(Default_Details_Category_WarningTrainee_Model).GetProperties(typeof(SearchByAttribute)))
            {
