...
{ 
	public partial class BaseAdministratorBLO : TrainingIS_BaseBLO<Administrator>{
		...
		public BaseAdministratorBLO(UnitOfWork<TrainingISModel> UnitOfWork,GAppContext GAppContext) : base(new AdministratorDAO(UnitOfWork.context),GAppContext)
        {
			...
			this.PluralName = msg_Administrator.PluralName;
        }

		public virtual List<string> GetSearchCreteria()
        {
            List<string> SearchCreteria = new List<string>();
            foreach (PropertyInfo model_property in typeof(Default_Administrator_Index_Model).GetProperties(typeof(GAppDataTableAttribute)))
            {
            ...
            foreach (PropertyInfo model_property in typeof(Default_Administrator_Index_Model).GetProperties(typeof(SearchByAttribute)))
            {
			...
			// SearchBy of Entity
            var entity_attributes = typeof(Default_Administrator_Index_Model).GetCustomAttributes(typeof(SearchByAttribute));
        ...
        public DataTable Export(string Controller_Reference)
        {
            ...
            List<Default_Administrator_Export_Model> _Exported_Data = null;
            ...
            try
            {
                ...
                _Exported_Data = new Default_Administrator_Export_ModelBLM(this._UnitOfWork, this.GAppContext)
            ...
            DataTable dataTable = exportService.CreateDataTable(msg_Administrator.PluralName);
