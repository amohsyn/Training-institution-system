...
{ 
	public partial class BaseActionControllerAppBLO : BaseBLO<ActionControllerApp>{
		...
		public BaseActionControllerAppBLO(UnitOfWork<TrainingISModel> UnitOfWork) : base(new ActionControllerAppDAO(UnitOfWork.context))
        {
	...
	public  partial class ActionControllerAppBLO : BaseActionControllerAppBLO{
		public ActionControllerAppBLO(UnitOfWork<TrainingISModel> UnitOfWork) : base(UnitOfWork) {}
