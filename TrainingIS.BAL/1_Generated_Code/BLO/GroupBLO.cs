...
{ 
	public partial class BaseGroupBLO : BaseBLO<Group>{
		...
		public BaseGroupBLO(UnitOfWork<TrainingISModel> UnitOfWork) : base(new GroupDAO(UnitOfWork.context))
        {
	...
	public  partial class GroupBLO : BaseGroupBLO{
		public GroupBLO(UnitOfWork<TrainingISModel> UnitOfWork) : base(UnitOfWork) {}
