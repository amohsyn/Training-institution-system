...
{ 
	public partial class BaseTrainingBLO : BaseBLO<Training>{
		...
		public BaseTrainingBLO(UnitOfWork<TrainingISModel> UnitOfWork) : base(new TrainingDAO(UnitOfWork.context))
        {
	...
	public  partial class TrainingBLO : BaseTrainingBLO{
		public TrainingBLO(UnitOfWork<TrainingISModel> UnitOfWork) : base(UnitOfWork) {}
