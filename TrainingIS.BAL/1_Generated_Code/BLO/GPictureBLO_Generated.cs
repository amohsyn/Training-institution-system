...
{ 
	public partial class BaseGPictureBLO : TrainingIS_BaseBLO<GPicture>{
		...
		public virtual List<string> GetSearchCreteria()
        {
            ...
            foreach (PropertyInfo model_property in typeof(Default_Details_GPicture_Model).GetProperties(typeof(GAppDataTableAttribute)))
            {
            ...
            foreach (PropertyInfo model_property in typeof(Default_Details_GPicture_Model).GetProperties(typeof(SearchByAttribute)))
            {
