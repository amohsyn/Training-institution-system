...
{ 
	public partial class BaseYearStudyBLO : BaseBLO<YearStudy>{
		...
		public BaseYearStudyBLO(UnitOfWork<TrainingISModel> UnitOfWork) : base(new YearStudyDAO(UnitOfWork.context))
        {
	...
	public  partial class YearStudyBLO : BaseYearStudyBLO{
		public YearStudyBLO(UnitOfWork<TrainingISModel> UnitOfWork) : base(UnitOfWork) {}
