...
{ 
	public partial class BaseModuleTrainingBLO : BaseBLO<ModuleTraining>{
		...
		public BaseModuleTrainingBLO(UnitOfWork<TrainingISModel> UnitOfWork) : base(new ModuleTrainingDAO(UnitOfWork.context))
        {
	...
	public  partial class ModuleTrainingBLO : BaseModuleTrainingBLO{
		public ModuleTrainingBLO(UnitOfWork<TrainingISModel> UnitOfWork) : base(UnitOfWork) {}
