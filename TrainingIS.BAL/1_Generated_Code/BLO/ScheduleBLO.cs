...
{ 
	public partial class BaseScheduleBLO : BaseBLO<Schedule>{
		...
		public BaseScheduleBLO(UnitOfWork<TrainingISModel> UnitOfWork) : base(new ScheduleDAO(UnitOfWork.context))
        {
	...
	public  partial class ScheduleBLO : BaseScheduleBLO{
		public ScheduleBLO(UnitOfWork<TrainingISModel> UnitOfWork) : base(UnitOfWork) {}
