...
{ 
	public partial class BaseFormerBLO : BaseBLO<Former>{
		...
		public BaseFormerBLO(UnitOfWork<TrainingISModel> UnitOfWork) : base(new FormerDAO(UnitOfWork.context))
        {
	...
	public  partial class FormerBLO : BaseFormerBLO{
		public FormerBLO(UnitOfWork<TrainingISModel> UnitOfWork) : base(UnitOfWork) {}
