...
{ 
	public partial class BaseYearStudyBLO : TrainingIS_BaseBLO<YearStudy>{
		...
		public virtual List<string> GetSearchCreteria()
        {
            ...
            foreach (PropertyInfo model_property in typeof(Default_Details_YearStudy_Model).GetProperties(typeof(GAppDataTableAttribute)))
            {
            ...
            foreach (PropertyInfo model_property in typeof(Default_Details_YearStudy_Model).GetProperties(typeof(SearchByAttribute)))
            {
