...
{ 
	public partial class BaseControllerAppBLO : BaseBLO<ControllerApp>{
		...
		public BaseControllerAppBLO(UnitOfWork<TrainingISModel> UnitOfWork) : base(new ControllerAppDAO(UnitOfWork.context))
        {
	...
	public  partial class ControllerAppBLO : BaseControllerAppBLO{
		public ControllerAppBLO(UnitOfWork<TrainingISModel> UnitOfWork) : base(UnitOfWork) {}
