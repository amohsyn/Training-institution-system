...
{ 
	public partial class BaseAuthrorizationAppBLO : TrainingIS_BaseBLO<AuthrorizationApp>{
		...
		public virtual List<string> GetSearchCreteria()
        {
			...
			// SearchBy of Entity
            var entity_attributes = typeof(Default_AuthrorizationApp_Index_Model).GetCustomAttributes(typeof(SearchByAttribute));
		...
		public virtual IQueryable<AuthrorizationApp> Find_as_Queryable(
			...
			Func<AuthrorizationApp, bool> Condition = null)
        {
           ...
           IQueryable<AuthrorizationApp> Query = this.entityDAO
        ...
        public DataTable Export(string Controller_Reference)
        {
            ...
            List<Default_AuthrorizationApp_Export_Model> _Exported_Data = null;
            ...
            try
            {
                ...
                _Exported_Data = new Default_AuthrorizationApp_Export_ModelBLM(this._UnitOfWork, this.GAppContext)
            ...
            DataTable dataTable = exportService.CreateDataTable(msg_AuthrorizationApp.PluralName);
		...
		public virtual ImportReport Import(DataTable dataTable, string FileName = "")
		{
				...
				ImportService importService = new ImportService(dataTable, typeof(AuthrorizationApp), this.GAppContext);
			...
			private void InitUnitOfWork()
			{
				...
				this.entityDAO = new AuthrorizationAppDAO(_UnitOfWork.context);
			}
			private AuthrorizationApp Load_Or_CreateEntity(ImportService importService, string entity_reference)
			{
				...
				{
					entity = new AuthrorizationAppBLO(this._UnitOfWork, this.GAppContext).CreateInstance();
			...
			/// <returns></returns>
			protected virtual AuthrorizationApp Load_if_not_attached_in_current_context(AuthrorizationApp item)
			{

				AuthrorizationApp entity = null;

				// if the item is in current context
				var item_in_context = this._UnitOfWork.context.AuthrorizationApps.Local.Where(a => a.Id == item.Id);
	...
	public  partial class AuthrorizationAppBLO : BaseAuthrorizationAppBLO{
		public AuthrorizationAppBLO(UnitOfWork<TrainingISModel> UnitOfWork, GAppContext GAppContext) : base(UnitOfWork,GAppContext) {}
