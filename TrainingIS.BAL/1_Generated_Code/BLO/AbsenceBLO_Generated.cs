...
{ 
	public partial class BaseAbsenceBLO : TrainingIS_BaseBLO<Absence>{
		...
		public virtual List<string> GetSearchCreteria()
        {
			...
			// SearchBy of Entity
            var entity_attributes = typeof(Index_Absence_Model).GetCustomAttributes(typeof(SearchByAttribute));
        ...
        public DataTable Export(string Controller_Reference)
        {
            ...
            List<Default_Absence_Export_Model> _Exported_Data = null;
            ...
            try
            {
                ...
                _Exported_Data = new Default_Absence_Export_ModelBLM(this._UnitOfWork, this.GAppContext)
            ...
            DataTable dataTable = exportService.CreateDataTable(msg_Absence.PluralName);
