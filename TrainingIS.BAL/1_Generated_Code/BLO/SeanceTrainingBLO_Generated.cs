...
{ 
	public partial class BaseSeanceTrainingBLO : BaseBLO<SeanceTraining>{
		...
		public BaseSeanceTrainingBLO(UnitOfWork<TrainingISModel> UnitOfWork,GAppContext GAppContext) : base(new SeanceTrainingDAO(UnitOfWork.context),GAppContext)
        {
        ...
        {
            ExportService exportService = new ExportService(typeof(SeanceTraining));
            DataTable entityDataTable = exportService.CreateDataTable(msg_SeanceTraining.PluralName);
		...
		public virtual ImportReport Import(DataTable dataTable, string FileName = "")
		{
			...
			private void InitUnitOfWork()
			{
				...
				this.entityDAO = new SeanceTrainingDAO(_UnitOfWork.context);
			}
			private SeanceTraining Load_Or_CreateEntity(ImportService importService, string entity_reference)
			{
				...
				{
					entity = new SeanceTrainingBLO(this._UnitOfWork, this.GAppContext).CreateInstance();
	...
	public  partial class SeanceTrainingBLO : BaseSeanceTrainingBLO{
		public SeanceTrainingBLO(UnitOfWork<TrainingISModel> UnitOfWork, GAppContext GAppContext) : base(UnitOfWork,GAppContext) {}
