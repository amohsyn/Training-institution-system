...
{ 
	public partial class BaseClassroomBLO : BaseBLO<Classroom>{
		...
		public BaseClassroomBLO(UnitOfWork<TrainingISModel> UnitOfWork) : base(new ClassroomDAO(UnitOfWork.context))
        {
	...
	public  partial class ClassroomBLO : BaseClassroomBLO{
		public ClassroomBLO(UnitOfWork<TrainingISModel> UnitOfWork) : base(UnitOfWork) {}
