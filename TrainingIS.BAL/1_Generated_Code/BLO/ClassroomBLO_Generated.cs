...
{ 
	public partial class BaseClassroomBLO : TrainingIS_BaseBLO<Classroom>{
		...
		public virtual List<string> GetSearchCreteria()
        {
            ...
            foreach (PropertyInfo model_property in typeof(Default_Details_Classroom_Model).GetProperties(typeof(GAppDataTableAttribute)))
            {
            ...
            foreach (PropertyInfo model_property in typeof(Default_Details_Classroom_Model).GetProperties(typeof(SearchByAttribute)))
            {
