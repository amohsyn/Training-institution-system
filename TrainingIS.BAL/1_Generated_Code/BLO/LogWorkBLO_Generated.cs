...
{ 
	public partial class BaseLogWorkBLO : BaseBLO<LogWork>{
		...
		public BaseLogWorkBLO(UnitOfWork<TrainingISModel> UnitOfWork) : base(new LogWorkDAO(UnitOfWork.context))
        {
	...
	public  partial class LogWorkBLO : BaseLogWorkBLO{
		public LogWorkBLO(UnitOfWork<TrainingISModel> UnitOfWork) : base(UnitOfWork) {}
