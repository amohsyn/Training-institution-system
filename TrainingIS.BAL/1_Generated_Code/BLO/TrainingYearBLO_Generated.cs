...
{ 
	public partial class BaseTrainingYearBLO : TrainingIS_BaseBLO<TrainingYear>{
		...
		public virtual List<string> GetSearchCreteria()
        {
            ...
            foreach (PropertyInfo model_property in typeof(Default_Details_TrainingYear_Model).GetProperties(typeof(GAppDataTableAttribute)))
            {
            ...
            foreach (PropertyInfo model_property in typeof(Default_Details_TrainingYear_Model).GetProperties(typeof(SearchByAttribute)))
            {
