...
{ 
	public partial class BaseSchoollevelBLO : BaseBLO<Schoollevel>{
		...
		public BaseSchoollevelBLO(UnitOfWork<TrainingISModel> UnitOfWork) : base(new SchoollevelDAO(UnitOfWork.context))
        {
	...
	public  partial class SchoollevelBLO : BaseSchoollevelBLO{
		public SchoollevelBLO(UnitOfWork<TrainingISModel> UnitOfWork) : base(UnitOfWork) {}
