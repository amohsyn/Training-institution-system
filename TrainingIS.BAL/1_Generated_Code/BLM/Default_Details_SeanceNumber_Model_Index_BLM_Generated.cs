...
{
	public partial class BaseDefault_Details_SeanceNumber_Model_Index_BLM : BaseModelBLM
    {
        public GAppContext GAppContext {set;get;}
        public BaseDefault_Details_SeanceNumber_Model_Index_BLM(UnitOfWork<TrainingISModel> unitOfWork, GAppContext GAppContext) :base(unitOfWork, GAppContext)
        {
        ...
        public virtual SeanceNumber ConverTo_SeanceNumber(Default_Details_SeanceNumber_Model Default_Details_SeanceNumber_Model)
        {
            ...
            {
                SeanceNumber = new SeanceNumberBLO(this.UnitOfWork,this.GAppContext).FindBaseEntityByID(Default_Details_SeanceNumber_Model.Id);
            }
            else
            {
		...
		public virtual List<Default_Details_SeanceNumber_Model> Find(FilterRequestParams filterRequestParams, List<string> SearchCreteria, out int totalRecords)
        {
            ...
            List<Default_Details_SeanceNumber_Model> ls_models = new List<Default_Details_SeanceNumber_Model>();
            foreach (var entity in list_entities)
            {
                ls_models.Add(this.ConverTo_Default_Details_SeanceNumber_Model(entity));
            }
            return ls_models;
        }
	...
	public partial class Default_Details_SeanceNumber_ModelBLM : BaseDefault_Details_SeanceNumber_Model_Index_BLM
	{
		public Default_Details_SeanceNumber_ModelBLM(UnitOfWork<TrainingISModel> unitOfWork, GAppContext GAppContext) :base(unitOfWork, GAppContext) {
