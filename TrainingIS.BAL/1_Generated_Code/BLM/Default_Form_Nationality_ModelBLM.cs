...
namespace TrainingIS.BLL.ModelsViews
{
	public partial class BaseDefault_Form_Nationality_ModelBLM : BaseModelBLM
    {
        ...
        public BaseDefault_Form_Nationality_ModelBLM(UnitOfWork<TrainingISModel> unitOfWork) :base(unitOfWork)
        {
        ...
        public virtual Nationality ConverTo_Nationality(Default_Form_Nationality_Model Default_Form_Nationality_Model)
        {
            ...
            {
                Nationality = new NationalityBLO(this.UnitOfWork).FindBaseEntityByID(Default_Form_Nationality_Model.Id);
            }
            else
            {
	...
	{
		public Default_Form_Nationality_ModelBLM(UnitOfWork<TrainingISModel> unitOfWork) :base(unitOfWork) {
