...
{
	public partial class BaseDefault_Form_Mission_Working_Group_ModelBLM : BaseModelBLM
    {
        public GAppContext GAppContext {set;get;}
        public BaseDefault_Form_Mission_Working_Group_ModelBLM(UnitOfWork<TrainingISModel> unitOfWork, GAppContext GAppContext) :base(unitOfWork, GAppContext)
        {
        ...
        public virtual Default_Form_Mission_Working_Group_Model ConverTo_Default_Form_Mission_Working_Group_Model(Mission_Working_Group Mission_Working_Group)
        {  
			Default_Form_Mission_Working_Group_Model Default_Form_Mission_Working_Group_Model = new Default_Form_Mission_Working_Group_Model();
		...
		public virtual Default_Form_Mission_Working_Group_Model CreateNew()
        {
            Mission_Working_Group Mission_Working_Group = new Mission_Working_GroupBLO(this.UnitOfWork, this.GAppContext).CreateInstance();
            Default_Form_Mission_Working_Group_Model Default_Form_Mission_Working_Group_Model = this.ConverTo_Default_Form_Mission_Working_Group_Model(Mission_Working_Group);
            return Default_Form_Mission_Working_Group_Model;
        } 

		public virtual List<Default_Form_Mission_Working_Group_Model> Find(FilterRequestParams filterRequestParams, List<string> SearchCreteria, out int totalRecords)
        {
            ...
            List<Default_Form_Mission_Working_Group_Model> ls_models = new List<Default_Form_Mission_Working_Group_Model>();
            foreach (var entity in list_entities)
            {
                ls_models.Add(this.ConverTo_Default_Form_Mission_Working_Group_Model(entity));
            }
            return ls_models;
        }
	...
	public partial class Default_Form_Mission_Working_Group_ModelBLM : BaseDefault_Form_Mission_Working_Group_ModelBLM
	{
