...
namespace TrainingIS.BLL.ModelsViews
{
	public partial class BaseIndex_SeanceTraining_ModelBLM : BaseModelBLM
    {
        ...
        public List<Index_SeanceTraining_Model> Find(string OrderBy, string FilterBy,  string SearchBy, List<string> SearchCreteria, int? CurrentPage, int? PageSize, out int totalRecords)
        {
