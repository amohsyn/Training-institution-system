...
{
	public partial class BaseDefault_Form_GPicture_ModelBLM : BaseModelBLM
    {
        public GAppContext GAppContext {set;get;}
        public BaseDefault_Form_GPicture_ModelBLM(UnitOfWork<TrainingISModel> unitOfWork, GAppContext GAppContext) :base(unitOfWork, GAppContext)
        {
        ...
        public virtual Default_Form_GPicture_Model ConverTo_Default_Form_GPicture_Model(GPicture GPicture)
        {  
			Default_Form_GPicture_Model Default_Form_GPicture_Model = new Default_Form_GPicture_Model();
		...
		public virtual Default_Form_GPicture_Model CreateNew()
        {
            GPicture GPicture = new GPictureBLO(this.UnitOfWork, this.GAppContext).CreateInstance();
            Default_Form_GPicture_Model Default_Form_GPicture_Model = this.ConverTo_Default_Form_GPicture_Model(GPicture);
            return Default_Form_GPicture_Model;
        } 

		public virtual List<Default_Form_GPicture_Model> Find(FilterRequestParams filterRequestParams, List<string> SearchCreteria, out int totalRecords)
        {
            ...
            List<Default_Form_GPicture_Model> ls_models = new List<Default_Form_GPicture_Model>();
            foreach (var entity in list_entities)
            {
                ls_models.Add(this.ConverTo_Default_Form_GPicture_Model(entity));
            }
            return ls_models;
        }
	...
	public partial class Default_Form_GPicture_ModelBLM : BaseDefault_Form_GPicture_ModelBLM
	{
