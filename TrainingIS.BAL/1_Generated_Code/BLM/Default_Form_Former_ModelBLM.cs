...
namespace TrainingIS.BLL.ModelsViews
{
	public partial class BaseDefault_Form_Former_ModelBLM : BaseModelBLM
    {
        ...
        public BaseDefault_Form_Former_ModelBLM(UnitOfWork<TrainingISModel> unitOfWork) :base(unitOfWork)
        {
        ...
        public virtual Former ConverTo_Former(Default_Form_Former_Model Default_Form_Former_Model)
        {
            ...
            {
                Former = new FormerBLO(this.UnitOfWork).FindBaseEntityByID(Default_Form_Former_Model.Id);
            }
            else
            {
                Former = new Former();
			...
			Former.Nationality = Default_Form_Former_Model.Nationality;
        ...
        {  
			...
			Default_Form_Former_Model.Nationality = Former.Nationality;
	...
	{
		public Default_Form_Former_ModelBLM(UnitOfWork<TrainingISModel> unitOfWork) :base(unitOfWork) {
