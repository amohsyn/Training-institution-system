...
{
	public partial class BaseDefault_Details_TrainingYear_Model_Index_BLM : BaseModelBLM
    {
        public GAppContext GAppContext {set;get;}
        public BaseDefault_Details_TrainingYear_Model_Index_BLM(UnitOfWork<TrainingISModel> unitOfWork, GAppContext GAppContext) :base(unitOfWork, GAppContext)
        {
		...
		public virtual List<Default_Details_TrainingYear_Model> Find(FilterRequestParams filterRequestParams, List<string> SearchCreteria, out int totalRecords)
        {
	...
	public partial class Default_Details_TrainingYear_ModelBLM : BaseDefault_Details_TrainingYear_Model_Index_BLM
	{
