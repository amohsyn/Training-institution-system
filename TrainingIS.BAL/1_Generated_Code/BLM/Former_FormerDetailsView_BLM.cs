...
{
	public partial class BaseFormerDetailsViewBLM : ViewModelBLM
    {
        
        public BaseFormerDetailsViewBLM(UnitOfWork unitOfWork) :base(unitOfWork)
        {
        ...
        public virtual Former ConverTo_Former(FormerDetailsView FormerDetailsView)
        {
            ...
            {
                Former = new FormerBLO(this.UnitOfWork).FindBaseEntityByID(FormerDetailsView.Id);
            }
            else
            {
                Former = new Former();
	...
	{
		public FormerDetailsViewBLM(UnitOfWork unitOfWork) :base(unitOfWork) {
