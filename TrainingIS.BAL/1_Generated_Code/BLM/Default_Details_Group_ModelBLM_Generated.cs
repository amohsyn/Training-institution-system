...
namespace TrainingIS.BLL.ModelsViews
{
	public partial class BaseDefault_Details_Group_ModelBLM : BaseModelBLM
    {
        ...
        public BaseDefault_Details_Group_ModelBLM(UnitOfWork<TrainingISModel> unitOfWork) :base(unitOfWork)
        {
        ...
        public virtual Group ConverTo_Group(Default_Details_Group_Model Default_Details_Group_Model)
        {
            ...
            {
                Group = new GroupBLO(this.UnitOfWork).FindBaseEntityByID(Default_Details_Group_Model.Id);
            }
            else
            {
                Group = new Group();
	...
	{
		public Default_Details_Group_ModelBLM(UnitOfWork<TrainingISModel> unitOfWork) :base(unitOfWork) {
