...
namespace TrainingIS.BLL.ModelsViews
{
	public partial class BaseDefault_Details_SeanceTraining_ModelBLM : BaseModelBLM
    {
        ...
        public BaseDefault_Details_SeanceTraining_ModelBLM(UnitOfWork<TrainingISModel> unitOfWork) :base(unitOfWork)
        {
        ...
        public virtual SeanceTraining ConverTo_SeanceTraining(Default_Details_SeanceTraining_Model Default_Details_SeanceTraining_Model)
        {
            ...
            {
                SeanceTraining = new SeanceTrainingBLO(this.UnitOfWork).FindBaseEntityByID(Default_Details_SeanceTraining_Model.Id);
            }
            else
            {
	...
	{
		public Default_Details_SeanceTraining_ModelBLM(UnitOfWork<TrainingISModel> unitOfWork) :base(unitOfWork) {
