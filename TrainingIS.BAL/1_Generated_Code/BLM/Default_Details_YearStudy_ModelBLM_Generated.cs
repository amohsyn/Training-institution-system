...
namespace TrainingIS.BLL.ModelsViews
{
	public partial class BaseDefault_Details_YearStudy_ModelBLM : BaseModelBLM
    {
        ...
        public BaseDefault_Details_YearStudy_ModelBLM(UnitOfWork<TrainingISModel> unitOfWork) :base(unitOfWork)
        {
        ...
        public virtual YearStudy ConverTo_YearStudy(Default_Details_YearStudy_Model Default_Details_YearStudy_Model)
        {
            ...
            {
                YearStudy = new YearStudyBLO(this.UnitOfWork).FindBaseEntityByID(Default_Details_YearStudy_Model.Id);
            }
            else
            {
	...
	{
		public Default_Details_YearStudy_ModelBLM(UnitOfWork<TrainingISModel> unitOfWork) :base(unitOfWork) {
