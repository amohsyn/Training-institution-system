...
namespace TrainingIS.BLL.ModelsViews
{
	public partial class BaseDefault_Details_EntityPropertyShortcut_ModelBLM : BaseModelBLM
    {
        ...
        public BaseDefault_Details_EntityPropertyShortcut_ModelBLM(UnitOfWork<TrainingISModel> unitOfWork) :base(unitOfWork)
        {
        ...
        public virtual EntityPropertyShortcut ConverTo_EntityPropertyShortcut(Default_Details_EntityPropertyShortcut_Model Default_Details_EntityPropertyShortcut_Model)
        {
            ...
            {
                EntityPropertyShortcut = new EntityPropertyShortcutBLO(this.UnitOfWork).FindBaseEntityByID(Default_Details_EntityPropertyShortcut_Model.Id);
            }
            else
            {
	...
	{
		public Default_Details_EntityPropertyShortcut_ModelBLM(UnitOfWork<TrainingISModel> unitOfWork) :base(unitOfWork) {
