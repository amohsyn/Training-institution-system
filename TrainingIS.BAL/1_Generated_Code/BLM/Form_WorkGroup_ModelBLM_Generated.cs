...
{
	public partial class BaseForm_WorkGroup_ModelBLM : BaseModelBLM
    {
        public GAppContext GAppContext {set;get;}
        public BaseForm_WorkGroup_ModelBLM(UnitOfWork<TrainingISModel> unitOfWork, GAppContext GAppContext) :base(unitOfWork, GAppContext)
        {
        ...
        public virtual Form_WorkGroup_Model ConverTo_Form_WorkGroup_Model(WorkGroup WorkGroup)
        {  
			Form_WorkGroup_Model Form_WorkGroup_Model = new Form_WorkGroup_Model();
		...
		public virtual Form_WorkGroup_Model CreateNew()
        {
            WorkGroup WorkGroup = new WorkGroupBLO(this.UnitOfWork, this.GAppContext).CreateInstance();
            Form_WorkGroup_Model Form_WorkGroup_Model = this.ConverTo_Form_WorkGroup_Model(WorkGroup);
            return Form_WorkGroup_Model;
        } 

		public virtual List<Form_WorkGroup_Model> Find(FilterRequestParams filterRequestParams, List<string> SearchCreteria, out int totalRecords)
        {
            ...
            List<Form_WorkGroup_Model> ls_models = new List<Form_WorkGroup_Model>();
            foreach (var entity in list_entities)
            {
                ls_models.Add(this.ConverTo_Form_WorkGroup_Model(entity));
            }
            return ls_models;
        }
	...
	public partial class Form_WorkGroup_ModelBLM : BaseForm_WorkGroup_ModelBLM
	{
