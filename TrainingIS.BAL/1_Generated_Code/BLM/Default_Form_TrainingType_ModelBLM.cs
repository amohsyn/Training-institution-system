...
namespace TrainingIS.BLL.ModelsViews
{
	public partial class BaseDefault_Form_TrainingType_ModelBLM : BaseModelBLM
    {
        ...
        public BaseDefault_Form_TrainingType_ModelBLM(UnitOfWork<TrainingISModel> unitOfWork) :base(unitOfWork)
        {
        ...
        public virtual TrainingType ConverTo_TrainingType(Default_Form_TrainingType_Model Default_Form_TrainingType_Model)
        {
            ...
            {
                TrainingType = new TrainingTypeBLO(this.UnitOfWork).FindBaseEntityByID(Default_Form_TrainingType_Model.Id);
            }
            else
            {
	...
	{
		public Default_Form_TrainingType_ModelBLM(UnitOfWork<TrainingISModel> unitOfWork) :base(unitOfWork) {
