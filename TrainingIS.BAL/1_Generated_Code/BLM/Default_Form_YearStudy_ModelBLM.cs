...
namespace TrainingIS.BLL.ModelsViews
{
	public partial class BaseDefault_Form_YearStudy_ModelBLM : BaseModelBLM
    {
        ...
        public BaseDefault_Form_YearStudy_ModelBLM(UnitOfWork<TrainingISModel> unitOfWork) :base(unitOfWork)
        {
        ...
        public virtual YearStudy ConverTo_YearStudy(Default_Form_YearStudy_Model Default_Form_YearStudy_Model)
        {
            ...
            {
                YearStudy = new YearStudyBLO(this.UnitOfWork).FindBaseEntityByID(Default_Form_YearStudy_Model.Id);
            }
            else
            {
	...
	{
		public Default_Form_YearStudy_ModelBLM(UnitOfWork<TrainingISModel> unitOfWork) :base(unitOfWork) {
