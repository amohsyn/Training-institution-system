...
namespace TrainingIS.BLL.ModelsViews
{
	public partial class BaseDefault_Details_Absence_ModelBLM : BaseModelBLM
    {
        ...
        public List<Default_Details_Absence_Model> Find(string OrderBy, string FilterBy,  string SearchBy, List<string> SearchCreteria, int? CurrentPage, int? PageSize, out int totalRecords)
        {
