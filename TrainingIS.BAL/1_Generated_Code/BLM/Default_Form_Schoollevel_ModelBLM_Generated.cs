...
namespace TrainingIS.BLL.ModelsViews
{
	public partial class BaseDefault_Form_Schoollevel_ModelBLM : BaseModelBLM
    {
        ...
        public BaseDefault_Form_Schoollevel_ModelBLM(UnitOfWork<TrainingISModel> unitOfWork, GAppContext GAppContext) :base(unitOfWork, GAppContext)
        {
        ...
        public List<Default_Form_Schoollevel_Model> Find(string OrderBy, string FilterBy,  string SearchBy, List<string> SearchCreteria, int? CurrentPage, int? PageSize, out int totalRecords)
        {
            ...
            List<Default_Form_Schoollevel_Model> ls_models = new List<Default_Form_Schoollevel_Model>();
            foreach (var entity in list_entities)
            {
                ls_models.Add(this.ConverTo_Default_Form_Schoollevel_Model(entity));
            }
            return ls_models;
        }
