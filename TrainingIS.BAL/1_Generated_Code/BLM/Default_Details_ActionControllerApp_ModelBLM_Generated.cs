...
namespace TrainingIS.BLL.ModelsViews
{
	public partial class BaseDefault_Details_ActionControllerApp_ModelBLM : BaseModelBLM
    {
        ...
        public BaseDefault_Details_ActionControllerApp_ModelBLM(UnitOfWork<TrainingISModel> unitOfWork) :base(unitOfWork)
        {
        ...
        public virtual ActionControllerApp ConverTo_ActionControllerApp(Default_Details_ActionControllerApp_Model Default_Details_ActionControllerApp_Model)
        {
            ...
            {
                ActionControllerApp = new ActionControllerAppBLO(this.UnitOfWork).FindBaseEntityByID(Default_Details_ActionControllerApp_Model.Id);
            }
            else
            {
	...
	{
		public Default_Details_ActionControllerApp_ModelBLM(UnitOfWork<TrainingISModel> unitOfWork) :base(unitOfWork) {
