...
namespace TrainingIS.BLL.ModelsViews
{
	public partial class BaseDefault_Form_RoleApp_ModelBLM : BaseModelBLM
    {
        ...
        public List<Default_Form_RoleApp_Model> Find(string OrderBy, string FilterBy,  string SearchBy, List<string> SearchCreteria, int? CurrentPage, int? PageSize, out int totalRecords)
        {
            ...
            List<Default_Form_RoleApp_Model> ls_models = new List<Default_Form_RoleApp_Model>();
            foreach (var entity in list_entities)
            {
                ls_models.Add(this.ConverTo_Default_Form_RoleApp_Model(entity));
            }
            return ls_models;
        }
