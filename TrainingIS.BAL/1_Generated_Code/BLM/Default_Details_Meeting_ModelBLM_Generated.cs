...
namespace TrainingIS.BLL.ModelsViews
{
	public partial class BaseDefault_Details_Meeting_ModelBLM : BaseModelBLM
    {
        ...
        public virtual Meeting ConverTo_Meeting(Default_Details_Meeting_Model Default_Details_Meeting_Model)
        {
			...
			Meeting.Presences_Of_Formers = Default_Details_Meeting_Model.Presences_Of_Formers;
			Meeting.Presences_Of_Administrators = Default_Details_Meeting_Model.Presences_Of_Administrators;
			Meeting.Presences_Of_Trainees = Default_Details_Meeting_Model.Presences_Of_Trainees;
        ...
        {  
			...
			Default_Details_Meeting_Model.Presences_Of_Formers = Meeting.Presences_Of_Formers;
			Default_Details_Meeting_Model.Presences_Of_Administrators = Meeting.Presences_Of_Administrators;
			Default_Details_Meeting_Model.Presences_Of_Trainees = Meeting.Presences_Of_Trainees;
