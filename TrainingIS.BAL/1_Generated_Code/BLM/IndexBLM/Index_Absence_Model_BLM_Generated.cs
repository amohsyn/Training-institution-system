...
{
	public partial class BaseIndex_Absence_Model_BLM : BaseModelBLM
    {
        public GAppContext GAppContext {set;get;}
        public BaseIndex_Absence_Model_BLM(UnitOfWork<TrainingISModel> unitOfWork, GAppContext GAppContext) :base(unitOfWork, GAppContext)
        {
        ...
        public virtual Absence ConverTo_Absence(Index_Absence_Model Index_Absence_Model)
        {
			...
			Absence.AbsenceState = Index_Absence_Model.AbsenceState;
        ...
        {  
			...
			Index_Absence_Model.AbsenceState = Absence.AbsenceState;
	...
	public partial class Index_Absence_ModelBLM : BaseIndex_Absence_Model_BLM
	{
