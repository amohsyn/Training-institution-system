...
namespace TrainingIS.BLL.ModelsViews
{
	public partial class BaseDefault_Details_Former_ModelBLM : BaseModelBLM
    {
        ...
        public BaseDefault_Details_Former_ModelBLM(UnitOfWork<TrainingISModel> unitOfWork) :base(unitOfWork)
        {
        ...
        public virtual Former ConverTo_Former(Default_Details_Former_Model Default_Details_Former_Model)
        {
            ...
            {
                Former = new FormerBLO(this.UnitOfWork).FindBaseEntityByID(Default_Details_Former_Model.Id);
            }
            else
            {
                Former = new Former();
	...
	{
		public Default_Details_Former_ModelBLM(UnitOfWork<TrainingISModel> unitOfWork) :base(unitOfWork) {
