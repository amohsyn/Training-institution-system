...
{
	public partial class BaseDefault_Details_RoleApp_Model_Index_BLM : BaseModelBLM
    {
        public GAppContext GAppContext {set;get;}
        public BaseDefault_Details_RoleApp_Model_Index_BLM(UnitOfWork<TrainingISModel> unitOfWork, GAppContext GAppContext) :base(unitOfWork, GAppContext)
        {
		...
		public virtual List<Default_Details_RoleApp_Model> Find(FilterRequestParams filterRequestParams, List<string> SearchCreteria, out int totalRecords)
        {
            ...
            List<Default_Details_RoleApp_Model> ls_models = new List<Default_Details_RoleApp_Model>();
            foreach (var entity in list_entities)
            {
                ls_models.Add(this.ConverTo_Default_Details_RoleApp_Model(entity));
            }
            return ls_models;
        }
	...
	public partial class Default_Details_RoleApp_ModelBLM : BaseDefault_Details_RoleApp_Model_Index_BLM
	{
