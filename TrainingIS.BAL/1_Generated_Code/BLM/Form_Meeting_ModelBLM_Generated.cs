...
{
	public partial class BaseForm_Meeting_ModelBLM : BaseModelBLM
    {
        public GAppContext GAppContext {set;get;}
        public BaseForm_Meeting_ModelBLM(UnitOfWork<TrainingISModel> unitOfWork, GAppContext GAppContext) :base(unitOfWork, GAppContext)
        {
        ...
        public virtual Form_Meeting_Model ConverTo_Form_Meeting_Model(Meeting Meeting)
        {  
		...
		public virtual Form_Meeting_Model CreateNew()
        {
            Meeting Meeting = new MeetingBLO(this.UnitOfWork, this.GAppContext).CreateInstance();
            Form_Meeting_Model Form_Meeting_Model = this.ConverTo_Form_Meeting_Model(Meeting);
            return Form_Meeting_Model;
        } 

		public virtual List<Form_Meeting_Model> Find(FilterRequestParams filterRequestParams, List<string> SearchCreteria, out int totalRecords)
        {
            ...
            List<Form_Meeting_Model> ls_models = new List<Form_Meeting_Model>();
            foreach (var entity in list_entities)
            {
                ls_models.Add(this.ConverTo_Form_Meeting_Model(entity));
            }
            return ls_models;
        }
	...
	public partial class Form_Meeting_ModelBLM : BaseForm_Meeting_ModelBLM
	{
