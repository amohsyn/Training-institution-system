...
namespace TrainingIS.BLL.ModelsViews
{
	public partial class BaseDefault_SeancePlanningFormViewBLM : ViewModelBLM
    {
        ...
        public virtual SeancePlanning ConverTo_SeancePlanning(Default_SeancePlanningFormView Default_SeancePlanningFormView)
        {
			...
			SeancePlanning.ClassroomId = Default_SeancePlanningFormView.ClassroomId;
        ...
        {  
			...
			Default_SeancePlanningFormView.ClassroomId = SeancePlanning.ClassroomId;
		...
		public virtual Default_SeancePlanningFormView CreateNew()
        {
            SeancePlanning SeancePlanning = new SeancePlanning();
            Default_SeancePlanningFormView Default_SeancePlanningFormView = this.ConverTo_Default_SeancePlanningFormView(SeancePlanning);
            return Default_SeancePlanningFormView;
        } 
    }
