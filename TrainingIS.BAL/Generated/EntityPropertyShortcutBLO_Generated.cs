...
namespace  TrainingIS.BLL
{
  ...
  // Chekc Reference colone existance
            ...
            foreach (DataRow dataRow in dataTable.Rows)
            {
                ...
                #region Create or Louad EntityPropertyShortcut Instance
            ...
            // Resume
            string resume_msg = string.Format(msgBLO.In_total_there_is_the_insertion_of, number_of_saved) + " " + msg_EntityPropertyShortcut.PluralName;
            importService.Report.AddMessage(resume_msg, MessageTypes.Resume_Info);
            resume_msg = string.Format(msgBLO.In_total_there_is_the_update_of, number_of_updated) + " " + msg_EntityPropertyShortcut.PluralName;
            importService.Report.AddMessage(resume_msg, MessageTypes.Resume_Info);
