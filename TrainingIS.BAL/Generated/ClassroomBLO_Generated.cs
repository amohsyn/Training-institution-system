...
namespace  TrainingIS.BLL
{
	public partial class BaseClassroomBLO : BaseBLO<Classroom>{
		...
		public BaseClassroomBLO(UnitOfWork UnitOfWork) : base()
        {
		    this._UnitOfWork = UnitOfWork;
            this.entityDAO = this._UnitOfWork.ClassroomDAO;
        }
		 
		private BaseClassroomBLO() : base() {}
		...
		public virtual DataTable Export()
        {
            ...
            DataTable entityDataTable = new DataTable(msg_Classroom.PluralName);

            var foreignKeys = this._UnitOfWork.context.GetForeignKeysIds(typeof(Classroom));
            var Keys =  this._UnitOfWork.context.GetKeyNames(typeof(Classroom));

            var navigationPropertiesNames = this.NavigationPropertiesNames();

            // Create DataColumn Names
            var Properties = typeof(Classroom).GetProperties();
	...
	public virtual ImportReport Import(DataTable dataTable, string FileName = "")
    {
        ...
        private void InitUnitOfWork()
        {
            ...
            this.entityDAO = new ClassroomDAO(unitOfWorkImport.context);
        }
	...
	public  partial class ClassroomBLO : BaseClassroomBLO{
		public ClassroomBLO(UnitOfWork UnitOfWork) : base(UnitOfWork) {}
