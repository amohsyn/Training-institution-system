...
namespace  TrainingIS.BLL
{
	public partial class BaseControllerAppBLO : BaseBLO<ControllerApp>{
		...
		public BaseControllerAppBLO(UnitOfWork UnitOfWork) : base()
        {
		    this._UnitOfWork = UnitOfWork;
            this.entityDAO = this._UnitOfWork.ControllerAppDAO;
        }
		 
		private BaseControllerAppBLO() : base() {}
		...
		public virtual DataTable Export()
        {
            ...
            DataTable entityDataTable = new DataTable(msg_ControllerApp.PluralName);

            var foreignKeys = this._UnitOfWork.context.GetForeignKeysIds(typeof(ControllerApp));
            var Keys =  this._UnitOfWork.context.GetKeyNames(typeof(ControllerApp));

            var navigationPropertiesNames = this.NavigationPropertiesNames();

            // Create DataColumn Names
            var Properties = typeof(ControllerApp).GetProperties();
	...
	public virtual ImportReport Import(DataTable dataTable, string FileName = "")
    {
        ...
        private void InitUnitOfWork()
        {
            ...
            this.entityDAO = new ControllerAppDAO(unitOfWorkImport.context);
        }
	...
	public  partial class ControllerAppBLO : BaseControllerAppBLO{
		public ControllerAppBLO(UnitOfWork UnitOfWork) : base(UnitOfWork) {}
