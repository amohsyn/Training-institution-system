...
namespace  TrainingIS.BLL
{
	public partial class BaseSpecialtyBLO : BaseBLO<Specialty>{
		...
		public BaseSpecialtyBLO(UnitOfWork UnitOfWork) : base()
        {
		    this._UnitOfWork = UnitOfWork;
            this.entityDAO = this._UnitOfWork.SpecialtyDAO;
        }
		 
		private BaseSpecialtyBLO() : base() {}
		...
		public virtual DataTable Export()
        {
            ...
            DataTable entityDataTable = new DataTable(msg_Specialty.PluralName);

            var foreignKeys = this._UnitOfWork.context.GetForeignKeysIds(typeof(Specialty));
            var Keys =  this._UnitOfWork.context.GetKeyNames(typeof(Specialty));
	...
	public virtual ImportReport Import(DataTable dataTable, string FileName = "")
    {
        ...
        private void InitUnitOfWork()
        {
            ...
            this.entityDAO = new SpecialtyDAO(unitOfWorkImport.context);
        }
	...
	public  partial class SpecialtyBLO : BaseSpecialtyBLO{
		public SpecialtyBLO(UnitOfWork UnitOfWork) : base(UnitOfWork) {}
