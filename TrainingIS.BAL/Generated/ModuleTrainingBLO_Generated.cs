...
namespace  TrainingIS.BLL
{
	public partial class BaseModuleTrainingBLO : BaseBLO<ModuleTraining>{
		...
		public BaseModuleTrainingBLO(UnitOfWork UnitOfWork) : base()
        {
		    this._UnitOfWork = UnitOfWork;
            this.entityDAO = this._UnitOfWork.ModuleTrainingDAO;
        }
		 
		private BaseModuleTrainingBLO() : base() {}
		...
		public virtual DataTable Export()
        {
            ...
            DataTable entityDataTable = new DataTable(msg_ModuleTraining.PluralName);

            var foreignKeys = this._UnitOfWork.context.GetForeignKeysIds(typeof(ModuleTraining));
            var Keys =  this._UnitOfWork.context.GetKeyNames(typeof(ModuleTraining));
	...
	public virtual ImportReport Import(DataTable dataTable, string FileName = "")
    {
        ...
        private void InitUnitOfWork()
        {
            ...
            this.entityDAO = new ModuleTrainingDAO(unitOfWorkImport.context);
        }
	...
	public  partial class ModuleTrainingBLO : BaseModuleTrainingBLO{
		public ModuleTrainingBLO(UnitOfWork UnitOfWork) : base(UnitOfWork) {}
