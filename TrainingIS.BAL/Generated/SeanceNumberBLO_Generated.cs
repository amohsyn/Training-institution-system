...
{ 
	public partial class BaseSeanceNumberBLO : BaseBLO<SeanceNumber>{
		...
		public BaseSeanceNumberBLO(UnitOfWork UnitOfWork) : base(UnitOfWork.SeanceNumberDAO)
        {
		...
		public virtual ImportReport Import(DataTable dataTable, string FileName = "")
		{
			...
			private void InitUnitOfWork()
			{
				...
				this.entityDAO = new SeanceNumberDAO(unitOfWorkImport.context);
			}
	...
	public  partial class SeanceNumberBLO : BaseSeanceNumberBLO{
		public SeanceNumberBLO(UnitOfWork UnitOfWork) : base(UnitOfWork) {}
