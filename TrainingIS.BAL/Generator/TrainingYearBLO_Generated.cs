...
namespace  TrainingIS.BLL
{
	...
	public virtual string Import(DataTable dataTable)
        {
            ImportService importService = new ImportService(typeof(TrainingYear), this._UnitOfWork.context);
    ...
    public virtual string Import_Old(DataTable dataTable)
        {
            ...
            msg += "<hr>";
            msg += string.Format(msgBLO.In_total_there_is_the_insertion_of, number_of_saved) + " " + msg_TrainingYear.PluralName;
			msg += "<br>";
            msg += string.Format(msgBLO.In_total_there_is_the_update_of, number_of_updated) + " " + msg_TrainingYear.PluralName;
            return msg;
        }
