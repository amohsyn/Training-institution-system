...
namespace  TrainingIS.BLL
{
	...
	public virtual string Import(DataTable dataTable)
        {
            ImportService importService = new ImportService(typeof(ModuleTraining), this._UnitOfWork.context);
            ...
            foreach (DataRow dataRow in dataTable.Rows)
            {
                ...
                ModuleTraining entity = this.FindBaseEntityByReference(reference);
                if (entity == null){
            ...
            // Resume
            string resume_msg = string.Format(msgBLO.In_total_there_is_the_insertion_of, number_of_saved) + " " + msg_ModuleTraining.PluralName;
            importService.Report.AddMessage(resume_msg, MessageTypes.Resume_Info);
            resume_msg = string.Format(msgBLO.In_total_there_is_the_update_of, number_of_updated) + " " + msg_ModuleTraining.PluralName;
            importService.Report.AddMessage(resume_msg, MessageTypes.Resume_Info);
    ...
    public virtual string Import_Old(DataTable dataTable)
        {
            ...
            msg += "<hr>";
            msg += string.Format(msgBLO.In_total_there_is_the_insertion_of, number_of_saved) + " " + msg_ModuleTraining.PluralName;
			msg += "<br>";
            msg += string.Format(msgBLO.In_total_there_is_the_update_of, number_of_updated) + " " + msg_ModuleTraining.PluralName;
            return msg;
        }
