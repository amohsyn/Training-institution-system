...
{
	public partial class YearStudyBLO : BaseBLO<YearStudy>{
	    
		UnitOfWork _UnitOfWork = null;

		public YearStudyBLO(UnitOfWork UnitOfWork) : base()
        {
		    this._UnitOfWork = UnitOfWork;
            this.entityDAO = this._UnitOfWork.YearStudyDAO;
        }
		 
		private YearStudyBLO() : base() {}
        ...
        public DataTable Export()
        {
            ...
            var foreignKeys = getForeignKeys(typeof(YearStudy));
            var Keys = getKeys(typeof(YearStudy));
