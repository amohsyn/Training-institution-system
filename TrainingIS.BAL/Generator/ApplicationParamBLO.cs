...
{
	public partial class ApplicationParamBLO : BaseBLO<ApplicationParam>{
	    
		UnitOfWork _UnitOfWork = null;

		public ApplicationParamBLO(UnitOfWork UnitOfWork) : base()
        {
		    this._UnitOfWork = UnitOfWork;
            this.entityDAO = this._UnitOfWork.ApplicationParamDAO;
        }
		 
		private ApplicationParamBLO() : base() {}
