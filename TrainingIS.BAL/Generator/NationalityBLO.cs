...
{
	public partial class NationalityBLO : BaseBLO<Nationality>{
	    
		UnitOfWork _UnitOfWork = null;

		public NationalityBLO(UnitOfWork UnitOfWork) : base()
        {
		    this._UnitOfWork = UnitOfWork;
            this.entityDAO = this._UnitOfWork.NationalityDAO;
        }
		 
		private NationalityBLO() : base() {}
        ...
        public DataTable Export()
        {
            ...
            var foreignKeys = getForeignKeys(typeof(Nationality));
            var Keys = getKeys(typeof(Nationality));
